...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3c0:	49c50513          	addi	a0,a0,1180 # 858 <digits>
 3c4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 480:	384c8c93          	addi	s9,s9,900 # 800 <malloc+0xf6>
 ...
 48e:	3ceb8b93          	addi	s7,s7,974 # 858 <digits>
 ...
 5b4:	24898993          	addi	s3,s3,584 # 7f8 <malloc+0xee>
        while(*s != 0){
 5b8:	85ee                	mv	a1,s11
...
malloc(uint nbytes)
{
 ...
 7e4:	b70080e7          	jalr	-1168(ra) # 350 <sbrk>
  if(p == (char*)-1)
