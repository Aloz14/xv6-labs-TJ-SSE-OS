...
printint(int fd, int xx, int base, int sgn)
{
 ...
 398:	51c50513          	addi	a0,a0,1308 # 8b0 <digits>
 39c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 458:	404c8c93          	addi	s9,s9,1028 # 858 <statistics+0x90>
 ...
 466:	44eb8b93          	addi	s7,s7,1102 # 8b0 <digits>
 ...
 58c:	2c898993          	addi	s3,s3,712 # 850 <statistics+0x88>
        while(*s != 0){
 590:	85ee                	mv	a1,s11
...
statistics(void *buf, int sz)
{
 ...
 7e2:	0ea50513          	addi	a0,a0,234 # 8c8 <digits+0x18>
 7e6:	00000097          	auipc	ra,0x0
 7ea:	b0a080e7          	jalr	-1270(ra) # 2f0 <open>
  if(fd < 0) {
 7ee:	04054263          	bltz	a0,832 <statistics+0x6a>
 7f2:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 7f4:	4481                	li	s1,0
 7f6:	03205063          	blez	s2,816 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 7fa:	4099063b          	subw	a2,s2,s1
 7fe:	009a05b3          	add	a1,s4,s1
 802:	854e                	mv	a0,s3
 804:	00000097          	auipc	ra,0x0
 808:	ac4080e7          	jalr	-1340(ra) # 2c8 <read>
 80c:	00054563          	bltz	a0,816 <statistics+0x4e>
      break;
    }
    i += n;
 810:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 812:	ff24c4e3          	blt	s1,s2,7fa <statistics+0x32>
  }
  close(fd);
 816:	854e                	mv	a0,s3
 818:	00000097          	auipc	ra,0x0
 81c:	ac0080e7          	jalr	-1344(ra) # 2d8 <close>
  return i;
}
 820:	8526                	mv	a0,s1
 822:	70a2                	ld	ra,40(sp)
 824:	7402                	ld	s0,32(sp)
 826:	64e2                	ld	s1,24(sp)
 828:	6942                	ld	s2,16(sp)
 82a:	69a2                	ld	s3,8(sp)
 82c:	6a02                	ld	s4,0(sp)
 82e:	6145                	addi	sp,sp,48
 830:	8082                	ret
      fprintf(2, "stats: open failed\n");
 832:	00000597          	auipc	a1,0x0
 836:	0a658593          	addi	a1,a1,166 # 8d8 <digits+0x28>
 83a:	4509                	li	a0,2
 83c:	00000097          	auipc	ra,0x0
 840:	dc0080e7          	jalr	-576(ra) # 5fc <fprintf>
      exit(1);
 844:	4505                	li	a0,1
 846:	00000097          	auipc	ra,0x0
 84a:	a6a080e7          	jalr	-1430(ra) # 2b0 <exit>
