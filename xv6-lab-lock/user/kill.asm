...
main(int argc, char **argv)
{
  ...
  4c:	84858593          	addi	a1,a1,-1976 # 890 <statistics+0x8e>
  50:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d2:	53a50513          	addi	a0,a0,1338 # 908 <digits>
 3d6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 492:	422c8c93          	addi	s9,s9,1058 # 8b0 <statistics+0xae>
 ...
 4a0:	46cb8b93          	addi	s7,s7,1132 # 908 <digits>
 ...
 5c6:	2e698993          	addi	s3,s3,742 # 8a8 <statistics+0xa6>
        while(*s != 0){
 5ca:	85ee                	mv	a1,s11
...
malloc(uint nbytes)
{
 ...
 7f6:	b80080e7          	jalr	-1152(ra) # 372 <sbrk>
  if(p == (char*)-1)
...
statistics(void *buf, int sz)
{
 ...
 81c:	10850513          	addi	a0,a0,264 # 920 <digits+0x18>
 820:	00000097          	auipc	ra,0x0
 824:	b0a080e7          	jalr	-1270(ra) # 32a <open>
  if(fd < 0) {
 828:	04054263          	bltz	a0,86c <statistics+0x6a>
 82c:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 82e:	4481                	li	s1,0
 830:	03205063          	blez	s2,850 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 834:	4099063b          	subw	a2,s2,s1
 838:	009a05b3          	add	a1,s4,s1
 83c:	854e                	mv	a0,s3
 83e:	00000097          	auipc	ra,0x0
 842:	ac4080e7          	jalr	-1340(ra) # 302 <read>
 846:	00054563          	bltz	a0,850 <statistics+0x4e>
      break;
    }
    i += n;
 84a:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 84c:	ff24c4e3          	blt	s1,s2,834 <statistics+0x32>
  }
  close(fd);
 850:	854e                	mv	a0,s3
 852:	00000097          	auipc	ra,0x0
 856:	ac0080e7          	jalr	-1344(ra) # 312 <close>
  return i;
}
 85a:	8526                	mv	a0,s1
 ...
 870:	0c458593          	addi	a1,a1,196 # 930 <digits+0x28>
 874:	4509                	li	a0,2
 876:	00000097          	auipc	ra,0x0
 87a:	dc0080e7          	jalr	-576(ra) # 636 <fprintf>
      exit(1);
 87e:	4505                	li	a0,1
 880:	00000097          	auipc	ra,0x0
 884:	a6a080e7          	jalr	-1430(ra) # 2ea <exit>
