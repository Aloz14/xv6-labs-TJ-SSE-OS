...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	12250513          	addi	a0,a0,290 # 6160 <statistics+0x88>
      ...
      74:	8082                	ret
{
      ...
      84:	10050513          	addi	a0,a0,256 # 6180 <statistics+0xa8>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	0f050513          	addi	a0,a0,240 # 6198 <statistics+0xc0>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	0f250513          	addi	a0,a0,242 # 61b8 <statistics+0xe0>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	0ba50513          	addi	a0,a0,186 # 61a0 <statistics+0xc8>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	0c650513          	addi	a0,a0,198 # 61c8 <statistics+0xf0>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	0c450513          	addi	a0,a0,196 # 61f0 <statistics+0x118>
     134:	00006097          	auipc	ra,0x6
     138:	adc080e7          	jalr	-1316(ra) # 5c10 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	0b050513          	addi	a0,a0,176 # 61f0 <statistics+0x118>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	0ac58593          	addi	a1,a1,172 # 6200 <statistics+0x128>
     15c:	00006097          	auipc	ra,0x6
     160:	a84080e7          	jalr	-1404(ra) # 5be0 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	08850513          	addi	a0,a0,136 # 61f0 <statistics+0x118>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	08c58593          	addi	a1,a1,140 # 6208 <statistics+0x130>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	05c50513          	addi	a0,a0,92 # 61f0 <statistics+0x118>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	04650513          	addi	a0,a0,70 # 6210 <statistics+0x138>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	fbc50513          	addi	a0,a0,-68 # 6238 <statistics+0x160>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	fa8a8a93          	addi	s5,s5,-88 # 6238 <statistics+0x160>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	f3650513          	addi	a0,a0,-202 # 6248 <statistics+0x170>
     ...
     338:	f3450513          	addi	a0,a0,-204 # 6268 <statistics+0x190>
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     362:	f2250513          	addi	a0,a0,-222 # 6280 <statistics+0x1a8>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     376:	f0e98993          	addi	s3,s3,-242 # 6280 <statistics+0x1a8>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c2:	ec250513          	addi	a0,a0,-318 # 6280 <statistics+0x1a8>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3da:	e3258593          	addi	a1,a1,-462 # 6208 <statistics+0x130>
    ...
    printf("write failed\n");
     ...
     3f0:	eb450513          	addi	a0,a0,-332 # 62a0 <statistics+0x1c8>
    ...
    exit(1);
     ...
     40a:	e8250513          	addi	a0,a0,-382 # 6288 <statistics+0x1b0>
    ...
    printf("open junk failed\n");
     ...
     424:	e6850513          	addi	a0,a0,-408 # 6288 <statistics+0x1b0>
  ...
  unlink("junk");
     ...
     448:	e3c50513          	addi	a0,a0,-452 # 6280 <statistics+0x1a8>
...
000000000000052e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     554:	d60a0a13          	addi	s4,s4,-672 # 62b0 <statistics+0x1d8>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     600:	cbc50513          	addi	a0,a0,-836 # 62b8 <statistics+0x1e0>
     ...
     61e:	cb650513          	addi	a0,a0,-842 # 62d0 <statistics+0x1f8>
     ...
     63c:	cc850513          	addi	a0,a0,-824 # 6300 <statistics+0x228>
     ...
     656:	cde50513          	addi	a0,a0,-802 # 6330 <statistics+0x258>
     ...
     674:	cd050513          	addi	a0,a0,-816 # 6340 <statistics+0x268>
...
000000000000068a <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b2:	cc2a0a13          	addi	s4,s4,-830 # 6370 <statistics+0x298>
    n = write(fds[1], "x", 1);
     6b6:	00006a97          	auipc	s5,0x6
     6ba:	b52a8a93          	addi	s5,s5,-1198 # 6208 <statistics+0x130>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     760:	c1c50513          	addi	a0,a0,-996 # 6378 <statistics+0x2a0>
     ...
     77e:	c1650513          	addi	a0,a0,-1002 # 6390 <statistics+0x2b8>
     ...
     798:	b9c50513          	addi	a0,a0,-1124 # 6330 <statistics+0x258>
     ...
     7b2:	c1250513          	addi	a0,a0,-1006 # 63c0 <statistics+0x2e8>
     ...
     7d0:	c0c50513          	addi	a0,a0,-1012 # 63d8 <statistics+0x300>
...
00000000000007e6 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     826:	9de58593          	addi	a1,a1,-1570 # 6200 <statistics+0x128>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     842:	9b250513          	addi	a0,a0,-1614 # 61f0 <statistics+0x118>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     86e:	98650513          	addi	a0,a0,-1658 # 61f0 <statistics+0x118>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     882:	97250513          	addi	a0,a0,-1678 # 61f0 <statistics+0x118>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c0:	bac58593          	addi	a1,a1,-1108 # 6468 <statistics+0x390>
     8c4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     902:	8f250513          	addi	a0,a0,-1806 # 61f0 <statistics+0x118>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     946:	ac650513          	addi	a0,a0,-1338 # 6408 <statistics+0x330>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     962:	aca50513          	addi	a0,a0,-1334 # 6428 <statistics+0x350>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     976:	ac650513          	addi	a0,a0,-1338 # 6438 <statistics+0x360>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     992:	aca50513          	addi	a0,a0,-1334 # 6458 <statistics+0x380>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     9a6:	a9650513          	addi	a0,a0,-1386 # 6438 <statistics+0x360>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c4:	ab050513          	addi	a0,a0,-1360 # 6470 <statistics+0x398>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e2:	ab250513          	addi	a0,a0,-1358 # 6490 <statistics+0x3b8>
...
00000000000009f8 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a16:	a9e50513          	addi	a0,a0,-1378 # 64b0 <statistics+0x3d8>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a2e:	aae98993          	addi	s3,s3,-1362 # 64d8 <statistics+0x400>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a32:	00006a97          	auipc	s5,0x6
     a36:	adea8a93          	addi	s5,s5,-1314 # 6510 <statistics+0x438>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7c:	a3850513          	addi	a0,a0,-1480 # 64b0 <statistics+0x3d8>
  ...
  if(unlink("small") < 0){
     ...
     ab8:	9fc50513          	addi	a0,a0,-1540 # 64b0 <statistics+0x3d8>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae2:	9da50513          	addi	a0,a0,-1574 # 64b8 <statistics+0x3e0>
    ...
    exit(1);
     ...
     b00:	9ec50513          	addi	a0,a0,-1556 # 64e8 <statistics+0x410>
     ...
     b1e:	a0650513          	addi	a0,a0,-1530 # 6520 <statistics+0x448>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3a:	a1250513          	addi	a0,a0,-1518 # 6548 <statistics+0x470>
    ...
    printf("%s: read failed\n", s);
     ...
     b56:	a1650513          	addi	a0,a0,-1514 # 6568 <statistics+0x490>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b72:	a1250513          	addi	a0,a0,-1518 # 6580 <statistics+0x4a8>
...
0000000000000b88 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba4:	a0050513          	addi	a0,a0,-1536 # 65a0 <statistics+0x4c8>
  ...
  fd = open("big", O_RDONLY);
     ...
     bf6:	9ae50513          	addi	a0,a0,-1618 # 65a0 <statistics+0x4c8>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c3e:	96e50513          	addi	a0,a0,-1682 # 65a8 <statistics+0x4d0>
    ...
    exit(1);
     ...
     c5c:	97050513          	addi	a0,a0,-1680 # 65c8 <statistics+0x4f0>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c78:	97c50513          	addi	a0,a0,-1668 # 65f0 <statistics+0x518>
  ...
  if(unlink("big") < 0){
     ...
     ca4:	90050513          	addi	a0,a0,-1792 # 65a0 <statistics+0x4c8>
     ...
     cd0:	94450513          	addi	a0,a0,-1724 # 6610 <statistics+0x538>
     ...
     cee:	94e50513          	addi	a0,a0,-1714 # 6638 <statistics+0x560>
     ...
     d0c:	94850513          	addi	a0,a0,-1720 # 6650 <statistics+0x578>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d28:	95450513          	addi	a0,a0,-1708 # 6678 <statistics+0x5a0>
...
0000000000000d3e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d56:	93e50513          	addi	a0,a0,-1730 # 6690 <statistics+0x5b8>
  ...
  write(fd, "hello", SZ);
     ...
     d6e:	95658593          	addi	a1,a1,-1706 # 66c0 <statistics+0x5e8>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8a:	90a50513          	addi	a0,a0,-1782 # 6690 <statistics+0x5b8>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da0:	8f450513          	addi	a0,a0,-1804 # 6690 <statistics+0x5b8>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db6:	8de50513          	addi	a0,a0,-1826 # 6690 <statistics+0x5b8>
  ...
  write(fd1, "yyy", 3);
     ...
     dca:	94258593          	addi	a1,a1,-1726 # 6708 <statistics+0x630>
  ...
  unlink("unlinkread");
     ...
     e32:	86250513          	addi	a0,a0,-1950 # 6690 <statistics+0x5b8>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e52:	85250513          	addi	a0,a0,-1966 # 66a0 <statistics+0x5c8>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e6e:	85e50513          	addi	a0,a0,-1954 # 66c8 <statistics+0x5f0>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8a:	86250513          	addi	a0,a0,-1950 # 66e8 <statistics+0x610>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea6:	86e50513          	addi	a0,a0,-1938 # 6710 <statistics+0x638>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec2:	87250513          	addi	a0,a0,-1934 # 6730 <statistics+0x658>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ede:	87650513          	addi	a0,a0,-1930 # 6750 <statistics+0x678>
...
0000000000000ef4 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f42:	78258593          	addi	a1,a1,1922 # 66c0 <statistics+0x5e8>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f62:	81a58593          	addi	a1,a1,-2022 # 6778 <statistics+0x6a0>
     f66:	00006517          	auipc	a0,0x6
     f6a:	80a50513          	addi	a0,a0,-2038 # 6770 <statistics+0x698>
  ...
  unlink("lf1");
     ...
     f7e:	7f650513          	addi	a0,a0,2038 # 6770 <statistics+0x698>
     f82:	00005097          	auipc	ra,0x5
     f86:	c8e080e7          	jalr	-882(ra) # 5c10 <unlink>
  if(open("lf1", 0) >= 0){
     f8a:	4581                	li	a1,0
     f8c:	00005517          	auipc	a0,0x5
     f90:	7e450513          	addi	a0,a0,2020 # 6770 <statistics+0x698>
  ...
  fd = open("lf2", 0);
     ...
     fa6:	7d650513          	addi	a0,a0,2006 # 6778 <statistics+0x6a0>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fde:	79e58593          	addi	a1,a1,1950 # 6778 <statistics+0x6a0>
     fe2:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff4:	78850513          	addi	a0,a0,1928 # 6778 <statistics+0x6a0>
     ff8:	00005097          	auipc	ra,0x5
     ffc:	c18080e7          	jalr	-1000(ra) # 5c10 <unlink>
  if(link("lf2", "lf1") >= 0){
    1000:	00005597          	auipc	a1,0x5
    1004:	77058593          	addi	a1,a1,1904 # 6770 <statistics+0x698>
    1008:	00005517          	auipc	a0,0x5
    100c:	77050513          	addi	a0,a0,1904 # 6778 <statistics+0x6a0>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1020:	75458593          	addi	a1,a1,1876 # 6770 <statistics+0x698>
    1024:	00006517          	auipc	a0,0x6
    1028:	85c50513          	addi	a0,a0,-1956 # 6880 <statistics+0x7a8>
    ...
    104a:	73a50513          	addi	a0,a0,1850 # 6780 <statistics+0x6a8>
    ...
    1066:	73650513          	addi	a0,a0,1846 # 6798 <statistics+0x6c0>
    ...
    1082:	73250513          	addi	a0,a0,1842 # 67b0 <statistics+0x6d8>
    ...
    109e:	73650513          	addi	a0,a0,1846 # 67d0 <statistics+0x6f8>
    ...
    10ba:	74a50513          	addi	a0,a0,1866 # 6800 <statistics+0x728>
    ...
    10d6:	74650513          	addi	a0,a0,1862 # 6818 <statistics+0x740>
    ...
    10f2:	74250513          	addi	a0,a0,1858 # 6830 <statistics+0x758>
    ...
    110e:	74e50513          	addi	a0,a0,1870 # 6858 <statistics+0x780>
    ...
    112a:	76250513          	addi	a0,a0,1890 # 6888 <statistics+0x7b0>
...
0000000000001140 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115c:	75098993          	addi	s3,s3,1872 # 68a8 <statistics+0x7d0>
    1160:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1198:	72450513          	addi	a0,a0,1828 # 68b8 <statistics+0x7e0>
...
00000000000011ae <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    11fe:	6dea0a13          	addi	s4,s4,1758 # 68d8 <statistics+0x800>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1250:	68c50513          	addi	a0,a0,1676 # 68d8 <statistics+0x800>
  ...
  for(i = 0; i < N; i++){
    ...
    12c0:	62450513          	addi	a0,a0,1572 # 68e0 <statistics+0x808>
    ...
    12e0:	62450513          	addi	a0,a0,1572 # 6900 <statistics+0x828>
    ...
    12fc:	62850513          	addi	a0,a0,1576 # 6920 <statistics+0x848>
...
000000000000134a <badarg>:
{
    ...
    1368:	e3498993          	addi	s3,s3,-460 # 6198 <statistics+0xc0>
    argv[0] = (char*)0xffffffff;
...
0000000000001390 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f2:	78a78793          	addi	a5,a5,1930 # 7b78 <statistics+0x1aa0>
  ...
  if(pid == 0){
    ...
    144e:	16e78793          	addi	a5,a5,366 # 85b8 <statistics+0x24e0>
    ...
    1472:	d2a50513          	addi	a0,a0,-726 # 6198 <statistics+0xc0>
    ...
    148a:	54250513          	addi	a0,a0,1346 # 69c8 <statistics+0x8f0>
    ...
    14aa:	49a50513          	addi	a0,a0,1178 # 6940 <statistics+0x868>
    ...
    14ca:	49a50513          	addi	a0,a0,1178 # 6960 <statistics+0x888>
    ...
    14ec:	49850513          	addi	a0,a0,1176 # 6980 <statistics+0x8a8>
    ...
    150c:	4a050513          	addi	a0,a0,1184 # 69a8 <statistics+0x8d0>
    ...
    1526:	90650513          	addi	a0,a0,-1786 # 6e28 <statistics+0xd50>
  ...
  if(st != 747){
    ...
    1570:	48450513          	addi	a0,a0,1156 # 69f0 <statistics+0x918>
...
0000000000001586 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    15a2:	c5250513          	addi	a0,a0,-942 # 61f0 <statistics+0x118>
  ...
  if(pid == 0){
    ...
    15cc:	c28a0a13          	addi	s4,s4,-984 # 61f0 <statistics+0x118>
      int n = write(fd, "1234567890", 10);
    15d0:	00005a97          	auipc	s5,0x5
    15d4:	480a8a93          	addi	s5,s5,1152 # 6a50 <statistics+0x978>
      int fd = open("truncfile", O_WRONLY);
    15d8:	4585                	li	a1,1
    15da:	8552                	mv	a0,s4
    ...
    1644:	3e050513          	addi	a0,a0,992 # 6a20 <statistics+0x948>
    ...
    1660:	3dc50513          	addi	a0,a0,988 # 6a38 <statistics+0x960>
    ...
    167e:	3e650513          	addi	a0,a0,998 # 6a60 <statistics+0x988>
    ...
    169c:	b58a0a13          	addi	s4,s4,-1192 # 61f0 <statistics+0x118>
    int n = write(fd, "xxx", 3);
    16a0:	00005a97          	auipc	s5,0x5
    16a4:	3e0a8a93          	addi	s5,s5,992 # 6a80 <statistics+0x9a8>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16ee:	b0650513          	addi	a0,a0,-1274 # 61f0 <statistics+0x118>
  ...
  exit(xstatus);
    ...
    170c:	33050513          	addi	a0,a0,816 # 6a38 <statistics+0x960>
    ...
    172a:	36250513          	addi	a0,a0,866 # 6a88 <statistics+0x9b0>
...
0000000000001740 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1752:	a4a78793          	addi	a5,a5,-1462 # 6198 <statistics+0xc0>
    1756:	fcf43023          	sd	a5,-64(s0)
    175a:	00005797          	auipc	a5,0x5
    175e:	34e78793          	addi	a5,a5,846 # 6aa8 <statistics+0x9d0>
    1762:	fcf43423          	sd	a5,-56(s0)
    1766:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    176a:	00005517          	auipc	a0,0x5
    176e:	34650513          	addi	a0,a0,838 # 6ab0 <statistics+0x9d8>
  ...
  if(pid == 0) {
    ...
    179c:	31850513          	addi	a0,a0,792 # 6ab0 <statistics+0x9d8>
    ...
    17b8:	31c50513          	addi	a0,a0,796 # 6ad0 <statistics+0x9f8>
    ...
    17d4:	25050513          	addi	a0,a0,592 # 6a20 <statistics+0x948>
    ...
    17f0:	2cc50513          	addi	a0,a0,716 # 6ab8 <statistics+0x9e0>
    ...
    180e:	98e50513          	addi	a0,a0,-1650 # 6198 <statistics+0xc0>
  ...
  if(xstatus != 0)
    ...
    1842:	2a250513          	addi	a0,a0,674 # 6ae0 <statistics+0xa08>
    ...
    185e:	29e50513          	addi	a0,a0,670 # 6af8 <statistics+0xa20>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1872:	24250513          	addi	a0,a0,578 # 6ab0 <statistics+0x9d8>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    189c:	cd050513          	addi	a0,a0,-816 # 6568 <statistics+0x490>
    ...
    18b8:	18450513          	addi	a0,a0,388 # 6a38 <statistics+0x960>
  ...
  unlink("echo-ok");
    ...
    18d2:	1e250513          	addi	a0,a0,482 # 6ab0 <statistics+0x9d8>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    18fc:	21850513          	addi	a0,a0,536 # 6b10 <statistics+0xa38>
...
000000000000191c <pipe1>:
{
  ...
  if(pid == 0){
    ...
    19bc:	17050513          	addi	a0,a0,368 # 6b28 <statistics+0xa50>
    ...
    19f6:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x9d>
{
    ...
    1a42:	10250513          	addi	a0,a0,258 # 6b40 <statistics+0xa68>
    ...
    1a5e:	0fe50513          	addi	a0,a0,254 # 6b58 <statistics+0xa80>
    ...
    1a90:	0e450513          	addi	a0,a0,228 # 6b70 <statistics+0xa98>
    ...
    1ad0:	0c450513          	addi	a0,a0,196 # 6b90 <statistics+0xab8>
...
0000000000001ae6 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b42:	ee250513          	addi	a0,a0,-286 # 6a20 <statistics+0x948>
    ...
    1b5e:	04e50513          	addi	a0,a0,78 # 6ba8 <statistics+0xad0>
    ...
    1b7a:	04a50513          	addi	a0,a0,74 # 6bc0 <statistics+0xae8>
...
0000000000001b9a <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1bf2:	e3250513          	addi	a0,a0,-462 # 6a20 <statistics+0x948>
    ...
    1c16:	e0e50513          	addi	a0,a0,-498 # 6a20 <statistics+0x948>
...
0000000000001c34 <forkfork>:
{
    ...
    1c90:	f5450513          	addi	a0,a0,-172 # 6be0 <statistics+0xb08>
    ...
    1ca2:	f22080e7          	jalr	-222(ra) # 5bc0 <exit>
{
    ...
    1ce8:	f0c50513          	addi	a0,a0,-244 # 6bf0 <statistics+0xb18>
...
0000000000001cfe <reparent2>:
{
  ...
  exit(0);
    ...
    1d36:	0f650513          	addi	a0,a0,246 # 6e28 <statistics+0xd50>
...
0000000000001d66 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1dd4:	05850513          	addi	a0,a0,88 # 6e28 <statistics+0xd50>
    ...
    1e00:	cbc50513          	addi	a0,a0,-836 # 6ab8 <statistics+0x9e0>
    ...
    1e72:	da250513          	addi	a0,a0,-606 # 6c10 <statistics+0xb38>
    ...
    1ea6:	d8650513          	addi	a0,a0,-634 # 6c28 <statistics+0xb50>
    ...
    1f0c:	d4850513          	addi	a0,a0,-696 # 6c50 <statistics+0xb78>
...
0000000000001f8c <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fac:	26050513          	addi	a0,a0,608 # 6208 <statistics+0x130>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1fe8:	224a8a93          	addi	s5,s5,548 # 6208 <statistics+0x130>
      link("cat", "x");
    1fec:	00005b97          	auipc	s7,0x5
    1ff0:	c8cb8b93          	addi	s7,s7,-884 # 6c78 <statistics+0xba0>
    1ff4:	a825                	j	202c <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1ff6:	85a6                	mv	a1,s1
    1ff8:	00005517          	auipc	a0,0x5
    1ffc:	a2850513          	addi	a0,a0,-1496 # 6a20 <statistics+0x948>
...
000000000000208e <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20be:	bde50513          	addi	a0,a0,-1058 # 6c98 <statistics+0xbc0>
  ...
  if(wait(0) != -1){
    ...
    2120:	b6450513          	addi	a0,a0,-1180 # 6c80 <statistics+0xba8>
    ...
    213c:	b8850513          	addi	a0,a0,-1144 # 6cc0 <statistics+0xbe8>
    ...
    2158:	b8450513          	addi	a0,a0,-1148 # 6cd8 <statistics+0xc00>
...
000000000000216e <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21d8:	84c50513          	addi	a0,a0,-1972 # 6a20 <statistics+0x948>
    ...
    21fa:	afa50513          	addi	a0,a0,-1286 # 6cf0 <statistics+0xc18>
...
000000000000221a <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    227c:	7a850513          	addi	a0,a0,1960 # 6a20 <statistics+0x948>
    ...
    22a8:	a6c50513          	addi	a0,a0,-1428 # 6d10 <statistics+0xc38>
...
00000000000022c8 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    22d8:	a5450513          	addi	a0,a0,-1452 # 6d28 <statistics+0xc50>
  ...
  fd = open("bigarg-ok", 0);
    ...
    230a:	a2250513          	addi	a0,a0,-1502 # 6d28 <statistics+0xc50>
  ...
  close(fd);
    ...
    2340:	9fc70713          	addi	a4,a4,-1540 # 6d38 <statistics+0xc60>
    ...
    2394:	a8850513          	addi	a0,a0,-1400 # 6e18 <statistics+0xd40>
    ...
    23b8:	a8450513          	addi	a0,a0,-1404 # 6e38 <statistics+0xd60>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2416:	a4650513          	addi	a0,a0,-1466 # 6e58 <statistics+0xd80>
    ...
    2432:	5f250513          	addi	a0,a0,1522 # 6a20 <statistics+0x948>
...
0000000000002452 <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24a0:	58450513          	addi	a0,a0,1412 # 6a20 <statistics+0x948>
...
00000000000024c0 <manywrites>:
{
  ...
  exit(0);
    ...
    251c:	91050513          	addi	a0,a0,-1776 # 6e28 <statistics+0xd50>
    ...
    25cc:	8b850513          	addi	a0,a0,-1864 # 6e80 <statistics+0xda8>
    ...
    25ec:	c8050513          	addi	a0,a0,-896 # 6268 <statistics+0x190>
...
000000000000260a <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2684:	4f878793          	addi	a5,a5,1272 # 7b78 <statistics+0x1aa0>
  ...
  if(ret != -1){
    ...
    26c6:	7d650513          	addi	a0,a0,2006 # 6e98 <statistics+0xdc0>
    ...
    26e4:	26050513          	addi	a0,a0,608 # 6940 <statistics+0x868>
    ...
    2702:	26250513          	addi	a0,a0,610 # 6960 <statistics+0x888>
    ...
    2722:	26250513          	addi	a0,a0,610 # 6980 <statistics+0x8a8>
    ...
    2740:	26c50513          	addi	a0,a0,620 # 69a8 <statistics+0x8d0>
...
0000000000002756 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    278c:	75050513          	addi	a0,a0,1872 # 6ed8 <statistics+0xe00>
  ...
  if(n >= 0){
    ...
    27bc:	74050513          	addi	a0,a0,1856 # 6ef8 <statistics+0xe20>
    ...
    27d6:	6ce50513          	addi	a0,a0,1742 # 6ea0 <statistics+0xdc8>
    ...
    27f0:	6cc50513          	addi	a0,a0,1740 # 6eb8 <statistics+0xde0>
    ...
    280a:	6da50513          	addi	a0,a0,1754 # 6ee0 <statistics+0xe08>
  ...
  unlink("rwsbrk");
    ...
    282e:	6ae50513          	addi	a0,a0,1710 # 6ed8 <statistics+0xe00>
    2832:	00003097          	auipc	ra,0x3
    2836:	3de080e7          	jalr	990(ra) # 5c10 <unlink>
  fd = open("README", O_RDONLY);
    283a:	4581                	li	a1,0
    283c:	00004517          	auipc	a0,0x4
    2840:	b3450513          	addi	a0,a0,-1228 # 6370 <statistics+0x298>
  ...
  if(n >= 0){
    ...
    286a:	6c250513          	addi	a0,a0,1730 # 6f28 <statistics+0xe50>
    ...
    2884:	66050513          	addi	a0,a0,1632 # 6ee0 <statistics+0xe08>
...
00000000000028ae <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2904:	65050513          	addi	a0,a0,1616 # 6f50 <statistics+0xe78>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2956:	61e50513          	addi	a0,a0,1566 # 6f70 <statistics+0xe98>
  ...
  if(c != a + 1){
    ...
    29ba:	61a50513          	addi	a0,a0,1562 # 6fd0 <statistics+0xef8>
    ...
    29dc:	5b850513          	addi	a0,a0,1464 # 6f90 <statistics+0xeb8>
    ...
    29f8:	5bc50513          	addi	a0,a0,1468 # 6fb0 <statistics+0xed8>
...
0000000000002a34 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2b42:	4b250513          	addi	a0,a0,1202 # 6ff0 <statistics+0xf18>
    ...
    2b5e:	4de50513          	addi	a0,a0,1246 # 7038 <statistics+0xf60>
    ...
    2b7e:	4de50513          	addi	a0,a0,1246 # 7058 <statistics+0xf80>
    ...
    2b9e:	4fe50513          	addi	a0,a0,1278 # 7098 <statistics+0xfc0>
    ...
    2bba:	51250513          	addi	a0,a0,1298 # 70c8 <statistics+0xff0>
    ...
    2bda:	52a50513          	addi	a0,a0,1322 # 7100 <statistics+0x1028>
...
0000000000002bf0 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c14:	51850513          	addi	a0,a0,1304 # 7128 <statistics+0x1050>
    2c18:	00003097          	auipc	ra,0x3
    2c1c:	fe8080e7          	jalr	-24(ra) # 5c00 <open>
    2c20:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c22:	00004517          	auipc	a0,0x4
    2c26:	50650513          	addi	a0,a0,1286 # 7128 <statistics+0x1050>
  ...
  if(pipe((int *) a) != 0){
    ...
    2c7a:	4ba50513          	addi	a0,a0,1210 # 7130 <statistics+0x1058>
    ...
    2c96:	4b650513          	addi	a0,a0,1206 # 7148 <statistics+0x1070>
    ...
    2cb2:	e7a50513          	addi	a0,a0,-390 # 6b28 <statistics+0xa50>
...
0000000000002cc8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2cdc:	48850513          	addi	a0,a0,1160 # 7160 <statistics+0x1088>
  ...
  close(fd);
    ...
    2d24:	d1850513          	addi	a0,a0,-744 # 6a38 <statistics+0x960>
...
0000000000002d3a <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2d72:	0ba50513          	addi	a0,a0,186 # 6e28 <statistics+0xd50>
  ...
  if(pid == 0){
    ...
    2dc8:	06450513          	addi	a0,a0,100 # 6e28 <statistics+0xd50>
  ...
  if(pid == 0){
    ...
    2e28:	00450513          	addi	a0,a0,4 # 6e28 <statistics+0xd50>
...
0000000000002f5a <execout>:
{
  ...
  exit(0);
    ...
    2f9c:	e9050513          	addi	a0,a0,-368 # 6e28 <statistics+0xd50>
    ...
    2ff0:	1ac50513          	addi	a0,a0,428 # 6198 <statistics+0xc0>
    2ff4:	faa43c23          	sd	a0,-72(s0)
    2ff8:	00003797          	auipc	a5,0x3
    2ffc:	21078793          	addi	a5,a5,528 # 6208 <statistics+0x130>
...
000000000000301e <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    302e:	30e50513          	addi	a0,a0,782 # 7338 <statistics+0x1260>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3040:	15450513          	addi	a0,a0,340 # 7190 <statistics+0x10b8>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    3056:	19650513          	addi	a0,a0,406 # 71e8 <statistics+0x1110>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    3074:	1f050513          	addi	a0,a0,496 # 7260 <statistics+0x1188>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    3090:	24450513          	addi	a0,a0,580 # 72d0 <statistics+0x11f8>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30a2:	28a50513          	addi	a0,a0,650 # 7328 <statistics+0x1250>
  ...
  unlink("12345678901234");
    ...
    3120:	04c50513          	addi	a0,a0,76 # 7168 <statistics+0x1090>
    ...
    313c:	07850513          	addi	a0,a0,120 # 71b0 <statistics+0x10d8>
    ...
    3158:	0c450513          	addi	a0,a0,196 # 7218 <statistics+0x1140>
    ...
    3174:	12050513          	addi	a0,a0,288 # 7290 <statistics+0x11b8>
    ...
    3190:	16450513          	addi	a0,a0,356 # 72f0 <statistics+0x1218>
    ...
    31ac:	1a050513          	addi	a0,a0,416 # 7348 <statistics+0x1270>
...
00000000000031c2 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    31f8:	18c50513          	addi	a0,a0,396 # 7380 <statistics+0x12a8>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3222:	17250513          	addi	a0,a0,370 # 7390 <statistics+0x12b8>
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    32b2:	0d250513          	addi	a0,a0,210 # 7380 <statistics+0x12a8>
  ...
  unlink("diskfulldir");
    ...
    32c6:	0be50513          	addi	a0,a0,190 # 7380 <statistics+0x12a8>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    33f4:	fc050513          	addi	a0,a0,-64 # 73b0 <statistics+0x12d8>
...
0000000000003402 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3412:	fd250513          	addi	a0,a0,-46 # 73e0 <statistics+0x1308>
  ...
  if(chdir("iputdir") < 0){
    ...
    3426:	fbe50513          	addi	a0,a0,-66 # 73e0 <statistics+0x1308>
  ...
  if(unlink("../iputdir") < 0){
    ...
    343a:	fea50513          	addi	a0,a0,-22 # 7420 <statistics+0x1348>
  ...
  if(chdir("/") < 0){
    ...
    344e:	00650513          	addi	a0,a0,6 # 7450 <statistics+0x1378>
    ...
    346e:	f7e50513          	addi	a0,a0,-130 # 73e8 <statistics+0x1310>
    ...
    348a:	f7a50513          	addi	a0,a0,-134 # 7400 <statistics+0x1328>
    ...
    34a6:	f8e50513          	addi	a0,a0,-114 # 7430 <statistics+0x1358>
    ...
    34c2:	f9a50513          	addi	a0,a0,-102 # 7458 <statistics+0x1380>
...
00000000000034d8 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    34f6:	eee50513          	addi	a0,a0,-274 # 73e0 <statistics+0x1308>
    ...
    350a:	eda50513          	addi	a0,a0,-294 # 73e0 <statistics+0x1308>
    ...
    351e:	f0650513          	addi	a0,a0,-250 # 7420 <statistics+0x1348>
    ...
    353e:	4e650513          	addi	a0,a0,1254 # 6a20 <statistics+0x948>
    ...
    355a:	e9250513          	addi	a0,a0,-366 # 73e8 <statistics+0x1310>
    ...
    3576:	efe50513          	addi	a0,a0,-258 # 7470 <statistics+0x1398>
    ...
    3592:	ea250513          	addi	a0,a0,-350 # 7430 <statistics+0x1358>
...
00000000000035c0 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    35d0:	ebc50513          	addi	a0,a0,-324 # 7488 <statistics+0x13b0>
  ...
  if(chdir("dir0") < 0){
    ...
    35e4:	ea850513          	addi	a0,a0,-344 # 7488 <statistics+0x13b0>
  ...
  if(chdir("..") < 0){
    ...
    35f8:	eb450513          	addi	a0,a0,-332 # 74a8 <statistics+0x13d0>
  ...
  if(unlink("dir0") < 0){
    ...
    360c:	e8050513          	addi	a0,a0,-384 # 7488 <statistics+0x13b0>
    ...
    362c:	dc050513          	addi	a0,a0,-576 # 73e8 <statistics+0x1310>
    ...
    3648:	e4c50513          	addi	a0,a0,-436 # 7490 <statistics+0x13b8>
    ...
    3664:	e5050513          	addi	a0,a0,-432 # 74b0 <statistics+0x13d8>
    ...
    3680:	e4c50513          	addi	a0,a0,-436 # 74c8 <statistics+0x13f0>
...
0000000000003696 <subdir>:
{
  ...
  unlink("ff");
    ...
    36a8:	f6c50513          	addi	a0,a0,-148 # 7610 <statistics+0x1538>
    36ac:	00002097          	auipc	ra,0x2
    36b0:	564080e7          	jalr	1380(ra) # 5c10 <unlink>
  if(mkdir("dd") != 0){
    36b4:	00004517          	auipc	a0,0x4
    36b8:	e2c50513          	addi	a0,a0,-468 # 74e0 <statistics+0x1408>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    36d0:	e3450513          	addi	a0,a0,-460 # 7500 <statistics+0x1428>
  ...
  write(fd, "ff", 2);
    ...
    36e8:	f2c58593          	addi	a1,a1,-212 # 7610 <statistics+0x1538>
  ...
  if(unlink("dd") >= 0){
    ...
    3702:	de250513          	addi	a0,a0,-542 # 74e0 <statistics+0x1408>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3716:	e4650513          	addi	a0,a0,-442 # 7558 <statistics+0x1480>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    372e:	e5650513          	addi	a0,a0,-426 # 7580 <statistics+0x14a8>
  ...
  write(fd, "FF", 2);
    ...
    3746:	e6e58593          	addi	a1,a1,-402 # 75b0 <statistics+0x14d8>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3762:	e5a50513          	addi	a0,a0,-422 # 75b8 <statistics+0x14e0>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37aa:	e6258593          	addi	a1,a1,-414 # 7608 <statistics+0x1530>
    37ae:	00004517          	auipc	a0,0x4
    37b2:	dd250513          	addi	a0,a0,-558 # 7580 <statistics+0x14a8>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    37c6:	dbe50513          	addi	a0,a0,-578 # 7580 <statistics+0x14a8>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    37dc:	da850513          	addi	a0,a0,-600 # 7580 <statistics+0x14a8>
  ...
  if(chdir("dd") != 0){
    ...
    37f0:	cf450513          	addi	a0,a0,-780 # 74e0 <statistics+0x1408>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3804:	ea050513          	addi	a0,a0,-352 # 76a0 <statistics+0x15c8>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3818:	ebc50513          	addi	a0,a0,-324 # 76d0 <statistics+0x15f8>
  ...
  if(chdir("./..") != 0){
    ...
    382c:	ed850513          	addi	a0,a0,-296 # 7700 <statistics+0x1628>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3842:	dca50513          	addi	a0,a0,-566 # 7608 <statistics+0x1530>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    387c:	d0850513          	addi	a0,a0,-760 # 7580 <statistics+0x14a8>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3894:	f0050513          	addi	a0,a0,-256 # 7790 <statistics+0x16b8>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38ac:	f1850513          	addi	a0,a0,-232 # 77c0 <statistics+0x16e8>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    38c4:	c2050513          	addi	a0,a0,-992 # 74e0 <statistics+0x1408>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    38da:	c0a50513          	addi	a0,a0,-1014 # 74e0 <statistics+0x1408>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    38f0:	bf450513          	addi	a0,a0,-1036 # 74e0 <statistics+0x1408>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3904:	f5058593          	addi	a1,a1,-176 # 7850 <statistics+0x1778>
    3908:	00004517          	auipc	a0,0x4
    390c:	e8850513          	addi	a0,a0,-376 # 7790 <statistics+0x16b8>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3920:	f3458593          	addi	a1,a1,-204 # 7850 <statistics+0x1778>
    3924:	00004517          	auipc	a0,0x4
    3928:	e9c50513          	addi	a0,a0,-356 # 77c0 <statistics+0x16e8>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    393c:	cd058593          	addi	a1,a1,-816 # 7608 <statistics+0x1530>
    3940:	00004517          	auipc	a0,0x4
    3944:	bc050513          	addi	a0,a0,-1088 # 7500 <statistics+0x1428>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3958:	e3c50513          	addi	a0,a0,-452 # 7790 <statistics+0x16b8>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    396c:	e5850513          	addi	a0,a0,-424 # 77c0 <statistics+0x16e8>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3980:	c8c50513          	addi	a0,a0,-884 # 7608 <statistics+0x1530>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3994:	e3050513          	addi	a0,a0,-464 # 77c0 <statistics+0x16e8>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39a8:	dec50513          	addi	a0,a0,-532 # 7790 <statistics+0x16b8>
  ...
  if(chdir("dd/ff") == 0){
    ...
    39bc:	b4850513          	addi	a0,a0,-1208 # 7500 <statistics+0x1428>
  ...
  if(chdir("dd/xx") == 0){
    ...
    39d0:	fd450513          	addi	a0,a0,-44 # 79a0 <statistics+0x18c8>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    39e4:	c2850513          	addi	a0,a0,-984 # 7608 <statistics+0x1530>
  ...
  if(unlink("dd/ff") != 0){
    ...
    39f8:	b0c50513          	addi	a0,a0,-1268 # 7500 <statistics+0x1428>
  ...
  if(unlink("dd") == 0){
    ...
    3a0c:	ad850513          	addi	a0,a0,-1320 # 74e0 <statistics+0x1408>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a20:	ff450513          	addi	a0,a0,-12 # 7a10 <statistics+0x1938>
  ...
  if(unlink("dd") < 0){
    ...
    3a34:	ab050513          	addi	a0,a0,-1360 # 74e0 <statistics+0x1408>
    ...
    3a56:	a9650513          	addi	a0,a0,-1386 # 74e8 <statistics+0x1410>
    ...
    3a72:	a9a50513          	addi	a0,a0,-1382 # 7508 <statistics+0x1430>
    ...
    3a8e:	a9e50513          	addi	a0,a0,-1378 # 7528 <statistics+0x1450>
    ...
    3aaa:	aba50513          	addi	a0,a0,-1350 # 7560 <statistics+0x1488>
    ...
    3ac6:	ace50513          	addi	a0,a0,-1330 # 7590 <statistics+0x14b8>
    ...
    3ae2:	aea50513          	addi	a0,a0,-1302 # 75c8 <statistics+0x14f0>
    ...
    3afe:	aee50513          	addi	a0,a0,-1298 # 75e8 <statistics+0x1510>
    ...
    3b1a:	b0250513          	addi	a0,a0,-1278 # 7618 <statistics+0x1540>
    ...
    3b36:	b0e50513          	addi	a0,a0,-1266 # 7640 <statistics+0x1568>
    ...
    3b52:	b1250513          	addi	a0,a0,-1262 # 7660 <statistics+0x1588>
    ...
    3b6e:	b1e50513          	addi	a0,a0,-1250 # 7688 <statistics+0x15b0>
    ...
    3b8a:	b2a50513          	addi	a0,a0,-1238 # 76b0 <statistics+0x15d8>
    ...
    3ba6:	b3e50513          	addi	a0,a0,-1218 # 76e0 <statistics+0x1608>
    ...
    3bc2:	b4a50513          	addi	a0,a0,-1206 # 7708 <statistics+0x1630>
    ...
    3bde:	b4650513          	addi	a0,a0,-1210 # 7720 <statistics+0x1648>
    ...
    3bfa:	b4a50513          	addi	a0,a0,-1206 # 7740 <statistics+0x1668>
    ...
    3c16:	b4e50513          	addi	a0,a0,-1202 # 7760 <statistics+0x1688>
    ...
    3c32:	b7250513          	addi	a0,a0,-1166 # 77a0 <statistics+0x16c8>
    ...
    3c4e:	b8650513          	addi	a0,a0,-1146 # 77d0 <statistics+0x16f8>
    ...
    3c6a:	b8a50513          	addi	a0,a0,-1142 # 77f0 <statistics+0x1718>
    ...
    3c86:	b8e50513          	addi	a0,a0,-1138 # 7810 <statistics+0x1738>
    ...
    3ca2:	b9250513          	addi	a0,a0,-1134 # 7830 <statistics+0x1758>
    ...
    3cbe:	ba650513          	addi	a0,a0,-1114 # 7860 <statistics+0x1788>
    ...
    3cda:	bb250513          	addi	a0,a0,-1102 # 7888 <statistics+0x17b0>
    ...
    3cf6:	bbe50513          	addi	a0,a0,-1090 # 78b0 <statistics+0x17d8>
    ...
    3d12:	bca50513          	addi	a0,a0,-1078 # 78d8 <statistics+0x1800>
    ...
    3d2e:	bce50513          	addi	a0,a0,-1074 # 78f8 <statistics+0x1820>
    ...
    3d4a:	bd250513          	addi	a0,a0,-1070 # 7918 <statistics+0x1840>
    ...
    3d66:	bde50513          	addi	a0,a0,-1058 # 7940 <statistics+0x1868>
    ...
    3d82:	be250513          	addi	a0,a0,-1054 # 7960 <statistics+0x1888>
    ...
    3d9e:	be650513          	addi	a0,a0,-1050 # 7980 <statistics+0x18a8>
    ...
    3dba:	bf250513          	addi	a0,a0,-1038 # 79a8 <statistics+0x18d0>
    ...
    3dd6:	86e50513          	addi	a0,a0,-1938 # 7640 <statistics+0x1568>
    ...
    3df2:	bda50513          	addi	a0,a0,-1062 # 79c8 <statistics+0x18f0>
    ...
    3e0e:	bde50513          	addi	a0,a0,-1058 # 79e8 <statistics+0x1910>
    ...
    3e2a:	bf250513          	addi	a0,a0,-1038 # 7a18 <statistics+0x1940>
    ...
    3e46:	bf650513          	addi	a0,a0,-1034 # 7a38 <statistics+0x1960>
...
0000000000003e5c <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3e6c:	be850513          	addi	a0,a0,-1048 # 7a50 <statistics+0x1978>
  ...
  if(chdir("dots") != 0){
    ...
    3e7e:	bd650513          	addi	a0,a0,-1066 # 7a50 <statistics+0x1978>
  ...
  if(unlink(".") == 0){
    ...
    3e90:	9f450513          	addi	a0,a0,-1548 # 6880 <statistics+0x7a8>
  ...
  if(unlink("..") == 0){
    ...
    3ea2:	60a50513          	addi	a0,a0,1546 # 74a8 <statistics+0x13d0>
  ...
  if(chdir("/") != 0){
    ...
    3eb4:	5a050513          	addi	a0,a0,1440 # 7450 <statistics+0x1378>
  ...
  if(unlink("dots/.") == 0){
    ...
    3ec6:	bf650513          	addi	a0,a0,-1034 # 7ab8 <statistics+0x19e0>
  ...
  if(unlink("dots/..") == 0){
    ...
    3ed8:	c0c50513          	addi	a0,a0,-1012 # 7ae0 <statistics+0x1a08>
  ...
  if(unlink("dots") != 0){
    ...
    3eea:	b6a50513          	addi	a0,a0,-1174 # 7a50 <statistics+0x1978>
    ...
    3f08:	b5450513          	addi	a0,a0,-1196 # 7a58 <statistics+0x1980>
    ...
    3f24:	b5050513          	addi	a0,a0,-1200 # 7a70 <statistics+0x1998>
    ...
    3f40:	b4c50513          	addi	a0,a0,-1204 # 7a88 <statistics+0x19b0>
    ...
    3f5c:	b4850513          	addi	a0,a0,-1208 # 7aa0 <statistics+0x19c8>
    ...
    3f78:	4e450513          	addi	a0,a0,1252 # 7458 <statistics+0x1380>
    ...
    3f94:	b3050513          	addi	a0,a0,-1232 # 7ac0 <statistics+0x19e8>
    ...
    3fb0:	b3c50513          	addi	a0,a0,-1220 # 7ae8 <statistics+0x1a10>
    ...
    3fcc:	b4050513          	addi	a0,a0,-1216 # 7b08 <statistics+0x1a30>
...
0000000000003fe2 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3ff8:	b3450513          	addi	a0,a0,-1228 # 7b28 <statistics+0x1a50>
  ...
  if(chdir("dirfile") == 0){
    ...
    4014:	b1850513          	addi	a0,a0,-1256 # 7b28 <statistics+0x1a50>
  ...
  fd = open("dirfile/xx", 0);
    ...
    4028:	b4c50513          	addi	a0,a0,-1204 # 7b70 <statistics+0x1a98>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4040:	b3450513          	addi	a0,a0,-1228 # 7b70 <statistics+0x1a98>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    4054:	b2050513          	addi	a0,a0,-1248 # 7b70 <statistics+0x1a98>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    4068:	b0c50513          	addi	a0,a0,-1268 # 7b70 <statistics+0x1a98>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    407c:	af858593          	addi	a1,a1,-1288 # 7b70 <statistics+0x1a98>
    4080:	00002517          	auipc	a0,0x2
    4084:	2f050513          	addi	a0,a0,752 # 6370 <statistics+0x298>
  ...
  if(unlink("dirfile") != 0){
    ...
    4098:	a9450513          	addi	a0,a0,-1388 # 7b28 <statistics+0x1a50>
  ...
  fd = open(".", O_RDWR);
    ...
    40ae:	7d650513          	addi	a0,a0,2006 # 6880 <statistics+0x7a8>
  ...
  fd = open(".", 0);
    ...
    40c4:	7c050513          	addi	a0,a0,1984 # 6880 <statistics+0x7a8>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    40d8:	13458593          	addi	a1,a1,308 # 6208 <statistics+0x130>
  ...
  close(fd);
    ...
    4104:	a3050513          	addi	a0,a0,-1488 # 7b30 <statistics+0x1a58>
    ...
    4120:	a3450513          	addi	a0,a0,-1484 # 7b50 <statistics+0x1a78>
    ...
    413c:	a4850513          	addi	a0,a0,-1464 # 7b80 <statistics+0x1aa8>
    ...
    4158:	a2c50513          	addi	a0,a0,-1492 # 7b80 <statistics+0x1aa8>
    ...
    4174:	a3850513          	addi	a0,a0,-1480 # 7ba8 <statistics+0x1ad0>
    ...
    4190:	a4450513          	addi	a0,a0,-1468 # 7bd0 <statistics+0x1af8>
    ...
    41ac:	a5050513          	addi	a0,a0,-1456 # 7bf8 <statistics+0x1b20>
    ...
    41c8:	a5c50513          	addi	a0,a0,-1444 # 7c20 <statistics+0x1b48>
    ...
    41e4:	a6050513          	addi	a0,a0,-1440 # 7c40 <statistics+0x1b68>
    ...
    4200:	a6c50513          	addi	a0,a0,-1428 # 7c68 <statistics+0x1b90>
...
0000000000004216 <iref>:
{
    ...
    4234:	a50a0a13          	addi	s4,s4,-1456 # 7c80 <statistics+0x1ba8>
    mkdir("");
    4238:	00003497          	auipc	s1,0x3
    423c:	55048493          	addi	s1,s1,1360 # 7788 <statistics+0x16b0>
    link("README", "");
    4240:	00002a97          	auipc	s5,0x2
    4244:	130a8a93          	addi	s5,s5,304 # 6370 <statistics+0x298>
    fd = open("xx", O_CREATE);
    4248:	00004997          	auipc	s3,0x4
    424c:	93098993          	addi	s3,s3,-1744 # 7b78 <statistics+0x1aa0>
    4250:	a891                	j	42a4 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    4252:	85da                	mv	a1,s6
    4254:	00004517          	auipc	a0,0x4
    4258:	a3450513          	addi	a0,a0,-1484 # 7c88 <statistics+0x1bb0>
    ...
    4274:	a3050513          	addi	a0,a0,-1488 # 7ca0 <statistics+0x1bc8>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    4308:	1a498993          	addi	s3,s3,420 # 74a8 <statistics+0x13d0>
    unlink("irefd");
    430c:	00004917          	auipc	s2,0x4
    4310:	97490913          	addi	s2,s2,-1676 # 7c80 <statistics+0x1ba8>
    chdir("..");
    4314:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4330:	12450513          	addi	a0,a0,292 # 7450 <statistics+0x1378>
...
0000000000004350 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    4360:	95c50513          	addi	a0,a0,-1700 # 7cb8 <statistics+0x1be0>
  ...
  if(pid == 0){
    ...
    4384:	93850513          	addi	a0,a0,-1736 # 7cb8 <statistics+0x1be0>
    ...
    439a:	94250513          	addi	a0,a0,-1726 # 7cd8 <statistics+0x1c00>
    ...
    43b6:	90e50513          	addi	a0,a0,-1778 # 7cc0 <statistics+0x1be8>
    ...
    43d2:	65250513          	addi	a0,a0,1618 # 6a20 <statistics+0x948>
  ...
  if(unlink("oidir") != 0){
    ...
    4400:	8bc50513          	addi	a0,a0,-1860 # 7cb8 <statistics+0x1be0>
    ...
    4414:	80050513          	addi	a0,a0,-2048 # 6c10 <statistics+0xb38>
...
0000000000004442 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4452:	8b250513          	addi	a0,a0,-1870 # 7d00 <statistics+0x1c28>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    447e:	88650513          	addi	a0,a0,-1914 # 7d00 <statistics+0x1c28>
  ...
  sleep(10); // one second
    ...
    44b6:	72e50513          	addi	a0,a0,1838 # 6be0 <statistics+0xb08>
    ...
    44d0:	83448493          	addi	s1,s1,-1996 # 7d00 <statistics+0x1c28>
    44d4:	4581                	li	a1,0
    44d6:	8526                	mv	a0,s1
...
0000000000004512 <killstatus>:
{
  ...
  exit(0);
    ...
    4578:	4ac50513          	addi	a0,a0,1196 # 6a20 <statistics+0x948>
    ...
    459e:	77650513          	addi	a0,a0,1910 # 7d10 <statistics+0x1c38>
...
00000000000045b4 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    45de:	60650513          	addi	a0,a0,1542 # 6be0 <statistics+0xb08>
  ...
  if(pid2 == 0)
    ...
    460c:	41850513          	addi	a0,a0,1048 # 6a20 <statistics+0x948>
  ...
  if(pid3 == 0){
    ...
    4650:	bbc58593          	addi	a1,a1,-1092 # 6208 <statistics+0x130>
    ...
    467a:	3aa50513          	addi	a0,a0,938 # 6a20 <statistics+0x948>
    ...
    4696:	69e50513          	addi	a0,a0,1694 # 7d30 <statistics+0x1c58>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    46d2:	67a50513          	addi	a0,a0,1658 # 7d48 <statistics+0x1c70>
  ...
  printf("kill... ");
    ...
    46fe:	66650513          	addi	a0,a0,1638 # 7d60 <statistics+0x1c88>
  ...
  printf("wait... ");
    ...
    472c:	64850513          	addi	a0,a0,1608 # 7d70 <statistics+0x1c98>
...
0000000000004758 <reparent>:
{
  ...
  exit(0);
    ...
    47ac:	27850513          	addi	a0,a0,632 # 6a20 <statistics+0x948>
    ...
    47c8:	3e450513          	addi	a0,a0,996 # 6ba8 <statistics+0xad0>
...
0000000000004808 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    483e:	2ee50513          	addi	a0,a0,750 # 6b28 <statistics+0xa50>
    ...
    4872:	99a58593          	addi	a1,a1,-1638 # 6208 <statistics+0x130>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    4936:	44e50513          	addi	a0,a0,1102 # 7d80 <statistics+0x1ca8>
    ...
    4952:	0d250513          	addi	a0,a0,210 # 6a20 <statistics+0x948>
    ...
    499e:	40650513          	addi	a0,a0,1030 # 7da0 <statistics+0x1cc8>
...
00000000000049be <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a42:	39250513          	addi	a0,a0,914 # 7dd0 <statistics+0x1cf8>
...
0000000000004a62 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4af8:	30c50513          	addi	a0,a0,780 # 7e00 <statistics+0x1d28>
    ...
    4b14:	31850513          	addi	a0,a0,792 # 7e28 <statistics+0x1d50>
  ...
  fd = open("sharedfd", 0);
    ...
    4b58:	29c50513          	addi	a0,a0,668 # 7df0 <statistics+0x1d18>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4b98:	2b450513          	addi	a0,a0,692 # 7e48 <statistics+0x1d70>
  ...
  unlink("sharedfd");
    ...
    4bd4:	22050513          	addi	a0,a0,544 # 7df0 <statistics+0x1d18>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4bfa:	27a50513          	addi	a0,a0,634 # 7e70 <statistics+0x1d98>
...
0000000000004c1a <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4c40:	24c78793          	addi	a5,a5,588 # 7e88 <statistics+0x1db0>
    4c44:	f6f43823          	sd	a5,-144(s0)
    4c48:	00003797          	auipc	a5,0x3
    4c4c:	24878793          	addi	a5,a5,584 # 7e90 <statistics+0x1db8>
    4c50:	f6f43c23          	sd	a5,-136(s0)
    4c54:	00003797          	auipc	a5,0x3
    4c58:	24478793          	addi	a5,a5,580 # 7e98 <statistics+0x1dc0>
    4c5c:	f8f43023          	sd	a5,-128(s0)
    4c60:	00003797          	auipc	a5,0x3
    4c64:	24078793          	addi	a5,a5,576 # 7ea0 <statistics+0x1dc8>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4cdc:	15050513          	addi	a0,a0,336 # 6e28 <statistics+0xd50>
    ...
    4d58:	15450513          	addi	a0,a0,340 # 7ea8 <statistics+0x1dd0>
    ...
    4d72:	14a50513          	addi	a0,a0,330 # 7eb8 <statistics+0x1de0>
    ...
    4d9a:	13a50513          	addi	a0,a0,314 # 7ed0 <statistics+0x1df8>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e28:	0bc50513          	addi	a0,a0,188 # 7ee0 <statistics+0x1e08>
...
0000000000004e5c <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4e8a:	072b8b93          	addi	s7,s7,114 # 7ef8 <statistics+0x1e20>
  for(i = 0; i < N; i++){
    ...
    4ecc:	03850513          	addi	a0,a0,56 # 7f00 <statistics+0x1e28>
    ...
    4eea:	01250513          	addi	a0,a0,18 # 7ef8 <statistics+0x1e20>
  ...
  fd = open(".", 0);
    ...
    4f22:	96250513          	addi	a0,a0,-1694 # 6880 <statistics+0x7a8>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4f9a:	f8a50513          	addi	a0,a0,-118 # 7f20 <statistics+0x1e48>
    ...
    4fba:	f8a50513          	addi	a0,a0,-118 # 7f40 <statistics+0x1e68>
  ...
  for(i = 0; i < N; i++){
    ...
    4ff2:	f7a50513          	addi	a0,a0,-134 # 7f68 <statistics+0x1e90>
    ...
    500e:	a1650513          	addi	a0,a0,-1514 # 6a20 <statistics+0x948>
...
00000000000051b8 <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    5240:	d6450513          	addi	a0,a0,-668 # 7fa0 <statistics+0x1ec8>
  ...
  for(i = 0; ; i++){
    ...
    52a4:	d1050513          	addi	a0,a0,-752 # 7fb0 <statistics+0x1ed8>
    ...
    52c0:	d1450513          	addi	a0,a0,-748 # 7fd0 <statistics+0x1ef8>
    ...
    52dc:	d1850513          	addi	a0,a0,-744 # 7ff0 <statistics+0x1f18>
    ...
    52f8:	d1c50513          	addi	a0,a0,-740 # 8010 <statistics+0x1f38>
    ...
    5314:	d2050513          	addi	a0,a0,-736 # 8030 <statistics+0x1f58>
    ...
    5330:	d1c50513          	addi	a0,a0,-740 # 8048 <statistics+0x1f70>
  ...
  unlink("bigfile.dat");
    ...
    535e:	c4650513          	addi	a0,a0,-954 # 7fa0 <statistics+0x1ec8>
    ...
    5382:	cea50513          	addi	a0,a0,-790 # 8068 <statistics+0x1f90>
...
0000000000005398 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    53ba:	cd250513          	addi	a0,a0,-814 # 8088 <statistics+0x1fb0>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    53da:	cc2c8c93          	addi	s9,s9,-830 # 8098 <statistics+0x1fc0>
    int total = 0;
    53de:	4d81                	li	s11,0
    ...
    5454:	c5850513          	addi	a0,a0,-936 # 80a8 <statistics+0x1fd0>
  ...
  printf("fsfull test finished\n");
    ...
    54ca:	c0250513          	addi	a0,a0,-1022 # 80c8 <statistics+0x1ff0>
    ...
    551a:	ba250513          	addi	a0,a0,-1118 # 80b8 <statistics+0x1fe0>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    554c:	b9850513          	addi	a0,a0,-1128 # 80e0 <statistics+0x2008>
  ...
  if(pid == 0) {
    ...
    557c:	b9050513          	addi	a0,a0,-1136 # 8108 <statistics+0x2030>
    ...
    55a0:	b5450513          	addi	a0,a0,-1196 # 80f0 <statistics+0x2018>
    ...
    55c8:	b4c50513          	addi	a0,a0,-1204 # 8110 <statistics+0x2038>
...
runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    5618:	b0450513          	addi	a0,a0,-1276 # 8118 <statistics+0x2040>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    5672:	b9a98993          	addi	s3,s3,-1126 # 6208 <statistics+0x130>
      uint64 a = (uint64) sbrk(4096);
    ...
    56a4:	ad050513          	addi	a0,a0,-1328 # 8170 <statistics+0x2098>
    ...
    56be:	a7650513          	addi	a0,a0,-1418 # 8130 <statistics+0x2058>
    ...
    56d8:	a7c50513          	addi	a0,a0,-1412 # 8150 <statistics+0x2078>
  ...
  while(1){
    ...
    5726:	a6e50513          	addi	a0,a0,-1426 # 8190 <statistics+0x20b8>
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    5788:	a2cb8b93          	addi	s7,s7,-1492 # 81b0 <statistics+0x20d8>
    int free0 = countfree();
    int free1 = 0;
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    589e:	97e58593          	addi	a1,a1,-1666 # 8218 <statistics+0x2140>
    ...
    58b6:	9be58593          	addi	a1,a1,-1602 # 8270 <statistics+0x2198>
    ...
    58cc:	9a058593          	addi	a1,a1,-1632 # 8268 <statistics+0x2190>
  ...
  int continuous = 0;
    ...
    58f8:	92c50513          	addi	a0,a0,-1748 # 8220 <statistics+0x2148>
  ...
  printf("ALL TESTS PASSED\n");
    ...
    5924:	93050513          	addi	a0,a0,-1744 # 8250 <statistics+0x2178>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    5ca8:	99450513          	addi	a0,a0,-1644 # 8638 <digits>
    5cac:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    5d62:	4c55                	li	s8,21
    5d64:	00003c97          	auipc	s9,0x3
    5d68:	87cc8c93          	addi	s9,s9,-1924 # 85e0 <statistics+0x2508>
  ...
  putc(fd, 'x');
    ...
    5d76:	8c6b8b93          	addi	s7,s7,-1850 # 8638 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    5e9c:	74098993          	addi	s3,s3,1856 # 85d8 <statistics+0x2500>
        while(*s != 0){
    5ea0:	85ee                	mv	a1,s11
...
{
    60d8:	7179                	addi	sp,sp,-48
    60da:	f406                	sd	ra,40(sp)
    60dc:	f022                	sd	s0,32(sp)
    60de:	ec26                	sd	s1,24(sp)
    60e0:	e84a                	sd	s2,16(sp)
    60e2:	e44e                	sd	s3,8(sp)
    60e4:	e052                	sd	s4,0(sp)
    60e6:	1800                	addi	s0,sp,48
    60e8:	8a2a                	mv	s4,a0
    60ea:	892e                	mv	s2,a1
  int fd, i, n;
  ...
  fd = open("statistics", O_RDONLY);
    60ec:	4581                	li	a1,0
    60ee:	00002517          	auipc	a0,0x2
    60f2:	56250513          	addi	a0,a0,1378 # 8650 <digits+0x18>
    60f6:	00000097          	auipc	ra,0x0
    60fa:	b0a080e7          	jalr	-1270(ra) # 5c00 <open>
  if(fd < 0) {
    60fe:	04054263          	bltz	a0,6142 <statistics+0x6a>
    6102:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
    6104:	4481                	li	s1,0
    6106:	03205063          	blez	s2,6126 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
    610a:	4099063b          	subw	a2,s2,s1
    610e:	009a05b3          	add	a1,s4,s1
    6112:	854e                	mv	a0,s3
    6114:	00000097          	auipc	ra,0x0
    6118:	ac4080e7          	jalr	-1340(ra) # 5bd8 <read>
    611c:	00054563          	bltz	a0,6126 <statistics+0x4e>
      break;
    }
    i += n;
    6120:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
    6122:	ff24c4e3          	blt	s1,s2,610a <statistics+0x32>
  }
  close(fd);
    6126:	854e                	mv	a0,s3
    6128:	00000097          	auipc	ra,0x0
    612c:	ac0080e7          	jalr	-1344(ra) # 5be8 <close>
  return i;
}
    6130:	8526                	mv	a0,s1
    6132:	70a2                	ld	ra,40(sp)
    6134:	7402                	ld	s0,32(sp)
    6136:	64e2                	ld	s1,24(sp)
    6138:	6942                	ld	s2,16(sp)
    613a:	69a2                	ld	s3,8(sp)
    613c:	6a02                	ld	s4,0(sp)
    613e:	6145                	addi	sp,sp,48
    6140:	8082                	ret
      fprintf(2, "stats: open failed\n");
    6142:	00002597          	auipc	a1,0x2
    6146:	51e58593          	addi	a1,a1,1310 # 8660 <digits+0x28>
    614a:	4509                	li	a0,2
    614c:	00000097          	auipc	ra,0x0
    6150:	dc0080e7          	jalr	-576(ra) # 5f0c <fprintf>
      exit(1);
    6154:	4505                	li	a0,1
    6156:	00000097          	auipc	ra,0x0
    615a:	a6a080e7          	jalr	-1430(ra) # 5bc0 <exit>
