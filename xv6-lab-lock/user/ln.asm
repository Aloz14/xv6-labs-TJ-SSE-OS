...
main(int argc, char *argv[])
{
  ...
  14:	88058593          	addi	a1,a1,-1920 # 890 <statistics+0x92>
  18:	4509                	li	a0,2
  ...
  50:	85c58593          	addi	a1,a1,-1956 # 8a8 <statistics+0xaa>
  54:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ce:	55650513          	addi	a0,a0,1366 # 920 <digits>
 3d2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 48e:	43ec8c93          	addi	s9,s9,1086 # 8c8 <statistics+0xca>
 ...
 49c:	488b8b93          	addi	s7,s7,1160 # 920 <digits>
 ...
 5c2:	30298993          	addi	s3,s3,770 # 8c0 <statistics+0xc2>
        while(*s != 0){
 5c6:	85ee                	mv	a1,s11
...
malloc(uint nbytes)
{
 ...
 7f2:	b80080e7          	jalr	-1152(ra) # 36e <sbrk>
  if(p == (char*)-1)
...
statistics(void *buf, int sz)
{
 ...
 818:	12450513          	addi	a0,a0,292 # 938 <digits+0x18>
 81c:	00000097          	auipc	ra,0x0
 820:	b0a080e7          	jalr	-1270(ra) # 326 <open>
  if(fd < 0) {
 824:	04054263          	bltz	a0,868 <statistics+0x6a>
 828:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 82a:	4481                	li	s1,0
 82c:	03205063          	blez	s2,84c <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 830:	4099063b          	subw	a2,s2,s1
 834:	009a05b3          	add	a1,s4,s1
 838:	854e                	mv	a0,s3
 83a:	00000097          	auipc	ra,0x0
 83e:	ac4080e7          	jalr	-1340(ra) # 2fe <read>
 842:	00054563          	bltz	a0,84c <statistics+0x4e>
      break;
    }
    i += n;
 846:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 848:	ff24c4e3          	blt	s1,s2,830 <statistics+0x32>
  }
  close(fd);
 84c:	854e                	mv	a0,s3
 84e:	00000097          	auipc	ra,0x0
 852:	ac0080e7          	jalr	-1344(ra) # 30e <close>
  return i;
}
 856:	8526                	mv	a0,s1
 858:	70a2                	ld	ra,40(sp)
 85a:	7402                	ld	s0,32(sp)
 85c:	64e2                	ld	s1,24(sp)
 85e:	6942                	ld	s2,16(sp)
 860:	69a2                	ld	s3,8(sp)
 862:	6a02                	ld	s4,0(sp)
 864:	6145                	addi	sp,sp,48
 866:	8082                	ret
      fprintf(2, "stats: open failed\n");
 868:	00000597          	auipc	a1,0x0
 86c:	0e058593          	addi	a1,a1,224 # 948 <digits+0x28>
 870:	4509                	li	a0,2
 872:	00000097          	auipc	ra,0x0
 876:	dc0080e7          	jalr	-576(ra) # 632 <fprintf>
      exit(1);
 87a:	4505                	li	a0,1
 87c:	00000097          	auipc	ra,0x0
 880:	a6a080e7          	jalr	-1430(ra) # 2e6 <exit>
