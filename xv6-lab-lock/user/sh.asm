...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	37e58593          	addi	a1,a1,894 # 1390 <statistics+0x94>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	33858593          	addi	a1,a1,824 # 1398 <statistics+0x9c>
      68:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	30650513          	addi	a0,a0,774 # 13a0 <statistics+0xa4>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	3da70713          	addi	a4,a4,986 # 14a0 <statistics+0x1a4>
    ...
    panic("runcmd");
      ...
      e4:	2c850513          	addi	a0,a0,712 # 13a8 <statistics+0xac>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     106:	2ae58593          	addi	a1,a1,686 # 13b0 <statistics+0xb4>
     10a:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     152:	27258593          	addi	a1,a1,626 # 13c0 <statistics+0xc4>
     156:	4509                	li	a0,2
    ...
    if(fork1() == 0){
     ...
     1e8:	1ec50513          	addi	a0,a0,492 # 13d0 <statistics+0xd4>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5b0:	e4cb8b93          	addi	s7,s7,-436 # 13f8 <statistics+0xfc>
  ...
  while(peek(ps, es, "<>")){
     ...
     5c2:	e1a50513          	addi	a0,a0,-486 # 13d8 <statistics+0xdc>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6aa:	d5a60613          	addi	a2,a2,-678 # 1400 <statistics+0x104>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6da:	d4ab0b13          	addi	s6,s6,-694 # 1420 <statistics+0x124>
  ...
  return ret;
     ...
     714:	cf850513          	addi	a0,a0,-776 # 1408 <statistics+0x10c>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     776:	c9e50513          	addi	a0,a0,-866 # 1410 <statistics+0x114>
...
0000000000000790 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7b0:	c7c60613          	addi	a2,a2,-900 # 1428 <statistics+0x12c>
     7b4:	85ce                	mv	a1,s3
     7b6:	854a                	mv	a0,s2
...
00000000000007fe <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     820:	c14a0a13          	addi	s4,s4,-1004 # 1430 <statistics+0x134>
  ...
  if(peek(ps, es, ";")){
     ...
     856:	be660613          	addi	a2,a2,-1050 # 1438 <statistics+0x13c>
     85a:	85ce                	mv	a1,s3
     85c:	854a                	mv	a0,s2
...
00000000000008a6 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8bc:	b4860613          	addi	a2,a2,-1208 # 1400 <statistics+0x104>
  ...
  if(!peek(ps, es, ")"))
     ...
     8ec:	b6860613          	addi	a2,a2,-1176 # 1450 <statistics+0x154>
     8f0:	85ca                	mv	a1,s2
     8f2:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     92e:	b1650513          	addi	a0,a0,-1258 # 1440 <statistics+0x144>
     932:	fffff097          	auipc	ra,0xfffff
     936:	724080e7          	jalr	1828(ra) # 56 <panic>
    panic("syntax - missing )");
     93a:	00001517          	auipc	a0,0x1
     93e:	b1e50513          	addi	a0,a0,-1250 # 1458 <statistics+0x15c>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     96a:	b5270713          	addi	a4,a4,-1198 # 14b8 <statistics+0x1bc>
...
00000000000009e2 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a16:	a5e60613          	addi	a2,a2,-1442 # 1470 <statistics+0x174>
     a1a:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a4c:	a3058593          	addi	a1,a1,-1488 # 1478 <statistics+0x17c>
     a50:	4509                	li	a0,2
     a52:	00000097          	auipc	ra,0x0
     a56:	6de080e7          	jalr	1758(ra) # 1130 <fprintf>
    panic("syntax");
     a5a:	00001517          	auipc	a0,0x1
     a5e:	9ae50513          	addi	a0,a0,-1618 # 1408 <statistics+0x10c>
...
0000000000000a6a <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a80:	a0c48493          	addi	s1,s1,-1524 # 1488 <statistics+0x18c>
     a84:	4589                	li	a1,2
     a86:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     abe:	9d6a8a93          	addi	s5,s5,-1578 # 1490 <statistics+0x194>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b36:	5fe080e7          	jalr	1534(ra) # 1130 <fprintf>
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     e9a:	f6e080e7          	jalr	-146(ra) # e04 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
     ...
     eae:	f04a                	sd	s2,32(sp)
     eb0:	ec4e                	sd	s3,24(sp)
  ...
  neg = 0;
  if(sgn && xx < 0){
     eb6:	c299                	beqz	a3,ebc <printint+0x16>
     eb8:	0805c963          	bltz	a1,f4a <printint+0xa4>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
     ebc:	2581                	sext.w	a1,a1
  neg = 0;
     ebe:	4881                	li	a7,0
     ec0:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
     ec6:	2601                	sext.w	a2,a2
     ec8:	00000517          	auipc	a0,0x0
     ecc:	66850513          	addi	a0,a0,1640 # 1530 <digits>
     ed0:	883a                	mv	a6,a4
     ed2:	2705                	addiw	a4,a4,1
     ed4:	02c5f7bb          	remuw	a5,a1,a2
     ed8:	1782                	slli	a5,a5,0x20
     eda:	9381                	srli	a5,a5,0x20
     edc:	97aa                	add	a5,a5,a0
     ede:	0007c783          	lbu	a5,0(a5)
     ee2:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
     ee6:	0005879b          	sext.w	a5,a1
     eea:	02c5d5bb          	divuw	a1,a1,a2
     eee:	0685                	addi	a3,a3,1
     ef0:	fec7f0e3          	bgeu	a5,a2,ed0 <printint+0x2a>
  if(neg)
     ef4:	00088c63          	beqz	a7,f0c <printint+0x66>
    buf[i++] = '-';
     ef8:	fd070793          	addi	a5,a4,-48
     efc:	00878733          	add	a4,a5,s0
     f00:	02d00793          	li	a5,45
     f04:	fef70823          	sb	a5,-16(a4)
     f08:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
     f0c:	02e05863          	blez	a4,f3c <printint+0x96>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
     ...
     f86:	4c55                	li	s8,21
     f88:	00000c97          	auipc	s9,0x0
     f8c:	550c8c93          	addi	s9,s9,1360 # 14d8 <statistics+0x1dc>
        ...
        if(s == 0)
          s = "(null)";
        while(*s != 0){
     f90:	02800d93          	li	s11,40
  putc(fd, 'x');
     f94:	4d41                	li	s10,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     f96:	00000b97          	auipc	s7,0x0
     f9a:	59ab8b93          	addi	s7,s7,1434 # 1530 <digits>
     f9e:	a839                	j	fbc <vprintf+0x6a>
        putc(fd, c);
     fa0:	85ca                	mv	a1,s2
     fa2:	8556                	mv	a0,s5
     fa4:	00000097          	auipc	ra,0x0
     fa8:	ee0080e7          	jalr	-288(ra) # e84 <putc>
     fac:	a019                	j	fb2 <vprintf+0x60>
    } else if(state == '%'){
     fae:	01498d63          	beq	s3,s4,fc8 <vprintf+0x76>
  for(i = 0; fmt[i]; i++){
     fb2:	0485                	addi	s1,s1,1
     fb4:	fff4c903          	lbu	s2,-1(s1)
     fb8:	14090d63          	beqz	s2,1112 <vprintf+0x1c0>
    if(state == 0){
     fbc:	fe0999e3          	bnez	s3,fae <vprintf+0x5c>
      if(c == '%'){
     fc0:	ff4910e3          	bne	s2,s4,fa0 <vprintf+0x4e>
        state = '%';
     fc4:	89d2                	mv	s3,s4
     fc6:	b7f5                	j	fb2 <vprintf+0x60>
      if(c == 'd'){
     fc8:	11490c63          	beq	s2,s4,10e0 <vprintf+0x18e>
     fcc:	f9d9079b          	addiw	a5,s2,-99
     fd0:	0ff7f793          	zext.b	a5,a5
     fd4:	10fc6e63          	bltu	s8,a5,10f0 <vprintf+0x19e>
     fd8:	f9d9079b          	addiw	a5,s2,-99
     fdc:	0ff7f713          	zext.b	a4,a5
     fe0:	10ec6863          	bltu	s8,a4,10f0 <vprintf+0x19e>
     fe4:	00271793          	slli	a5,a4,0x2
    ...
    1002:	ea8080e7          	jalr	-344(ra) # ea6 <printint>
    1006:	8b4a                	mv	s6,s2
      } else {
    ...
    101e:	e8c080e7          	jalr	-372(ra) # ea6 <printint>
    1022:	8b4a                	mv	s6,s2
      state = 0;
    1024:	4981                	li	s3,0
    ...
    103a:	e70080e7          	jalr	-400(ra) # ea6 <printint>
    103e:	8b4a                	mv	s6,s2
      state = 0;
    1040:	4981                	li	s3,0
  ...
  putc(fd, '0');
    ...
    105a:	e2e080e7          	jalr	-466(ra) # e84 <putc>
  putc(fd, 'x');
    105e:	07800593          	li	a1,120
    1062:	8556                	mv	a0,s5
    1064:	00000097          	auipc	ra,0x0
    1068:	e20080e7          	jalr	-480(ra) # e84 <putc>
    106c:	896a                	mv	s2,s10
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    106e:	03c9d793          	srli	a5,s3,0x3c
    1072:	97de                	add	a5,a5,s7
    1074:	0007c583          	lbu	a1,0(a5)
    1078:	8556                	mv	a0,s5
    107a:	00000097          	auipc	ra,0x0
    107e:	e0a080e7          	jalr	-502(ra) # e84 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    1082:	0992                	slli	s3,s3,0x4
    1084:	397d                	addiw	s2,s2,-1
    1086:	fe0914e3          	bnez	s2,106e <vprintf+0x11c>
        printptr(fd, va_arg(ap, uint64));
    108a:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    108e:	4981                	li	s3,0
    1090:	b70d                	j	fb2 <vprintf+0x60>
        s = va_arg(ap, char*);
    1092:	008b0913          	addi	s2,s6,8
    1096:	000b3983          	ld	s3,0(s6)
        if(s == 0)
    109a:	02098163          	beqz	s3,10bc <vprintf+0x16a>
        while(*s != 0){
    109e:	0009c583          	lbu	a1,0(s3)
    10a2:	c5ad                	beqz	a1,110c <vprintf+0x1ba>
          putc(fd, *s);
    10a4:	8556                	mv	a0,s5
    10a6:	00000097          	auipc	ra,0x0
    10aa:	dde080e7          	jalr	-546(ra) # e84 <putc>
          s++;
    10ae:	0985                	addi	s3,s3,1
        while(*s != 0){
    10b0:	0009c583          	lbu	a1,0(s3)
    10b4:	f9e5                	bnez	a1,10a4 <vprintf+0x152>
        s = va_arg(ap, char*);
    10b6:	8b4a                	mv	s6,s2
      state = 0;
    10b8:	4981                	li	s3,0
    10ba:	bde5                	j	fb2 <vprintf+0x60>
          s = "(null)";
    10bc:	00000997          	auipc	s3,0x0
    10c0:	41498993          	addi	s3,s3,1044 # 14d0 <statistics+0x1d4>
        while(*s != 0){
    10c4:	85ee                	mv	a1,s11
    10c6:	bff9                	j	10a4 <vprintf+0x152>
        putc(fd, va_arg(ap, uint));
    10c8:	008b0913          	addi	s2,s6,8
    10cc:	000b4583          	lbu	a1,0(s6)
    10d0:	8556                	mv	a0,s5
    10d2:	00000097          	auipc	ra,0x0
    10d6:	db2080e7          	jalr	-590(ra) # e84 <putc>
    10da:	8b4a                	mv	s6,s2
      state = 0;
    10dc:	4981                	li	s3,0
    10de:	bdd1                	j	fb2 <vprintf+0x60>
        putc(fd, c);
    10e0:	85d2                	mv	a1,s4
    10e2:	8556                	mv	a0,s5
    10e4:	00000097          	auipc	ra,0x0
    10e8:	da0080e7          	jalr	-608(ra) # e84 <putc>
      state = 0;
    10ec:	4981                	li	s3,0
    10ee:	b5d1                	j	fb2 <vprintf+0x60>
        putc(fd, '%');
    10f0:	85d2                	mv	a1,s4
    10f2:	8556                	mv	a0,s5
    10f4:	00000097          	auipc	ra,0x0
    10f8:	d90080e7          	jalr	-624(ra) # e84 <putc>
        putc(fd, c);
    10fc:	85ca                	mv	a1,s2
    10fe:	8556                	mv	a0,s5
    1100:	00000097          	auipc	ra,0x0
    1104:	d84080e7          	jalr	-636(ra) # e84 <putc>
      state = 0;
    1108:	4981                	li	s3,0
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12f0:	b80080e7          	jalr	-1152(ra) # e6c <sbrk>
  if(p == (char*)-1)
...
statistics(void *buf, int sz)
{
    ...
    12fe:	f406                	sd	ra,40(sp)
    1300:	f022                	sd	s0,32(sp)
    1302:	ec26                	sd	s1,24(sp)
    1304:	e84a                	sd	s2,16(sp)
    1306:	e44e                	sd	s3,8(sp)
    1308:	e052                	sd	s4,0(sp)
    130a:	1800                	addi	s0,sp,48
    130c:	8a2a                	mv	s4,a0
    130e:	892e                	mv	s2,a1
  int fd, i, n;
  ...
  fd = open("statistics", O_RDONLY);
    1310:	4581                	li	a1,0
    1312:	00000517          	auipc	a0,0x0
    1316:	23650513          	addi	a0,a0,566 # 1548 <digits+0x18>
    131a:	00000097          	auipc	ra,0x0
    131e:	b0a080e7          	jalr	-1270(ra) # e24 <open>
  if(fd < 0) {
    1322:	04054263          	bltz	a0,1366 <statistics+0x6a>
    1326:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
    1328:	4481                	li	s1,0
    132a:	03205063          	blez	s2,134a <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
    132e:	4099063b          	subw	a2,s2,s1
    1332:	009a05b3          	add	a1,s4,s1
    1336:	854e                	mv	a0,s3
    1338:	00000097          	auipc	ra,0x0
    133c:	ac4080e7          	jalr	-1340(ra) # dfc <read>
    1340:	00054563          	bltz	a0,134a <statistics+0x4e>
      break;
    }
    i += n;
    1344:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
    1346:	ff24c4e3          	blt	s1,s2,132e <statistics+0x32>
  }
  close(fd);
    134a:	854e                	mv	a0,s3
    134c:	00000097          	auipc	ra,0x0
    1350:	ac0080e7          	jalr	-1344(ra) # e0c <close>
  return i;
}
    1354:	8526                	mv	a0,s1
    1356:	70a2                	ld	ra,40(sp)
    1358:	7402                	ld	s0,32(sp)
    135a:	64e2                	ld	s1,24(sp)
    135c:	6942                	ld	s2,16(sp)
    135e:	69a2                	ld	s3,8(sp)
    1360:	6a02                	ld	s4,0(sp)
    1362:	6145                	addi	sp,sp,48
    1364:	8082                	ret
      fprintf(2, "stats: open failed\n");
    1366:	00000597          	auipc	a1,0x0
    136a:	1f258593          	addi	a1,a1,498 # 1558 <digits+0x28>
    136e:	4509                	li	a0,2
    1370:	00000097          	auipc	ra,0x0
    1374:	dc0080e7          	jalr	-576(ra) # 1130 <fprintf>
      exit(1);
    1378:	4505                	li	a0,1
    137a:	00000097          	auipc	ra,0x0
    137e:	a6a080e7          	jalr	-1430(ra) # de4 <exit>
