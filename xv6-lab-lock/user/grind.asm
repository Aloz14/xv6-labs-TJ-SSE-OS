...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      9e:	33650513          	addi	a0,a0,822 # 13d0 <statistics+0x8a>
      a2:	00001097          	auipc	ra,0x1
      a6:	df4080e7          	jalr	-524(ra) # e96 <mkdir>
  if(chdir("grindir") != 0){
      aa:	00001517          	auipc	a0,0x1
      ae:	32650513          	addi	a0,a0,806 # 13d0 <statistics+0x8a>
      b2:	00001097          	auipc	ra,0x1
      b6:	dec080e7          	jalr	-532(ra) # e9e <chdir>
      ba:	cd11                	beqz	a0,d6 <go+0x5e>
    printf("grind: chdir grindir failed\n");
      bc:	00001517          	auipc	a0,0x1
      c0:	31c50513          	addi	a0,a0,796 # 13d8 <statistics+0x92>
  ...
  chdir("/");
      ...
      da:	32250513          	addi	a0,a0,802 # 13f8 <statistics+0xb2>
  ...
  while(1){
    ...
    if((iters % 500) == 0)
      ...
      ea:	32298993          	addi	s3,s3,802 # 1408 <statistics+0xc2>
      ee:	c489                	beqz	s1,f8 <go+0x80>
      f0:	00001997          	auipc	s3,0x1
      f4:	31098993          	addi	s3,s3,784 # 1400 <statistics+0xba>
    iters++;
      f8:	4485                	li	s1,1
  int fd = -1;
      fa:	5a7d                	li	s4,-1
      fc:	00001917          	auipc	s2,0x1
     100:	5bc90913          	addi	s2,s2,1468 # 16b8 <statistics+0x372>
    ...
    if(what == 1){
     ...
     10e:	30650513          	addi	a0,a0,774 # 1410 <statistics+0xca>
    ...
    if(what == 1){
     ...
     168:	2bc50513          	addi	a0,a0,700 # 1420 <statistics+0xda>
     ...
     182:	29250513          	addi	a0,a0,658 # 1410 <statistics+0xca>
     ...
     194:	24050513          	addi	a0,a0,576 # 13d0 <statistics+0x8a>
     ...
     1a6:	29650513          	addi	a0,a0,662 # 1438 <statistics+0xf2>
     1aa:	00001097          	auipc	ra,0x1
     1ae:	cd4080e7          	jalr	-812(ra) # e7e <unlink>
      chdir("/");
     1b2:	00001517          	auipc	a0,0x1
     1b6:	24650513          	addi	a0,a0,582 # 13f8 <statistics+0xb2>
     1ba:	00001097          	auipc	ra,0x1
     1be:	ce4080e7          	jalr	-796(ra) # e9e <chdir>
     1c2:	b785                	j	122 <go+0xaa>
        printf("grind: chdir grindir failed\n");
     1c4:	00001517          	auipc	a0,0x1
     1c8:	21450513          	addi	a0,a0,532 # 13d8 <statistics+0x92>
     ...
     1f0:	25450513          	addi	a0,a0,596 # 1440 <statistics+0xfa>
     ...
     212:	24250513          	addi	a0,a0,578 # 1450 <statistics+0x10a>
     ...
     256:	1be50513          	addi	a0,a0,446 # 1410 <statistics+0xca>
     25a:	00001097          	auipc	ra,0x1
     25e:	c3c080e7          	jalr	-964(ra) # e96 <mkdir>
      close(open("a/../a/./a", O_CREATE|O_RDWR));
     262:	20200593          	li	a1,514
     266:	00001517          	auipc	a0,0x1
     26a:	20250513          	addi	a0,a0,514 # 1468 <statistics+0x122>
     ...
     282:	1fa50513          	addi	a0,a0,506 # 1478 <statistics+0x132>
     ...
     294:	1f050513          	addi	a0,a0,496 # 1480 <statistics+0x13a>
     298:	00001097          	auipc	ra,0x1
     29c:	bfe080e7          	jalr	-1026(ra) # e96 <mkdir>
      close(open("grindir/../b/b", O_CREATE|O_RDWR));
     2a0:	20200593          	li	a1,514
     2a4:	00001517          	auipc	a0,0x1
     2a8:	1e450513          	addi	a0,a0,484 # 1488 <statistics+0x142>
     ...
     2c0:	1dc50513          	addi	a0,a0,476 # 1498 <statistics+0x152>
     ...
     2d2:	19250513          	addi	a0,a0,402 # 1460 <statistics+0x11a>
     2d6:	00001097          	auipc	ra,0x1
     2da:	ba8080e7          	jalr	-1112(ra) # e7e <unlink>
      link("../grindir/./../a", "../b");
     2de:	00001597          	auipc	a1,0x1
     2e2:	15a58593          	addi	a1,a1,346 # 1438 <statistics+0xf2>
     2e6:	00001517          	auipc	a0,0x1
     2ea:	1ba50513          	addi	a0,a0,442 # 14a0 <statistics+0x15a>
     ...
     2fc:	1c050513          	addi	a0,a0,448 # 14b8 <statistics+0x172>
     300:	00001097          	auipc	ra,0x1
     304:	b7e080e7          	jalr	-1154(ra) # e7e <unlink>
      link(".././b", "/grindir/../a");
     308:	00001597          	auipc	a1,0x1
     30c:	13858593          	addi	a1,a1,312 # 1440 <statistics+0xfa>
     310:	00001517          	auipc	a0,0x1
     314:	1b850513          	addi	a0,a0,440 # 14c8 <statistics+0x182>
     ...
     348:	18c50513          	addi	a0,a0,396 # 14d0 <statistics+0x18a>
     ...
     396:	13e50513          	addi	a0,a0,318 # 14d0 <statistics+0x18a>
     ...
     3a8:	a8a080e7          	jalr	-1398(ra) # e2e <exit>
      ...
      sbrk(6011);
     3ac:	6505                	lui	a0,0x1
     3ae:	77b50513          	addi	a0,a0,1915 # 177b <digits+0x3>
     ...
     3f6:	0f650513          	addi	a0,a0,246 # 14e8 <statistics+0x1a2>
     ...
     422:	09250513          	addi	a0,a0,146 # 14b0 <statistics+0x16a>
     ...
     444:	09050513          	addi	a0,a0,144 # 14d0 <statistics+0x18a>
     ...
     45e:	09e50513          	addi	a0,a0,158 # 14f8 <statistics+0x1b2>
     ...
     4ac:	02850513          	addi	a0,a0,40 # 14d0 <statistics+0x18a>
     ...
     508:	00c50513          	addi	a0,a0,12 # 1510 <statistics+0x1ca>
     ...
     534:	ff858593          	addi	a1,a1,-8 # 1528 <statistics+0x1e2>
     ...
     636:	e9e50513          	addi	a0,a0,-354 # 14d0 <statistics+0x18a>
     ...
     650:	f2450513          	addi	a0,a0,-220 # 1570 <statistics+0x22a>
     ...
     664:	f1050513          	addi	a0,a0,-240 # 1570 <statistics+0x22a>
     ...
     67c:	eb058593          	addi	a1,a1,-336 # 1528 <statistics+0x1e2>
     ...
     6c2:	eb250513          	addi	a0,a0,-334 # 1570 <statistics+0x22a>
     6c6:	00000097          	auipc	ra,0x0
     6ca:	7b8080e7          	jalr	1976(ra) # e7e <unlink>
     6ce:	bc91                	j	122 <go+0xaa>
        printf("grind: create c failed\n");
     6d0:	00001517          	auipc	a0,0x1
     6d4:	ea850513          	addi	a0,a0,-344 # 1578 <statistics+0x232>
     ...
     6ee:	ea650513          	addi	a0,a0,-346 # 1590 <statistics+0x24a>
     ...
     708:	ea450513          	addi	a0,a0,-348 # 15a8 <statistics+0x262>
     ...
     724:	ea050513          	addi	a0,a0,-352 # 15c0 <statistics+0x27a>
     ...
     73e:	eae50513          	addi	a0,a0,-338 # 15e8 <statistics+0x2a2>
     ...
     826:	e6658593          	addi	a1,a1,-410 # 1688 <statistics+0x342>
     ...
     84a:	e4a50513          	addi	a0,a0,-438 # 1690 <statistics+0x34a>
     ...
     864:	cb058593          	addi	a1,a1,-848 # 1510 <statistics+0x1ca>
     868:	4509                	li	a0,2
     ...
     880:	c9458593          	addi	a1,a1,-876 # 1510 <statistics+0x1ca>
     884:	4509                	li	a0,2
     ...
     8dc:	d3858593          	addi	a1,a1,-712 # 1610 <statistics+0x2ca>
     8e0:	4509                	li	a0,2
     ...
     950:	b8458593          	addi	a1,a1,-1148 # 14d0 <statistics+0x18a>
     954:	4509                	li	a0,2
     ...
     99c:	c7858593          	addi	a1,a1,-904 # 1610 <statistics+0x2ca>
     9a0:	4509                	li	a0,2
     ...
     9e0:	c3458593          	addi	a1,a1,-972 # 1610 <statistics+0x2ca>
     9e4:	4509                	li	a0,2
     ...
     a48:	a8c58593          	addi	a1,a1,-1396 # 14d0 <statistics+0x18a>
     a4c:	4509                	li	a0,2
...
iter()
{
  ...
  unlink("a");
     ...
     a70:	a4450513          	addi	a0,a0,-1468 # 14b0 <statistics+0x16a>
     a74:	00000097          	auipc	ra,0x0
     a78:	40a080e7          	jalr	1034(ra) # e7e <unlink>
  unlink("b");
     a7c:	00001517          	auipc	a0,0x1
     a80:	9e450513          	addi	a0,a0,-1564 # 1460 <statistics+0x11a>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     aba:	a1a50513          	addi	a0,a0,-1510 # 14d0 <statistics+0x18a>
  ...
  if(pid2 == 0){
    ...
    rand_next ^= 7177;
     ...
     ae8:	629c                	ld	a5,0(a3)
     aea:	6709                	lui	a4,0x2
     aec:	c0970713          	addi	a4,a4,-1015 # 1c09 <digits+0x491>
    ...
    printf("grind: fork failed\n");
     ...
     b02:	9d250513          	addi	a0,a0,-1582 # 14d0 <statistics+0x18a>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f16:	86650513          	addi	a0,a0,-1946 # 1778 <digits>
     f1a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
     ...
     fd6:	74ec8c93          	addi	s9,s9,1870 # 1720 <statistics+0x3da>
  ...
  putc(fd, 'x');
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     fe4:	798b8b93          	addi	s7,s7,1944 # 1778 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    110a:	61298993          	addi	s3,s3,1554 # 1718 <statistics+0x3d2>
        while(*s != 0){
    110e:	85ee                	mv	a1,s11
...
statistics(void *buf, int sz)
{
    ...
    1348:	f406                	sd	ra,40(sp)
    134a:	f022                	sd	s0,32(sp)
    134c:	ec26                	sd	s1,24(sp)
    134e:	e84a                	sd	s2,16(sp)
    1350:	e44e                	sd	s3,8(sp)
    1352:	e052                	sd	s4,0(sp)
  ...
  fd = open("statistics", O_RDONLY);
    ...
    1360:	43450513          	addi	a0,a0,1076 # 1790 <digits+0x18>
    1364:	00000097          	auipc	ra,0x0
    1368:	b0a080e7          	jalr	-1270(ra) # e6e <open>
  if(fd < 0) {
    136c:	04054263          	bltz	a0,13b0 <statistics+0x6a>
    1370:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
    1372:	4481                	li	s1,0
    1374:	03205063          	blez	s2,1394 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
    1378:	4099063b          	subw	a2,s2,s1
    137c:	009a05b3          	add	a1,s4,s1
    1380:	854e                	mv	a0,s3
    1382:	00000097          	auipc	ra,0x0
    1386:	ac4080e7          	jalr	-1340(ra) # e46 <read>
    138a:	00054563          	bltz	a0,1394 <statistics+0x4e>
      break;
    }
    i += n;
    138e:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
    1390:	ff24c4e3          	blt	s1,s2,1378 <statistics+0x32>
  }
  close(fd);
    1394:	854e                	mv	a0,s3
    1396:	00000097          	auipc	ra,0x0
    139a:	ac0080e7          	jalr	-1344(ra) # e56 <close>
  return i;
}
    139e:	8526                	mv	a0,s1
    13a0:	70a2                	ld	ra,40(sp)
    13a2:	7402                	ld	s0,32(sp)
    13a4:	64e2                	ld	s1,24(sp)
    13a6:	6942                	ld	s2,16(sp)
    13a8:	69a2                	ld	s3,8(sp)
    13aa:	6a02                	ld	s4,0(sp)
    13ac:	6145                	addi	sp,sp,48
    13ae:	8082                	ret
      fprintf(2, "stats: open failed\n");
    13b0:	00000597          	auipc	a1,0x0
    13b4:	3f058593          	addi	a1,a1,1008 # 17a0 <digits+0x28>
    13b8:	4509                	li	a0,2
    13ba:	00000097          	auipc	ra,0x0
    13be:	dc0080e7          	jalr	-576(ra) # 117a <fprintf>
      exit(1);
    13c2:	4505                	li	a0,1
    13c4:	00000097          	auipc	ra,0x0
    13c8:	a6a080e7          	jalr	-1430(ra) # e2e <exit>
