...
main(int argc, char *argv[])
{
  ...
  1a:	94a78793          	addi	a5,a5,-1718 # 960 <statistics+0xb6>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	90450513          	addi	a0,a0,-1788 # 930 <statistics+0x86>
  ...
  6c:	8e050513          	addi	a0,a0,-1824 # 948 <statistics+0x9e>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	8a250513          	addi	a0,a0,-1886 # 958 <statistics+0xae>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 53a:	442c8c93          	addi	s9,s9,1090 # 978 <statistics+0xce>
 ...
 548:	48cb8b93          	addi	s7,s7,1164 # 9d0 <digits>
 ...
 66e:	30698993          	addi	s3,s3,774 # 970 <statistics+0xc6>
        while(*s != 0){
 672:	85ee                	mv	a1,s11
...
statistics(void *buf, int sz)
{
 ...
 8c4:	12850513          	addi	a0,a0,296 # 9e8 <digits+0x18>
 ...
 918:	0e458593          	addi	a1,a1,228 # 9f8 <digits+0x28>
 91c:	4509                	li	a0,2
