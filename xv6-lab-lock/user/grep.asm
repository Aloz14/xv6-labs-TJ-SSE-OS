...
00000000000001de <main>:
{
 ...
 252:	88258593          	addi	a1,a1,-1918 # ad0 <statistics+0x94>
 256:	4509                	li	a0,2
 ...
 288:	86c50513          	addi	a0,a0,-1940 # af0 <statistics+0xb4>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 60c:	56050513          	addi	a0,a0,1376 # b68 <digits>
 610:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6cc:	448c8c93          	addi	s9,s9,1096 # b10 <statistics+0xd4>
 ...
 6da:	492b8b93          	addi	s7,s7,1170 # b68 <digits>
 ...
 800:	30c98993          	addi	s3,s3,780 # b08 <statistics+0xcc>
        while(*s != 0){
 804:	85ee                	mv	a1,s11
...
statistics(void *buf, int sz)
{
 ...
 a56:	12e50513          	addi	a0,a0,302 # b80 <digits+0x18>
 a5a:	00000097          	auipc	ra,0x0
 a5e:	b0a080e7          	jalr	-1270(ra) # 564 <open>
  if(fd < 0) {
 a62:	04054263          	bltz	a0,aa6 <statistics+0x6a>
 a66:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 a68:	4481                	li	s1,0
 a6a:	03205063          	blez	s2,a8a <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 a6e:	4099063b          	subw	a2,s2,s1
 a72:	009a05b3          	add	a1,s4,s1
 a76:	854e                	mv	a0,s3
 a78:	00000097          	auipc	ra,0x0
 a7c:	ac4080e7          	jalr	-1340(ra) # 53c <read>
 a80:	00054563          	bltz	a0,a8a <statistics+0x4e>
      break;
    }
    i += n;
 a84:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 a86:	ff24c4e3          	blt	s1,s2,a6e <statistics+0x32>
  }
  close(fd);
 a8a:	854e                	mv	a0,s3
 a8c:	00000097          	auipc	ra,0x0
 a90:	ac0080e7          	jalr	-1344(ra) # 54c <close>
  return i;
}
 a94:	8526                	mv	a0,s1
 a96:	70a2                	ld	ra,40(sp)
 a98:	7402                	ld	s0,32(sp)
 a9a:	64e2                	ld	s1,24(sp)
 a9c:	6942                	ld	s2,16(sp)
 a9e:	69a2                	ld	s3,8(sp)
 aa0:	6a02                	ld	s4,0(sp)
 aa2:	6145                	addi	sp,sp,48
 aa4:	8082                	ret
      fprintf(2, "stats: open failed\n");
 aa6:	00000597          	auipc	a1,0x0
 aaa:	0ea58593          	addi	a1,a1,234 # b90 <digits+0x28>
 aae:	4509                	li	a0,2
 ab0:	00000097          	auipc	ra,0x0
 ab4:	dc0080e7          	jalr	-576(ra) # 870 <fprintf>
      exit(1);
 ab8:	4505                	li	a0,1
 aba:	00000097          	auipc	ra,0x0
 abe:	a6a080e7          	jalr	-1430(ra) # 524 <exit>
