...
ls(char *path)
{
 ...
 12c:	a0850513          	addi	a0,a0,-1528 # b30 <statistics+0xbc>
 ...
 16a:	99a58593          	addi	a1,a1,-1638 # b00 <statistics+0x8c>
 16e:	4509                	li	a0,2
 ...
 180:	99c58593          	addi	a1,a1,-1636 # b18 <statistics+0xa4>
 184:	4509                	li	a0,2
 ...
 1b2:	99250513          	addi	a0,a0,-1646 # b40 <statistics+0xcc>
 ...
 1f6:	966a0a13          	addi	s4,s4,-1690 # b58 <statistics+0xe4>
        printf("ls: cannot stat %s\n", buf);
 1fa:	00001a97          	auipc	s5,0x1
 1fe:	91ea8a93          	addi	s5,s5,-1762 # b18 <statistics+0xa4>
 ...
 276:	664080e7          	jalr	1636(ra) # 8d6 <printf>
...
main(int argc, char *argv[])
{
 ...
 2c0:	8ac50513          	addi	a0,a0,-1876 # b68 <statistics+0xf4>
...
putc(int fd, char c)
{
 ...
 612:	f6e080e7          	jalr	-146(ra) # 57c <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 644:	59050513          	addi	a0,a0,1424 # bd0 <digits>
 648:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 704:	478c8c93          	addi	s9,s9,1144 # b78 <statistics+0x104>
 ...
 712:	4c2b8b93          	addi	s7,s7,1218 # bd0 <digits>
 ...
 838:	33c98993          	addi	s3,s3,828 # b70 <statistics+0xfc>
        while(*s != 0){
 83c:	85ee                	mv	a1,s11
...
malloc(uint nbytes)
{
 ...
 9ea:	63a78793          	addi	a5,a5,1594 # 1020 <base>
 ...
 a68:	b80080e7          	jalr	-1152(ra) # 5e4 <sbrk>
  if(p == (char*)-1)
...
statistics(void *buf, int sz)
{
 ...
 a8e:	15e50513          	addi	a0,a0,350 # be8 <digits+0x18>
 a92:	00000097          	auipc	ra,0x0
 a96:	b0a080e7          	jalr	-1270(ra) # 59c <open>
  if(fd < 0) {
 a9a:	04054263          	bltz	a0,ade <statistics+0x6a>
 a9e:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 aa0:	4481                	li	s1,0
 aa2:	03205063          	blez	s2,ac2 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 aa6:	4099063b          	subw	a2,s2,s1
 aaa:	009a05b3          	add	a1,s4,s1
 aae:	854e                	mv	a0,s3
 ab0:	00000097          	auipc	ra,0x0
 ab4:	ac4080e7          	jalr	-1340(ra) # 574 <read>
 ab8:	00054563          	bltz	a0,ac2 <statistics+0x4e>
      break;
    }
    i += n;
 abc:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 abe:	ff24c4e3          	blt	s1,s2,aa6 <statistics+0x32>
  }
  close(fd);
 ac2:	854e                	mv	a0,s3
 ac4:	00000097          	auipc	ra,0x0
 ac8:	ac0080e7          	jalr	-1344(ra) # 584 <close>
  return i;
}
 acc:	8526                	mv	a0,s1
 ...
 adc:	8082                	ret
      fprintf(2, "stats: open failed\n");
 ade:	00000597          	auipc	a1,0x0
 ae2:	11a58593          	addi	a1,a1,282 # bf8 <digits+0x28>
 ae6:	4509                	li	a0,2
 ae8:	00000097          	auipc	ra,0x0
 aec:	dc0080e7          	jalr	-576(ra) # 8a8 <fprintf>
      exit(1);
 af0:	4505                	li	a0,1
 af2:	00000097          	auipc	ra,0x0
 af6:	a6a080e7          	jalr	-1430(ra) # 55c <exit>
