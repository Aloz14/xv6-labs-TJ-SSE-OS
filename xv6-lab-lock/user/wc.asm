...
wc(int fd, char *name)
{
  ...
  3c:	988a0a13          	addi	s4,s4,-1656 # 9c0 <statistics+0x8c>
        inword = 0;
  40:	4b01                	li	s6,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  ba:	92250513          	addi	a0,a0,-1758 # 9d8 <statistics+0xa4>
  ...
  e8:	8e450513          	addi	a0,a0,-1820 # 9c8 <statistics+0x94>
...
main(int argc, char *argv[])
{
 ...
 162:	88a58593          	addi	a1,a1,-1910 # 9e8 <statistics+0xb4>
 166:	4501                	li	a0,0
 ...
 180:	87450513          	addi	a0,a0,-1932 # 9f0 <statistics+0xbc>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 504:	56850513          	addi	a0,a0,1384 # a68 <digits>
 508:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5c4:	450c8c93          	addi	s9,s9,1104 # a10 <statistics+0xdc>
 ...
 5d2:	49ab8b93          	addi	s7,s7,1178 # a68 <digits>
 ...
 6f8:	31498993          	addi	s3,s3,788 # a08 <statistics+0xd4>
        while(*s != 0){
 6fc:	85ee                	mv	a1,s11
...
statistics(void *buf, int sz)
{
 ...
 94e:	13650513          	addi	a0,a0,310 # a80 <digits+0x18>
 952:	00000097          	auipc	ra,0x0
 956:	b0a080e7          	jalr	-1270(ra) # 45c <open>
  if(fd < 0) {
 95a:	04054263          	bltz	a0,99e <statistics+0x6a>
 95e:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 960:	4481                	li	s1,0
 962:	03205063          	blez	s2,982 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 966:	4099063b          	subw	a2,s2,s1
 96a:	009a05b3          	add	a1,s4,s1
 96e:	854e                	mv	a0,s3
 970:	00000097          	auipc	ra,0x0
 974:	ac4080e7          	jalr	-1340(ra) # 434 <read>
 978:	00054563          	bltz	a0,982 <statistics+0x4e>
      break;
    }
    i += n;
 97c:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 97e:	ff24c4e3          	blt	s1,s2,966 <statistics+0x32>
  }
  close(fd);
 982:	854e                	mv	a0,s3
 984:	00000097          	auipc	ra,0x0
 988:	ac0080e7          	jalr	-1344(ra) # 444 <close>
  return i;
}
 98c:	8526                	mv	a0,s1
 ...
 9a2:	0f258593          	addi	a1,a1,242 # a90 <digits+0x28>
 9a6:	4509                	li	a0,2
 9a8:	00000097          	auipc	ra,0x0
 9ac:	dc0080e7          	jalr	-576(ra) # 768 <fprintf>
      exit(1);
 9b0:	4505                	li	a0,1
 9b2:	00000097          	auipc	ra,0x0
 9b6:	a6a080e7          	jalr	-1430(ra) # 41c <exit>
