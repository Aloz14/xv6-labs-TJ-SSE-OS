...
main(int argc, char *argv[])
{
  ...
  42:	86258593          	addi	a1,a1,-1950 # 8a0 <statistics+0x8a>
  46:	4509                	li	a0,2
  ...
  60:	85c58593          	addi	a1,a1,-1956 # 8b8 <statistics+0xa2>
  64:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e6:	55650513          	addi	a0,a0,1366 # 938 <digits>
 3ea:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a6:	43ec8c93          	addi	s9,s9,1086 # 8e0 <statistics+0xca>
 ...
 4b4:	488b8b93          	addi	s7,s7,1160 # 938 <digits>
 ...
 5da:	30298993          	addi	s3,s3,770 # 8d8 <statistics+0xc2>
        while(*s != 0){
 5de:	85ee                	mv	a1,s11
...
statistics(void *buf, int sz)
{
 ...
 830:	12450513          	addi	a0,a0,292 # 950 <digits+0x18>
 834:	00000097          	auipc	ra,0x0
 838:	b0a080e7          	jalr	-1270(ra) # 33e <open>
  if(fd < 0) {
 83c:	04054263          	bltz	a0,880 <statistics+0x6a>
 840:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 842:	4481                	li	s1,0
 844:	03205063          	blez	s2,864 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 848:	4099063b          	subw	a2,s2,s1
 84c:	009a05b3          	add	a1,s4,s1
 850:	854e                	mv	a0,s3
 852:	00000097          	auipc	ra,0x0
 856:	ac4080e7          	jalr	-1340(ra) # 316 <read>
 85a:	00054563          	bltz	a0,864 <statistics+0x4e>
      break;
    }
    i += n;
 85e:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 860:	ff24c4e3          	blt	s1,s2,848 <statistics+0x32>
  }
  close(fd);
 864:	854e                	mv	a0,s3
 866:	00000097          	auipc	ra,0x0
 86a:	ac0080e7          	jalr	-1344(ra) # 326 <close>
  return i;
}
 86e:	8526                	mv	a0,s1
 ...
 87e:	8082                	ret
      fprintf(2, "stats: open failed\n");
 880:	00000597          	auipc	a1,0x0
 884:	0e058593          	addi	a1,a1,224 # 960 <digits+0x28>
 888:	4509                	li	a0,2
 88a:	00000097          	auipc	ra,0x0
 88e:	dc0080e7          	jalr	-576(ra) # 64a <fprintf>
      exit(1);
 892:	4505                	li	a0,1
 894:	00000097          	auipc	ra,0x0
 898:	a6a080e7          	jalr	-1430(ra) # 2fe <exit>
