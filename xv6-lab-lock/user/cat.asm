...
cat(int fd)
{
  ...
  44:	91058593          	addi	a1,a1,-1776 # 950 <statistics+0x94>
  48:	4509                	li	a0,2
  ...
  72:	8fa58593          	addi	a1,a1,-1798 # 968 <statistics+0xac>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 106:	87e58593          	addi	a1,a1,-1922 # 980 <statistics+0xc4>
 10a:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 48c:	57050513          	addi	a0,a0,1392 # 9f8 <digits>
 490:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 54c:	458c8c93          	addi	s9,s9,1112 # 9a0 <statistics+0xe4>
 ...
 55a:	4a2b8b93          	addi	s7,s7,1186 # 9f8 <digits>
 ...
 680:	31c98993          	addi	s3,s3,796 # 998 <statistics+0xdc>
        while(*s != 0){
 684:	85ee                	mv	a1,s11
...
statistics(void *buf, int sz)
{
 ...
 8d6:	13e50513          	addi	a0,a0,318 # a10 <digits+0x18>
 8da:	00000097          	auipc	ra,0x0
 8de:	b0a080e7          	jalr	-1270(ra) # 3e4 <open>
  if(fd < 0) {
 8e2:	04054263          	bltz	a0,926 <statistics+0x6a>
 8e6:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 8e8:	4481                	li	s1,0
 8ea:	03205063          	blez	s2,90a <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 8ee:	4099063b          	subw	a2,s2,s1
 8f2:	009a05b3          	add	a1,s4,s1
 8f6:	854e                	mv	a0,s3
 8f8:	00000097          	auipc	ra,0x0
 8fc:	ac4080e7          	jalr	-1340(ra) # 3bc <read>
 900:	00054563          	bltz	a0,90a <statistics+0x4e>
      break;
    }
    i += n;
 904:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 906:	ff24c4e3          	blt	s1,s2,8ee <statistics+0x32>
  }
  close(fd);
 90a:	854e                	mv	a0,s3
 90c:	00000097          	auipc	ra,0x0
 910:	ac0080e7          	jalr	-1344(ra) # 3cc <close>
  return i;
}
 914:	8526                	mv	a0,s1
 ...
 924:	8082                	ret
      fprintf(2, "stats: open failed\n");
 926:	00000597          	auipc	a1,0x0
 92a:	0fa58593          	addi	a1,a1,250 # a20 <digits+0x28>
 92e:	4509                	li	a0,2
 930:	00000097          	auipc	ra,0x0
 934:	dc0080e7          	jalr	-576(ra) # 6f0 <fprintf>
      exit(1);
 938:	4505                	li	a0,1
 93a:	00000097          	auipc	ra,0x0
 93e:	a6a080e7          	jalr	-1430(ra) # 3a4 <exit>
