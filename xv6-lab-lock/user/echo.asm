...
main(int argc, char *argv[])
{
  ...
  2e:	886a0a13          	addi	s4,s4,-1914 # 8b0 <statistics+0x8e>
    write(1, argv[i], strlen(argv[i]));
  ...
  6c:	85058593          	addi	a1,a1,-1968 # 8b8 <statistics+0x96>
  70:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f2:	53250513          	addi	a0,a0,1330 # 920 <digits>
 3f6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4b2:	41ac8c93          	addi	s9,s9,1050 # 8c8 <statistics+0xa6>
 ...
 4c0:	464b8b93          	addi	s7,s7,1124 # 920 <digits>
 ...
 5e6:	2de98993          	addi	s3,s3,734 # 8c0 <statistics+0x9e>
        while(*s != 0){
 5ea:	85ee                	mv	a1,s11
...
statistics(void *buf, int sz)
{
 ...
 83c:	10050513          	addi	a0,a0,256 # 938 <digits+0x18>
 840:	00000097          	auipc	ra,0x0
 844:	b0a080e7          	jalr	-1270(ra) # 34a <open>
  if(fd < 0) {
 848:	04054263          	bltz	a0,88c <statistics+0x6a>
 84c:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 84e:	4481                	li	s1,0
 850:	03205063          	blez	s2,870 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 854:	4099063b          	subw	a2,s2,s1
 858:	009a05b3          	add	a1,s4,s1
 85c:	854e                	mv	a0,s3
 85e:	00000097          	auipc	ra,0x0
 862:	ac4080e7          	jalr	-1340(ra) # 322 <read>
 866:	00054563          	bltz	a0,870 <statistics+0x4e>
      break;
    }
    i += n;
 86a:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 86c:	ff24c4e3          	blt	s1,s2,854 <statistics+0x32>
  }
  close(fd);
 870:	854e                	mv	a0,s3
 872:	00000097          	auipc	ra,0x0
 876:	ac0080e7          	jalr	-1344(ra) # 332 <close>
  return i;
}
 87a:	8526                	mv	a0,s1
 87c:	70a2                	ld	ra,40(sp)
 87e:	7402                	ld	s0,32(sp)
 880:	64e2                	ld	s1,24(sp)
 882:	6942                	ld	s2,16(sp)
 884:	69a2                	ld	s3,8(sp)
 886:	6a02                	ld	s4,0(sp)
 ...
 890:	0bc58593          	addi	a1,a1,188 # 948 <digits+0x28>
 894:	4509                	li	a0,2
 896:	00000097          	auipc	ra,0x0
 89a:	dc0080e7          	jalr	-576(ra) # 656 <fprintf>
      exit(1);
 89e:	4505                	li	a0,1
 8a0:	00000097          	auipc	ra,0x0
 8a4:	a6a080e7          	jalr	-1430(ra) # 30a <exit>
