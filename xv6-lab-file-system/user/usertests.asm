...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	0b250513          	addi	a0,a0,178 # 60f0 <malloc+0xf2>
      ...
      74:	8082                	ret
{
      ...
      84:	09050513          	addi	a0,a0,144 # 6110 <malloc+0x112>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	08050513          	addi	a0,a0,128 # 6128 <malloc+0x12a>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	08250513          	addi	a0,a0,130 # 6148 <malloc+0x14a>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	04a50513          	addi	a0,a0,74 # 6130 <malloc+0x132>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	05650513          	addi	a0,a0,86 # 6158 <malloc+0x15a>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	05450513          	addi	a0,a0,84 # 6180 <malloc+0x182>
     134:	00006097          	auipc	ra,0x6
     138:	ae0080e7          	jalr	-1312(ra) # 5c14 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	04050513          	addi	a0,a0,64 # 6180 <malloc+0x182>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	03c58593          	addi	a1,a1,60 # 6190 <malloc+0x192>
     15c:	00006097          	auipc	ra,0x6
     160:	a88080e7          	jalr	-1400(ra) # 5be4 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	01850513          	addi	a0,a0,24 # 6180 <malloc+0x182>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	01c58593          	addi	a1,a1,28 # 6198 <malloc+0x19a>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	fec50513          	addi	a0,a0,-20 # 6180 <malloc+0x182>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	fd650513          	addi	a0,a0,-42 # 61a0 <malloc+0x1a2>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	f4c50513          	addi	a0,a0,-180 # 61c8 <malloc+0x1ca>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	f38a8a93          	addi	s5,s5,-200 # 61c8 <malloc+0x1ca>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	ec650513          	addi	a0,a0,-314 # 61d8 <malloc+0x1da>
     ...
     338:	ec450513          	addi	a0,a0,-316 # 61f8 <malloc+0x1fa>
     33c:	00006097          	auipc	ra,0x6
     340:	c0a080e7          	jalr	-1014(ra) # 5f46 <printf>
        exit(1);
     344:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     362:	eb250513          	addi	a0,a0,-334 # 6210 <malloc+0x212>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     376:	e9e98993          	addi	s3,s3,-354 # 6210 <malloc+0x212>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c2:	e5250513          	addi	a0,a0,-430 # 6210 <malloc+0x212>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3da:	dc258593          	addi	a1,a1,-574 # 6198 <malloc+0x19a>
    ...
    printf("write failed\n");
     ...
     3f0:	e4450513          	addi	a0,a0,-444 # 6230 <malloc+0x232>
     3f4:	00006097          	auipc	ra,0x6
     3f8:	b52080e7          	jalr	-1198(ra) # 5f46 <printf>
    exit(1);
     3fc:	4505                	li	a0,1
     ...
     40a:	e1250513          	addi	a0,a0,-494 # 6218 <malloc+0x21a>
     40e:	00006097          	auipc	ra,0x6
     412:	b38080e7          	jalr	-1224(ra) # 5f46 <printf>
      exit(1);
     416:	4505                	li	a0,1
    ...
    printf("open junk failed\n");
     ...
     424:	df850513          	addi	a0,a0,-520 # 6218 <malloc+0x21a>
     428:	00006097          	auipc	ra,0x6
     42c:	b1e080e7          	jalr	-1250(ra) # 5f46 <printf>
    exit(1);
     430:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     448:	dcc50513          	addi	a0,a0,-564 # 6210 <malloc+0x212>
...
000000000000052e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     554:	cf0a0a13          	addi	s4,s4,-784 # 6240 <malloc+0x242>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     600:	c4c50513          	addi	a0,a0,-948 # 6248 <malloc+0x24a>
     604:	00006097          	auipc	ra,0x6
     608:	942080e7          	jalr	-1726(ra) # 5f46 <printf>
      exit(1);
     60c:	4505                	li	a0,1
     ...
     61e:	c4650513          	addi	a0,a0,-954 # 6260 <malloc+0x262>
     622:	00006097          	auipc	ra,0x6
     626:	924080e7          	jalr	-1756(ra) # 5f46 <printf>
      exit(1);
     62a:	4505                	li	a0,1
     ...
     63c:	c5850513          	addi	a0,a0,-936 # 6290 <malloc+0x292>
     640:	00006097          	auipc	ra,0x6
     644:	906080e7          	jalr	-1786(ra) # 5f46 <printf>
      exit(1);
     648:	4505                	li	a0,1
     ...
     656:	c6e50513          	addi	a0,a0,-914 # 62c0 <malloc+0x2c2>
     65a:	00006097          	auipc	ra,0x6
     65e:	8ec080e7          	jalr	-1812(ra) # 5f46 <printf>
      exit(1);
     662:	4505                	li	a0,1
     ...
     674:	c6050513          	addi	a0,a0,-928 # 62d0 <malloc+0x2d2>
     678:	00006097          	auipc	ra,0x6
     67c:	8ce080e7          	jalr	-1842(ra) # 5f46 <printf>
      exit(1);
     680:	4505                	li	a0,1
...
000000000000068a <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b2:	c52a0a13          	addi	s4,s4,-942 # 6300 <malloc+0x302>
    n = write(fds[1], "x", 1);
     6b6:	00006a97          	auipc	s5,0x6
     6ba:	ae2a8a93          	addi	s5,s5,-1310 # 6198 <malloc+0x19a>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     760:	bac50513          	addi	a0,a0,-1108 # 6308 <malloc+0x30a>
     764:	00005097          	auipc	ra,0x5
     768:	7e2080e7          	jalr	2018(ra) # 5f46 <printf>
      exit(1);
     76c:	4505                	li	a0,1
     ...
     77e:	ba650513          	addi	a0,a0,-1114 # 6320 <malloc+0x322>
     782:	00005097          	auipc	ra,0x5
     786:	7c4080e7          	jalr	1988(ra) # 5f46 <printf>
      exit(1);
     78a:	4505                	li	a0,1
     ...
     798:	b2c50513          	addi	a0,a0,-1236 # 62c0 <malloc+0x2c2>
     79c:	00005097          	auipc	ra,0x5
     7a0:	7aa080e7          	jalr	1962(ra) # 5f46 <printf>
      exit(1);
     7a4:	4505                	li	a0,1
     ...
     7b2:	ba250513          	addi	a0,a0,-1118 # 6350 <malloc+0x352>
     7b6:	00005097          	auipc	ra,0x5
     7ba:	790080e7          	jalr	1936(ra) # 5f46 <printf>
      exit(1);
     7be:	4505                	li	a0,1
     ...
     7d0:	b9c50513          	addi	a0,a0,-1124 # 6368 <malloc+0x36a>
     7d4:	00005097          	auipc	ra,0x5
     7d8:	772080e7          	jalr	1906(ra) # 5f46 <printf>
      exit(1);
     7dc:	4505                	li	a0,1
...
00000000000007e6 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     826:	96e58593          	addi	a1,a1,-1682 # 6190 <malloc+0x192>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     842:	94250513          	addi	a0,a0,-1726 # 6180 <malloc+0x182>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     86e:	91650513          	addi	a0,a0,-1770 # 6180 <malloc+0x182>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     882:	90250513          	addi	a0,a0,-1790 # 6180 <malloc+0x182>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c0:	b3c58593          	addi	a1,a1,-1220 # 63f8 <malloc+0x3fa>
     8c4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     902:	88250513          	addi	a0,a0,-1918 # 6180 <malloc+0x182>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     946:	a5650513          	addi	a0,a0,-1450 # 6398 <malloc+0x39a>
     94a:	00005097          	auipc	ra,0x5
     94e:	5fc080e7          	jalr	1532(ra) # 5f46 <printf>
    exit(1);
     952:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     962:	a5a50513          	addi	a0,a0,-1446 # 63b8 <malloc+0x3ba>
     966:	00005097          	auipc	ra,0x5
     96a:	5e0080e7          	jalr	1504(ra) # 5f46 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     96e:	8652                	mv	a2,s4
     970:	85d6                	mv	a1,s5
     972:	00006517          	auipc	a0,0x6
     976:	a5650513          	addi	a0,a0,-1450 # 63c8 <malloc+0x3ca>
     97a:	00005097          	auipc	ra,0x5
     97e:	5cc080e7          	jalr	1484(ra) # 5f46 <printf>
    exit(1);
     982:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     992:	a5a50513          	addi	a0,a0,-1446 # 63e8 <malloc+0x3ea>
     996:	00005097          	auipc	ra,0x5
     99a:	5b0080e7          	jalr	1456(ra) # 5f46 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     99e:	8652                	mv	a2,s4
     9a0:	85d6                	mv	a1,s5
     9a2:	00006517          	auipc	a0,0x6
     9a6:	a2650513          	addi	a0,a0,-1498 # 63c8 <malloc+0x3ca>
     9aa:	00005097          	auipc	ra,0x5
     9ae:	59c080e7          	jalr	1436(ra) # 5f46 <printf>
    exit(1);
     9b2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c4:	a4050513          	addi	a0,a0,-1472 # 6400 <malloc+0x402>
     9c8:	00005097          	auipc	ra,0x5
     9cc:	57e080e7          	jalr	1406(ra) # 5f46 <printf>
    exit(1);
     9d0:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e2:	a4250513          	addi	a0,a0,-1470 # 6420 <malloc+0x422>
     9e6:	00005097          	auipc	ra,0x5
     9ea:	560080e7          	jalr	1376(ra) # 5f46 <printf>
    exit(1);
     9ee:	4505                	li	a0,1
...
00000000000009f8 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a16:	a2e50513          	addi	a0,a0,-1490 # 6440 <malloc+0x442>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a2e:	a3e98993          	addi	s3,s3,-1474 # 6468 <malloc+0x46a>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a32:	00006a97          	auipc	s5,0x6
     a36:	a6ea8a93          	addi	s5,s5,-1426 # 64a0 <malloc+0x4a2>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7c:	9c850513          	addi	a0,a0,-1592 # 6440 <malloc+0x442>
  ...
  if(unlink("small") < 0){
     ...
     ab8:	98c50513          	addi	a0,a0,-1652 # 6440 <malloc+0x442>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae2:	96a50513          	addi	a0,a0,-1686 # 6448 <malloc+0x44a>
     ae6:	00005097          	auipc	ra,0x5
     aea:	460080e7          	jalr	1120(ra) # 5f46 <printf>
    exit(1);
     aee:	4505                	li	a0,1
     ...
     b00:	97c50513          	addi	a0,a0,-1668 # 6478 <malloc+0x47a>
     b04:	00005097          	auipc	ra,0x5
     b08:	442080e7          	jalr	1090(ra) # 5f46 <printf>
      exit(1);
     b0c:	4505                	li	a0,1
     ...
     b1e:	99650513          	addi	a0,a0,-1642 # 64b0 <malloc+0x4b2>
     b22:	00005097          	auipc	ra,0x5
     b26:	424080e7          	jalr	1060(ra) # 5f46 <printf>
      exit(1);
     b2a:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3a:	9a250513          	addi	a0,a0,-1630 # 64d8 <malloc+0x4da>
     b3e:	00005097          	auipc	ra,0x5
     b42:	408080e7          	jalr	1032(ra) # 5f46 <printf>
    exit(1);
     b46:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     b56:	9a650513          	addi	a0,a0,-1626 # 64f8 <malloc+0x4fa>
     b5a:	00005097          	auipc	ra,0x5
     b5e:	3ec080e7          	jalr	1004(ra) # 5f46 <printf>
    exit(1);
     b62:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b72:	9a250513          	addi	a0,a0,-1630 # 6510 <malloc+0x512>
     b76:	00005097          	auipc	ra,0x5
     b7a:	3d0080e7          	jalr	976(ra) # 5f46 <printf>
    exit(1);
     b7e:	4505                	li	a0,1
...
0000000000000b88 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba4:	99050513          	addi	a0,a0,-1648 # 6530 <malloc+0x532>
  ...
  fd = open("big", O_RDONLY);
     ...
     bf8:	93c50513          	addi	a0,a0,-1732 # 6530 <malloc+0x532>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c40:	8fc50513          	addi	a0,a0,-1796 # 6538 <malloc+0x53a>
    ...
    exit(1);
     ...
     c5e:	8fe50513          	addi	a0,a0,-1794 # 6558 <malloc+0x55a>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c7a:	90a50513          	addi	a0,a0,-1782 # 6580 <malloc+0x582>
  ...
  if(unlink("big") < 0){
     ...
     ca8:	88c50513          	addi	a0,a0,-1908 # 6530 <malloc+0x532>
     ...
     cd2:	8d250513          	addi	a0,a0,-1838 # 65a0 <malloc+0x5a2>
     ...
     cf0:	8dc50513          	addi	a0,a0,-1828 # 65c8 <malloc+0x5ca>
     ...
     d0e:	8d650513          	addi	a0,a0,-1834 # 65e0 <malloc+0x5e2>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d2a:	8e250513          	addi	a0,a0,-1822 # 6608 <malloc+0x60a>
...
0000000000000d40 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d58:	8cc50513          	addi	a0,a0,-1844 # 6620 <malloc+0x622>
  ...
  write(fd, "hello", SZ);
     ...
     d70:	8e458593          	addi	a1,a1,-1820 # 6650 <malloc+0x652>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8c:	89850513          	addi	a0,a0,-1896 # 6620 <malloc+0x622>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da2:	88250513          	addi	a0,a0,-1918 # 6620 <malloc+0x622>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db8:	86c50513          	addi	a0,a0,-1940 # 6620 <malloc+0x622>
  ...
  write(fd1, "yyy", 3);
     ...
     dcc:	8d058593          	addi	a1,a1,-1840 # 6698 <malloc+0x69a>
  ...
  unlink("unlinkread");
     ...
     e34:	7f050513          	addi	a0,a0,2032 # 6620 <malloc+0x622>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e54:	7e050513          	addi	a0,a0,2016 # 6630 <malloc+0x632>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e70:	7ec50513          	addi	a0,a0,2028 # 6658 <malloc+0x65a>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8c:	7f050513          	addi	a0,a0,2032 # 6678 <malloc+0x67a>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea8:	7fc50513          	addi	a0,a0,2044 # 66a0 <malloc+0x6a2>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec4:	80050513          	addi	a0,a0,-2048 # 66c0 <malloc+0x6c2>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ee0:	80450513          	addi	a0,a0,-2044 # 66e0 <malloc+0x6e2>
...
0000000000000ef6 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f44:	71058593          	addi	a1,a1,1808 # 6650 <malloc+0x652>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f64:	7a858593          	addi	a1,a1,1960 # 6708 <malloc+0x70a>
     f68:	00005517          	auipc	a0,0x5
     f6c:	79850513          	addi	a0,a0,1944 # 6700 <malloc+0x702>
  ...
  unlink("lf1");
     ...
     f80:	78450513          	addi	a0,a0,1924 # 6700 <malloc+0x702>
     f84:	00005097          	auipc	ra,0x5
     f88:	c90080e7          	jalr	-880(ra) # 5c14 <unlink>
  if(open("lf1", 0) >= 0){
     f8c:	4581                	li	a1,0
     f8e:	00005517          	auipc	a0,0x5
     f92:	77250513          	addi	a0,a0,1906 # 6700 <malloc+0x702>
  ...
  fd = open("lf2", 0);
     ...
     fa8:	76450513          	addi	a0,a0,1892 # 6708 <malloc+0x70a>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fe0:	72c58593          	addi	a1,a1,1836 # 6708 <malloc+0x70a>
     fe4:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff6:	71650513          	addi	a0,a0,1814 # 6708 <malloc+0x70a>
     ffa:	00005097          	auipc	ra,0x5
     ffe:	c1a080e7          	jalr	-998(ra) # 5c14 <unlink>
  if(link("lf2", "lf1") >= 0){
    1002:	00005597          	auipc	a1,0x5
    1006:	6fe58593          	addi	a1,a1,1790 # 6700 <malloc+0x702>
    100a:	00005517          	auipc	a0,0x5
    100e:	6fe50513          	addi	a0,a0,1790 # 6708 <malloc+0x70a>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1022:	6e258593          	addi	a1,a1,1762 # 6700 <malloc+0x702>
    1026:	00005517          	auipc	a0,0x5
    102a:	7ea50513          	addi	a0,a0,2026 # 6810 <malloc+0x812>
    ...
    104c:	6c850513          	addi	a0,a0,1736 # 6710 <malloc+0x712>
    ...
    1068:	6c450513          	addi	a0,a0,1732 # 6728 <malloc+0x72a>
    ...
    1084:	6c050513          	addi	a0,a0,1728 # 6740 <malloc+0x742>
    ...
    10a0:	6c450513          	addi	a0,a0,1732 # 6760 <malloc+0x762>
    ...
    10bc:	6d850513          	addi	a0,a0,1752 # 6790 <malloc+0x792>
    ...
    10d8:	6d450513          	addi	a0,a0,1748 # 67a8 <malloc+0x7aa>
    ...
    10f4:	6d050513          	addi	a0,a0,1744 # 67c0 <malloc+0x7c2>
    ...
    1110:	6dc50513          	addi	a0,a0,1756 # 67e8 <malloc+0x7ea>
    ...
    112c:	6f050513          	addi	a0,a0,1776 # 6818 <malloc+0x81a>
...
0000000000001142 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115e:	6de98993          	addi	s3,s3,1758 # 6838 <malloc+0x83a>
    1162:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    119a:	6b250513          	addi	a0,a0,1714 # 6848 <malloc+0x84a>
...
00000000000011b0 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    1200:	66ca0a13          	addi	s4,s4,1644 # 6868 <malloc+0x86a>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1252:	61a50513          	addi	a0,a0,1562 # 6868 <malloc+0x86a>
  ...
  for(i = 0; i < N; i++){
    ...
    12c2:	5b250513          	addi	a0,a0,1458 # 6870 <malloc+0x872>
    ...
    12e2:	5b250513          	addi	a0,a0,1458 # 6890 <malloc+0x892>
    ...
    12fe:	5b650513          	addi	a0,a0,1462 # 68b0 <malloc+0x8b2>
...
000000000000134c <badarg>:
{
    ...
    136a:	dc298993          	addi	s3,s3,-574 # 6128 <malloc+0x12a>
    argv[0] = (char*)0xffffffff;
...
0000000000001392 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f4:	71878793          	addi	a5,a5,1816 # 7b08 <malloc+0x1b0a>
  ...
  if(pid == 0){
    ...
    1450:	0fc78793          	addi	a5,a5,252 # 8548 <malloc+0x254a>
    ...
    1474:	cb850513          	addi	a0,a0,-840 # 6128 <malloc+0x12a>
    ...
    148c:	4d050513          	addi	a0,a0,1232 # 6958 <malloc+0x95a>
    ...
    14ac:	42850513          	addi	a0,a0,1064 # 68d0 <malloc+0x8d2>
    ...
    14cc:	42850513          	addi	a0,a0,1064 # 68f0 <malloc+0x8f2>
    ...
    14ee:	42650513          	addi	a0,a0,1062 # 6910 <malloc+0x912>
    ...
    150e:	42e50513          	addi	a0,a0,1070 # 6938 <malloc+0x93a>
    ...
    1528:	89450513          	addi	a0,a0,-1900 # 6db8 <malloc+0xdba>
  ...
  if(st != 747){
    ...
    1572:	41250513          	addi	a0,a0,1042 # 6980 <malloc+0x982>
...
0000000000001588 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    15a4:	be050513          	addi	a0,a0,-1056 # 6180 <malloc+0x182>
  ...
  if(pid == 0){
    ...
    15ce:	bb6a0a13          	addi	s4,s4,-1098 # 6180 <malloc+0x182>
      int n = write(fd, "1234567890", 10);
    15d2:	00005a97          	auipc	s5,0x5
    15d6:	40ea8a93          	addi	s5,s5,1038 # 69e0 <malloc+0x9e2>
      int fd = open("truncfile", O_WRONLY);
    15da:	4585                	li	a1,1
    15dc:	8552                	mv	a0,s4
    ...
    1646:	36e50513          	addi	a0,a0,878 # 69b0 <malloc+0x9b2>
    ...
    1662:	36a50513          	addi	a0,a0,874 # 69c8 <malloc+0x9ca>
    ...
    1680:	37450513          	addi	a0,a0,884 # 69f0 <malloc+0x9f2>
    ...
    169e:	ae6a0a13          	addi	s4,s4,-1306 # 6180 <malloc+0x182>
    int n = write(fd, "xxx", 3);
    16a2:	00005a97          	auipc	s5,0x5
    16a6:	36ea8a93          	addi	s5,s5,878 # 6a10 <malloc+0xa12>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16f0:	a9450513          	addi	a0,a0,-1388 # 6180 <malloc+0x182>
  ...
  exit(xstatus);
    ...
    170e:	2be50513          	addi	a0,a0,702 # 69c8 <malloc+0x9ca>
    ...
    172c:	2f050513          	addi	a0,a0,752 # 6a18 <malloc+0xa1a>
...
0000000000001742 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1754:	9d878793          	addi	a5,a5,-1576 # 6128 <malloc+0x12a>
    1758:	fcf43023          	sd	a5,-64(s0)
    175c:	00005797          	auipc	a5,0x5
    1760:	2dc78793          	addi	a5,a5,732 # 6a38 <malloc+0xa3a>
    1764:	fcf43423          	sd	a5,-56(s0)
    1768:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    176c:	00005517          	auipc	a0,0x5
    1770:	2d450513          	addi	a0,a0,724 # 6a40 <malloc+0xa42>
  ...
  if(pid == 0) {
    ...
    179e:	2a650513          	addi	a0,a0,678 # 6a40 <malloc+0xa42>
    ...
    17ba:	2aa50513          	addi	a0,a0,682 # 6a60 <malloc+0xa62>
    ...
    17d6:	1de50513          	addi	a0,a0,478 # 69b0 <malloc+0x9b2>
    ...
    17f2:	25a50513          	addi	a0,a0,602 # 6a48 <malloc+0xa4a>
    ...
    1810:	91c50513          	addi	a0,a0,-1764 # 6128 <malloc+0x12a>
  ...
  if(xstatus != 0)
    ...
    1844:	23050513          	addi	a0,a0,560 # 6a70 <malloc+0xa72>
    ...
    1860:	22c50513          	addi	a0,a0,556 # 6a88 <malloc+0xa8a>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1874:	1d050513          	addi	a0,a0,464 # 6a40 <malloc+0xa42>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    189e:	c5e50513          	addi	a0,a0,-930 # 64f8 <malloc+0x4fa>
    ...
    18ba:	11250513          	addi	a0,a0,274 # 69c8 <malloc+0x9ca>
  ...
  unlink("echo-ok");
    ...
    18d4:	17050513          	addi	a0,a0,368 # 6a40 <malloc+0xa42>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    18fe:	1a650513          	addi	a0,a0,422 # 6aa0 <malloc+0xaa2>
...
000000000000191e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    19be:	0fe50513          	addi	a0,a0,254 # 6ab8 <malloc+0xaba>
    19c2:	00004097          	auipc	ra,0x4
    19c6:	584080e7          	jalr	1412(ra) # 5f46 <printf>
    exit(1);
    19ca:	4505                	li	a0,1
    ...
    19f8:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x9b>
{
    ...
    1a44:	09050513          	addi	a0,a0,144 # 6ad0 <malloc+0xad2>
    1a48:	00004097          	auipc	ra,0x4
    1a4c:	4fe080e7          	jalr	1278(ra) # 5f46 <printf>
        exit(1);
    1a50:	4505                	li	a0,1
    ...
    1a60:	08c50513          	addi	a0,a0,140 # 6ae8 <malloc+0xaea>
    1a64:	00004097          	auipc	ra,0x4
    1a68:	4e2080e7          	jalr	1250(ra) # 5f46 <printf>
}
    ...
    1a92:	07250513          	addi	a0,a0,114 # 6b00 <malloc+0xb02>
    1a96:	00004097          	auipc	ra,0x4
    1a9a:	4b0080e7          	jalr	1200(ra) # 5f46 <printf>
      exit(1);
    1a9e:	4505                	li	a0,1
    ...
    1ad2:	05250513          	addi	a0,a0,82 # 6b20 <malloc+0xb22>
    1ad6:	00004097          	auipc	ra,0x4
    1ada:	470080e7          	jalr	1136(ra) # 5f46 <printf>
    exit(1);
    1ade:	4505                	li	a0,1
...
0000000000001ae8 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b44:	e7050513          	addi	a0,a0,-400 # 69b0 <malloc+0x9b2>
    1b48:	00004097          	auipc	ra,0x4
    1b4c:	3fe080e7          	jalr	1022(ra) # 5f46 <printf>
      exit(1);
    1b50:	4505                	li	a0,1
    ...
    1b60:	fdc50513          	addi	a0,a0,-36 # 6b38 <malloc+0xb3a>
    1b64:	00004097          	auipc	ra,0x4
    1b68:	3e2080e7          	jalr	994(ra) # 5f46 <printf>
        exit(1);
    1b6c:	4505                	li	a0,1
    ...
    1b7c:	fd850513          	addi	a0,a0,-40 # 6b50 <malloc+0xb52>
    1b80:	00004097          	auipc	ra,0x4
    1b84:	3c6080e7          	jalr	966(ra) # 5f46 <printf>
        exit(1);
    1b88:	4505                	li	a0,1
...
0000000000001b9c <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1bf4:	dc050513          	addi	a0,a0,-576 # 69b0 <malloc+0x9b2>
    1bf8:	00004097          	auipc	ra,0x4
    1bfc:	34e080e7          	jalr	846(ra) # 5f46 <printf>
      exit(1);
    1c00:	4505                	li	a0,1
    ...
    1c18:	d9c50513          	addi	a0,a0,-612 # 69b0 <malloc+0x9b2>
    1c1c:	00004097          	auipc	ra,0x4
    1c20:	32a080e7          	jalr	810(ra) # 5f46 <printf>
        exit(1);
    1c24:	4505                	li	a0,1
...
0000000000001c36 <forkfork>:
{
    ...
    1c92:	ee250513          	addi	a0,a0,-286 # 6b70 <malloc+0xb72>
    1c96:	00004097          	auipc	ra,0x4
    1c9a:	2b0080e7          	jalr	688(ra) # 5f46 <printf>
      exit(1);
    1c9e:	4505                	li	a0,1
    ...
    1ca4:	f24080e7          	jalr	-220(ra) # 5bc4 <exit>
{
    ...
    1cea:	e9a50513          	addi	a0,a0,-358 # 6b80 <malloc+0xb82>
    1cee:	00004097          	auipc	ra,0x4
    1cf2:	258080e7          	jalr	600(ra) # 5f46 <printf>
      exit(1);
    1cf6:	4505                	li	a0,1
...
0000000000001d00 <reparent2>:
{
  ...
  exit(0);
    ...
    1d38:	08450513          	addi	a0,a0,132 # 6db8 <malloc+0xdba>
    1d3c:	00004097          	auipc	ra,0x4
    1d40:	20a080e7          	jalr	522(ra) # 5f46 <printf>
      exit(1);
    1d44:	4505                	li	a0,1
...
0000000000001d68 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1dd6:	fe650513          	addi	a0,a0,-26 # 6db8 <malloc+0xdba>
    1dda:	00004097          	auipc	ra,0x4
    1dde:	16c080e7          	jalr	364(ra) # 5f46 <printf>
      exit(1);
    1de2:	4505                	li	a0,1
    ...
    1e02:	c4a50513          	addi	a0,a0,-950 # 6a48 <malloc+0xa4a>
    1e06:	00004097          	auipc	ra,0x4
    1e0a:	140080e7          	jalr	320(ra) # 5f46 <printf>
          exit(1);
    1e0e:	4505                	li	a0,1
    ...
    1e74:	d3050513          	addi	a0,a0,-720 # 6ba0 <malloc+0xba2>
    1e78:	00004097          	auipc	ra,0x4
    1e7c:	0ce080e7          	jalr	206(ra) # 5f46 <printf>
            exit(1);
    1e80:	4505                	li	a0,1
    ...
    1ea8:	d1450513          	addi	a0,a0,-748 # 6bb8 <malloc+0xbba>
    1eac:	00004097          	auipc	ra,0x4
    1eb0:	09a080e7          	jalr	154(ra) # 5f46 <printf>
        exit(1);
    1eb4:	4505                	li	a0,1
    ...
    1f0e:	cd650513          	addi	a0,a0,-810 # 6be0 <malloc+0xbe2>
    1f12:	00004097          	auipc	ra,0x4
    1f16:	034080e7          	jalr	52(ra) # 5f46 <printf>
        exit(1);
    1f1a:	4505                	li	a0,1
...
0000000000001f8e <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fae:	1ee50513          	addi	a0,a0,494 # 6198 <malloc+0x19a>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1fea:	1b2a8a93          	addi	s5,s5,434 # 6198 <malloc+0x19a>
      link("cat", "x");
    1fee:	00005b97          	auipc	s7,0x5
    1ff2:	c1ab8b93          	addi	s7,s7,-998 # 6c08 <malloc+0xc0a>
    1ff6:	a825                	j	202e <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1ff8:	85a6                	mv	a1,s1
    1ffa:	00005517          	auipc	a0,0x5
    1ffe:	9b650513          	addi	a0,a0,-1610 # 69b0 <malloc+0x9b2>
    2002:	00004097          	auipc	ra,0x4
    2006:	f44080e7          	jalr	-188(ra) # 5f46 <printf>
    exit(1);
    200a:	4505                	li	a0,1
...
0000000000002090 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20c0:	b6c50513          	addi	a0,a0,-1172 # 6c28 <malloc+0xc2a>
    20c4:	00004097          	auipc	ra,0x4
    20c8:	e82080e7          	jalr	-382(ra) # 5f46 <printf>
    exit(1);
    20cc:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    2122:	af250513          	addi	a0,a0,-1294 # 6c10 <malloc+0xc12>
    2126:	00004097          	auipc	ra,0x4
    212a:	e20080e7          	jalr	-480(ra) # 5f46 <printf>
    exit(1);
    212e:	4505                	li	a0,1
    ...
    213e:	b1650513          	addi	a0,a0,-1258 # 6c50 <malloc+0xc52>
    2142:	00004097          	auipc	ra,0x4
    2146:	e04080e7          	jalr	-508(ra) # 5f46 <printf>
      exit(1);
    214a:	4505                	li	a0,1
    ...
    215a:	b1250513          	addi	a0,a0,-1262 # 6c68 <malloc+0xc6a>
    215e:	00004097          	auipc	ra,0x4
    2162:	de8080e7          	jalr	-536(ra) # 5f46 <printf>
    exit(1);
    2166:	4505                	li	a0,1
...
0000000000002170 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21da:	7da50513          	addi	a0,a0,2010 # 69b0 <malloc+0x9b2>
    21de:	00004097          	auipc	ra,0x4
    21e2:	d68080e7          	jalr	-664(ra) # 5f46 <printf>
      exit(1);
    21e6:	4505                	li	a0,1
    ...
    21fc:	a8850513          	addi	a0,a0,-1400 # 6c80 <malloc+0xc82>
    2200:	00004097          	auipc	ra,0x4
    2204:	d46080e7          	jalr	-698(ra) # 5f46 <printf>
      exit(1);
    2208:	4505                	li	a0,1
...
000000000000221c <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    227e:	73650513          	addi	a0,a0,1846 # 69b0 <malloc+0x9b2>
    2282:	00004097          	auipc	ra,0x4
    2286:	cc4080e7          	jalr	-828(ra) # 5f46 <printf>
      exit(1);
    228a:	4505                	li	a0,1
    ...
    22aa:	9fa50513          	addi	a0,a0,-1542 # 6ca0 <malloc+0xca2>
    22ae:	00004097          	auipc	ra,0x4
    22b2:	c98080e7          	jalr	-872(ra) # 5f46 <printf>
      exit(1);
    22b6:	4505                	li	a0,1
...
00000000000022ca <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    22da:	9e250513          	addi	a0,a0,-1566 # 6cb8 <malloc+0xcba>
  ...
  fd = open("bigarg-ok", 0);
    ...
    230c:	9b050513          	addi	a0,a0,-1616 # 6cb8 <malloc+0xcba>
  ...
  close(fd);
    ...
    2342:	98a70713          	addi	a4,a4,-1654 # 6cc8 <malloc+0xcca>
    ...
    2396:	a1650513          	addi	a0,a0,-1514 # 6da8 <malloc+0xdaa>
    239a:	00004097          	auipc	ra,0x4
    239e:	bac080e7          	jalr	-1108(ra) # 5f46 <printf>
    exit(1);
    23a2:	4505                	li	a0,1
    ...
    23ba:	a1250513          	addi	a0,a0,-1518 # 6dc8 <malloc+0xdca>
    23be:	00004097          	auipc	ra,0x4
    23c2:	b88080e7          	jalr	-1144(ra) # 5f46 <printf>
    exit(1);
    23c6:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2418:	9d450513          	addi	a0,a0,-1580 # 6de8 <malloc+0xdea>
    241c:	00004097          	auipc	ra,0x4
    2420:	b2a080e7          	jalr	-1238(ra) # 5f46 <printf>
    exit(1);
    2424:	4505                	li	a0,1
    ...
    2434:	58050513          	addi	a0,a0,1408 # 69b0 <malloc+0x9b2>
    2438:	00004097          	auipc	ra,0x4
    243c:	b0e080e7          	jalr	-1266(ra) # 5f46 <printf>
    exit(1);
    2440:	4505                	li	a0,1
...
0000000000002454 <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24a2:	51250513          	addi	a0,a0,1298 # 69b0 <malloc+0x9b2>
    24a6:	00004097          	auipc	ra,0x4
    24aa:	aa0080e7          	jalr	-1376(ra) # 5f46 <printf>
    exit(1);
    24ae:	4505                	li	a0,1
...
00000000000024c2 <manywrites>:
{
  ...
  exit(0);
    ...
    251e:	89e50513          	addi	a0,a0,-1890 # 6db8 <malloc+0xdba>
    2522:	00004097          	auipc	ra,0x4
    2526:	a24080e7          	jalr	-1500(ra) # 5f46 <printf>
      exit(1);
    252a:	4505                	li	a0,1
    ...
    25ce:	84650513          	addi	a0,a0,-1978 # 6e10 <malloc+0xe12>
    25d2:	00004097          	auipc	ra,0x4
    25d6:	974080e7          	jalr	-1676(ra) # 5f46 <printf>
            exit(1);
    25da:	4505                	li	a0,1
    ...
    25ee:	c0e50513          	addi	a0,a0,-1010 # 61f8 <malloc+0x1fa>
    25f2:	00004097          	auipc	ra,0x4
    25f6:	954080e7          	jalr	-1708(ra) # 5f46 <printf>
            exit(1);
    25fa:	4505                	li	a0,1
...
000000000000260c <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2686:	48678793          	addi	a5,a5,1158 # 7b08 <malloc+0x1b0a>
  ...
  if(ret != -1){
    ...
    26c8:	76450513          	addi	a0,a0,1892 # 6e28 <malloc+0xe2a>
    26cc:	00004097          	auipc	ra,0x4
    26d0:	87a080e7          	jalr	-1926(ra) # 5f46 <printf>
    exit(1);
    26d4:	4505                	li	a0,1
    ...
    26e6:	1ee50513          	addi	a0,a0,494 # 68d0 <malloc+0x8d2>
    26ea:	00004097          	auipc	ra,0x4
    26ee:	85c080e7          	jalr	-1956(ra) # 5f46 <printf>
    exit(1);
    26f2:	4505                	li	a0,1
    ...
    2704:	1f050513          	addi	a0,a0,496 # 68f0 <malloc+0x8f2>
    2708:	00004097          	auipc	ra,0x4
    270c:	83e080e7          	jalr	-1986(ra) # 5f46 <printf>
    exit(1);
    2710:	4505                	li	a0,1
    ...
    2724:	1f050513          	addi	a0,a0,496 # 6910 <malloc+0x912>
    2728:	00004097          	auipc	ra,0x4
    272c:	81e080e7          	jalr	-2018(ra) # 5f46 <printf>
    exit(1);
    2730:	4505                	li	a0,1
    ...
    2742:	1fa50513          	addi	a0,a0,506 # 6938 <malloc+0x93a>
    2746:	00004097          	auipc	ra,0x4
    274a:	800080e7          	jalr	-2048(ra) # 5f46 <printf>
    exit(1);
    274e:	4505                	li	a0,1
...
0000000000002758 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    278e:	6de50513          	addi	a0,a0,1758 # 6e68 <malloc+0xe6a>
  ...
  if(n >= 0){
    ...
    27be:	6ce50513          	addi	a0,a0,1742 # 6e88 <malloc+0xe8a>
    27c2:	00003097          	auipc	ra,0x3
    27c6:	784080e7          	jalr	1924(ra) # 5f46 <printf>
    exit(1);
    27ca:	4505                	li	a0,1
    ...
    27d8:	65c50513          	addi	a0,a0,1628 # 6e30 <malloc+0xe32>
    27dc:	00003097          	auipc	ra,0x3
    27e0:	76a080e7          	jalr	1898(ra) # 5f46 <printf>
    exit(1);
    27e4:	4505                	li	a0,1
    ...
    27f2:	65a50513          	addi	a0,a0,1626 # 6e48 <malloc+0xe4a>
    27f6:	00003097          	auipc	ra,0x3
    27fa:	750080e7          	jalr	1872(ra) # 5f46 <printf>
    exit(1);
    27fe:	4505                	li	a0,1
    ...
    280c:	66850513          	addi	a0,a0,1640 # 6e70 <malloc+0xe72>
    2810:	00003097          	auipc	ra,0x3
    2814:	736080e7          	jalr	1846(ra) # 5f46 <printf>
    exit(1);
    2818:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    2830:	63c50513          	addi	a0,a0,1596 # 6e68 <malloc+0xe6a>
    2834:	00003097          	auipc	ra,0x3
    2838:	3e0080e7          	jalr	992(ra) # 5c14 <unlink>
  fd = open("README", O_RDONLY);
    283c:	4581                	li	a1,0
    283e:	00004517          	auipc	a0,0x4
    2842:	ac250513          	addi	a0,a0,-1342 # 6300 <malloc+0x302>
  ...
  if(n >= 0){
    ...
    286c:	65050513          	addi	a0,a0,1616 # 6eb8 <malloc+0xeba>
    2870:	00003097          	auipc	ra,0x3
    2874:	6d6080e7          	jalr	1750(ra) # 5f46 <printf>
    exit(1);
    2878:	4505                	li	a0,1
    ...
    2886:	5ee50513          	addi	a0,a0,1518 # 6e70 <malloc+0xe72>
    288a:	00003097          	auipc	ra,0x3
    288e:	6bc080e7          	jalr	1724(ra) # 5f46 <printf>
    exit(1);
    2892:	4505                	li	a0,1
...
00000000000028b0 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2906:	5de50513          	addi	a0,a0,1502 # 6ee0 <malloc+0xee2>
    290a:	00003097          	auipc	ra,0x3
    290e:	63c080e7          	jalr	1596(ra) # 5f46 <printf>
    exit(1);
    2912:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2958:	5ac50513          	addi	a0,a0,1452 # 6f00 <malloc+0xf02>
    295c:	00003097          	auipc	ra,0x3
    2960:	5ea080e7          	jalr	1514(ra) # 5f46 <printf>
    exit(1);
    2964:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    29bc:	5a850513          	addi	a0,a0,1448 # 6f60 <malloc+0xf62>
    29c0:	00003097          	auipc	ra,0x3
    29c4:	586080e7          	jalr	1414(ra) # 5f46 <printf>
    exit(1);
    29c8:	4505                	li	a0,1
    ...
    29de:	54650513          	addi	a0,a0,1350 # 6f20 <malloc+0xf22>
    29e2:	00003097          	auipc	ra,0x3
    29e6:	564080e7          	jalr	1380(ra) # 5f46 <printf>
      exit(1);
    29ea:	4505                	li	a0,1
    ...
    29fa:	54a50513          	addi	a0,a0,1354 # 6f40 <malloc+0xf42>
    29fe:	00003097          	auipc	ra,0x3
    2a02:	548080e7          	jalr	1352(ra) # 5f46 <printf>
    exit(1);
    2a06:	4505                	li	a0,1
...
0000000000002a36 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2b44:	44050513          	addi	a0,a0,1088 # 6f80 <malloc+0xf82>
    2b48:	00003097          	auipc	ra,0x3
    2b4c:	3fe080e7          	jalr	1022(ra) # 5f46 <printf>
    exit(1);
    2b50:	4505                	li	a0,1
    ...
    2b60:	46c50513          	addi	a0,a0,1132 # 6fc8 <malloc+0xfca>
    2b64:	00003097          	auipc	ra,0x3
    2b68:	3e2080e7          	jalr	994(ra) # 5f46 <printf>
    exit(1);
    2b6c:	4505                	li	a0,1
    ...
    2b80:	46c50513          	addi	a0,a0,1132 # 6fe8 <malloc+0xfea>
    2b84:	00003097          	auipc	ra,0x3
    2b88:	3c2080e7          	jalr	962(ra) # 5f46 <printf>
    exit(1);
    2b8c:	4505                	li	a0,1
    ...
    2ba0:	48c50513          	addi	a0,a0,1164 # 7028 <malloc+0x102a>
    2ba4:	00003097          	auipc	ra,0x3
    2ba8:	3a2080e7          	jalr	930(ra) # 5f46 <printf>
    exit(1);
    2bac:	4505                	li	a0,1
    ...
    2bbc:	4a050513          	addi	a0,a0,1184 # 7058 <malloc+0x105a>
    2bc0:	00003097          	auipc	ra,0x3
    2bc4:	386080e7          	jalr	902(ra) # 5f46 <printf>
    exit(1);
    2bc8:	4505                	li	a0,1
    ...
    2bdc:	4b850513          	addi	a0,a0,1208 # 7090 <malloc+0x1092>
    2be0:	00003097          	auipc	ra,0x3
    2be4:	366080e7          	jalr	870(ra) # 5f46 <printf>
    exit(1);
    2be8:	4505                	li	a0,1
...
0000000000002bf2 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c16:	4a650513          	addi	a0,a0,1190 # 70b8 <malloc+0x10ba>
    2c1a:	00003097          	auipc	ra,0x3
    2c1e:	fea080e7          	jalr	-22(ra) # 5c04 <open>
    2c22:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c24:	00004517          	auipc	a0,0x4
    2c28:	49450513          	addi	a0,a0,1172 # 70b8 <malloc+0x10ba>
  ...
  if(pipe((int *) a) != 0){
    ...
    2c7c:	44850513          	addi	a0,a0,1096 # 70c0 <malloc+0x10c2>
    2c80:	00003097          	auipc	ra,0x3
    2c84:	2c6080e7          	jalr	710(ra) # 5f46 <printf>
    exit(1);
    2c88:	4505                	li	a0,1
    ...
    2c98:	44450513          	addi	a0,a0,1092 # 70d8 <malloc+0x10da>
    2c9c:	00003097          	auipc	ra,0x3
    2ca0:	2aa080e7          	jalr	682(ra) # 5f46 <printf>
    exit(1);
    2ca4:	4505                	li	a0,1
    ...
    2cb4:	e0850513          	addi	a0,a0,-504 # 6ab8 <malloc+0xaba>
    2cb8:	00003097          	auipc	ra,0x3
    2cbc:	28e080e7          	jalr	654(ra) # 5f46 <printf>
    exit(1);
    2cc0:	4505                	li	a0,1
...
0000000000002cca <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2cde:	41650513          	addi	a0,a0,1046 # 70f0 <malloc+0x10f2>
  ...
  close(fd);
    ...
    2d26:	ca650513          	addi	a0,a0,-858 # 69c8 <malloc+0x9ca>
    2d2a:	00003097          	auipc	ra,0x3
    2d2e:	21c080e7          	jalr	540(ra) # 5f46 <printf>
    exit(1);
    2d32:	4505                	li	a0,1
...
0000000000002d3c <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2d74:	04850513          	addi	a0,a0,72 # 6db8 <malloc+0xdba>
    2d78:	00003097          	auipc	ra,0x3
    2d7c:	1ce080e7          	jalr	462(ra) # 5f46 <printf>
    exit(1);
    2d80:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2dca:	ff250513          	addi	a0,a0,-14 # 6db8 <malloc+0xdba>
    2dce:	00003097          	auipc	ra,0x3
    2dd2:	178080e7          	jalr	376(ra) # 5f46 <printf>
    exit(1);
    2dd6:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2e2a:	f9250513          	addi	a0,a0,-110 # 6db8 <malloc+0xdba>
    2e2e:	00003097          	auipc	ra,0x3
    2e32:	118080e7          	jalr	280(ra) # 5f46 <printf>
    exit(1);
    2e36:	4505                	li	a0,1
...
0000000000002f5c <execout>:
{
  ...
  exit(0);
    ...
    2f9e:	e1e50513          	addi	a0,a0,-482 # 6db8 <malloc+0xdba>
    2fa2:	00003097          	auipc	ra,0x3
    2fa6:	fa4080e7          	jalr	-92(ra) # 5f46 <printf>
      exit(1);
    2faa:	4505                	li	a0,1
    ...
    2ff2:	13a50513          	addi	a0,a0,314 # 6128 <malloc+0x12a>
    2ff6:	faa43c23          	sd	a0,-72(s0)
    2ffa:	00003797          	auipc	a5,0x3
    2ffe:	19e78793          	addi	a5,a5,414 # 6198 <malloc+0x19a>
...
0000000000003020 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    3030:	29c50513          	addi	a0,a0,668 # 72c8 <malloc+0x12ca>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3042:	0e250513          	addi	a0,a0,226 # 7120 <malloc+0x1122>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    3058:	12450513          	addi	a0,a0,292 # 7178 <malloc+0x117a>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    3076:	17e50513          	addi	a0,a0,382 # 71f0 <malloc+0x11f2>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    3092:	1d250513          	addi	a0,a0,466 # 7260 <malloc+0x1262>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30a4:	21850513          	addi	a0,a0,536 # 72b8 <malloc+0x12ba>
  ...
  unlink("12345678901234");
    ...
    3122:	fda50513          	addi	a0,a0,-38 # 70f8 <malloc+0x10fa>
    3126:	00003097          	auipc	ra,0x3
    312a:	e20080e7          	jalr	-480(ra) # 5f46 <printf>
    exit(1);
    312e:	4505                	li	a0,1
    ...
    313e:	00650513          	addi	a0,a0,6 # 7140 <malloc+0x1142>
    3142:	00003097          	auipc	ra,0x3
    3146:	e04080e7          	jalr	-508(ra) # 5f46 <printf>
    exit(1);
    314a:	4505                	li	a0,1
    ...
    315a:	05250513          	addi	a0,a0,82 # 71a8 <malloc+0x11aa>
    315e:	00003097          	auipc	ra,0x3
    3162:	de8080e7          	jalr	-536(ra) # 5f46 <printf>
    exit(1);
    3166:	4505                	li	a0,1
    ...
    3176:	0ae50513          	addi	a0,a0,174 # 7220 <malloc+0x1222>
    317a:	00003097          	auipc	ra,0x3
    317e:	dcc080e7          	jalr	-564(ra) # 5f46 <printf>
    exit(1);
    3182:	4505                	li	a0,1
    ...
    3192:	0f250513          	addi	a0,a0,242 # 7280 <malloc+0x1282>
    3196:	00003097          	auipc	ra,0x3
    319a:	db0080e7          	jalr	-592(ra) # 5f46 <printf>
    exit(1);
    319e:	4505                	li	a0,1
    ...
    31ae:	12e50513          	addi	a0,a0,302 # 72d8 <malloc+0x12da>
    31b2:	00003097          	auipc	ra,0x3
    31b6:	d94080e7          	jalr	-620(ra) # 5f46 <printf>
    exit(1);
    31ba:	4505                	li	a0,1
...
00000000000031c4 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    31fa:	11a50513          	addi	a0,a0,282 # 7310 <malloc+0x1312>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3226:	0fe50513          	addi	a0,a0,254 # 7320 <malloc+0x1322>
    322a:	00003097          	auipc	ra,0x3
    322e:	d1c080e7          	jalr	-740(ra) # 5f46 <printf>
      break;
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    32b6:	05e50513          	addi	a0,a0,94 # 7310 <malloc+0x1312>
  ...
  unlink("diskfulldir");
    ...
    32ca:	04a50513          	addi	a0,a0,74 # 7310 <malloc+0x1312>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    33f8:	f4c50513          	addi	a0,a0,-180 # 7340 <malloc+0x1342>
    33fc:	00003097          	auipc	ra,0x3
    3400:	b4a080e7          	jalr	-1206(ra) # 5f46 <printf>
...
0000000000003406 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3416:	f5e50513          	addi	a0,a0,-162 # 7370 <malloc+0x1372>
  ...
  if(chdir("iputdir") < 0){
    ...
    342a:	f4a50513          	addi	a0,a0,-182 # 7370 <malloc+0x1372>
  ...
  if(unlink("../iputdir") < 0){
    ...
    343e:	f7650513          	addi	a0,a0,-138 # 73b0 <malloc+0x13b2>
  ...
  if(chdir("/") < 0){
    ...
    3452:	f9250513          	addi	a0,a0,-110 # 73e0 <malloc+0x13e2>
    ...
    3472:	f0a50513          	addi	a0,a0,-246 # 7378 <malloc+0x137a>
    3476:	00003097          	auipc	ra,0x3
    347a:	ad0080e7          	jalr	-1328(ra) # 5f46 <printf>
    exit(1);
    347e:	4505                	li	a0,1
    ...
    348e:	f0650513          	addi	a0,a0,-250 # 7390 <malloc+0x1392>
    3492:	00003097          	auipc	ra,0x3
    3496:	ab4080e7          	jalr	-1356(ra) # 5f46 <printf>
    exit(1);
    349a:	4505                	li	a0,1
    ...
    34aa:	f1a50513          	addi	a0,a0,-230 # 73c0 <malloc+0x13c2>
    34ae:	00003097          	auipc	ra,0x3
    34b2:	a98080e7          	jalr	-1384(ra) # 5f46 <printf>
    exit(1);
    34b6:	4505                	li	a0,1
    ...
    34c6:	f2650513          	addi	a0,a0,-218 # 73e8 <malloc+0x13ea>
    34ca:	00003097          	auipc	ra,0x3
    34ce:	a7c080e7          	jalr	-1412(ra) # 5f46 <printf>
    exit(1);
    34d2:	4505                	li	a0,1
...
00000000000034dc <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    34fa:	e7a50513          	addi	a0,a0,-390 # 7370 <malloc+0x1372>
    ...
    350e:	e6650513          	addi	a0,a0,-410 # 7370 <malloc+0x1372>
    ...
    3522:	e9250513          	addi	a0,a0,-366 # 73b0 <malloc+0x13b2>
    ...
    3542:	47250513          	addi	a0,a0,1138 # 69b0 <malloc+0x9b2>
    3546:	00003097          	auipc	ra,0x3
    354a:	a00080e7          	jalr	-1536(ra) # 5f46 <printf>
    exit(1);
    354e:	4505                	li	a0,1
    ...
    355e:	e1e50513          	addi	a0,a0,-482 # 7378 <malloc+0x137a>
    3562:	00003097          	auipc	ra,0x3
    3566:	9e4080e7          	jalr	-1564(ra) # 5f46 <printf>
      exit(1);
    356a:	4505                	li	a0,1
    ...
    357a:	e8a50513          	addi	a0,a0,-374 # 7400 <malloc+0x1402>
    357e:	00003097          	auipc	ra,0x3
    3582:	9c8080e7          	jalr	-1592(ra) # 5f46 <printf>
      exit(1);
    3586:	4505                	li	a0,1
    ...
    3596:	e2e50513          	addi	a0,a0,-466 # 73c0 <malloc+0x13c2>
    359a:	00003097          	auipc	ra,0x3
    359e:	9ac080e7          	jalr	-1620(ra) # 5f46 <printf>
      exit(1);
    35a2:	4505                	li	a0,1
...
00000000000035c4 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    35d4:	e4850513          	addi	a0,a0,-440 # 7418 <malloc+0x141a>
  ...
  if(chdir("dir0") < 0){
    ...
    35e8:	e3450513          	addi	a0,a0,-460 # 7418 <malloc+0x141a>
  ...
  if(chdir("..") < 0){
    ...
    35fc:	e4050513          	addi	a0,a0,-448 # 7438 <malloc+0x143a>
  ...
  if(unlink("dir0") < 0){
    ...
    3610:	e0c50513          	addi	a0,a0,-500 # 7418 <malloc+0x141a>
    ...
    3630:	d4c50513          	addi	a0,a0,-692 # 7378 <malloc+0x137a>
    3634:	00003097          	auipc	ra,0x3
    3638:	912080e7          	jalr	-1774(ra) # 5f46 <printf>
    exit(1);
    363c:	4505                	li	a0,1
    ...
    364c:	dd850513          	addi	a0,a0,-552 # 7420 <malloc+0x1422>
    3650:	00003097          	auipc	ra,0x3
    3654:	8f6080e7          	jalr	-1802(ra) # 5f46 <printf>
    exit(1);
    3658:	4505                	li	a0,1
    ...
    3668:	ddc50513          	addi	a0,a0,-548 # 7440 <malloc+0x1442>
    366c:	00003097          	auipc	ra,0x3
    3670:	8da080e7          	jalr	-1830(ra) # 5f46 <printf>
    exit(1);
    3674:	4505                	li	a0,1
    ...
    3684:	dd850513          	addi	a0,a0,-552 # 7458 <malloc+0x145a>
    3688:	00003097          	auipc	ra,0x3
    368c:	8be080e7          	jalr	-1858(ra) # 5f46 <printf>
    exit(1);
    3690:	4505                	li	a0,1
...
000000000000369a <subdir>:
{
  ...
  unlink("ff");
    ...
    36ac:	ef850513          	addi	a0,a0,-264 # 75a0 <malloc+0x15a2>
    36b0:	00002097          	auipc	ra,0x2
    36b4:	564080e7          	jalr	1380(ra) # 5c14 <unlink>
  if(mkdir("dd") != 0){
    36b8:	00004517          	auipc	a0,0x4
    36bc:	db850513          	addi	a0,a0,-584 # 7470 <malloc+0x1472>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    36d4:	dc050513          	addi	a0,a0,-576 # 7490 <malloc+0x1492>
  ...
  write(fd, "ff", 2);
    ...
    36ec:	eb858593          	addi	a1,a1,-328 # 75a0 <malloc+0x15a2>
  ...
  if(unlink("dd") >= 0){
    ...
    3706:	d6e50513          	addi	a0,a0,-658 # 7470 <malloc+0x1472>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    371a:	dd250513          	addi	a0,a0,-558 # 74e8 <malloc+0x14ea>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    3732:	de250513          	addi	a0,a0,-542 # 7510 <malloc+0x1512>
  ...
  write(fd, "FF", 2);
    ...
    374a:	dfa58593          	addi	a1,a1,-518 # 7540 <malloc+0x1542>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3766:	de650513          	addi	a0,a0,-538 # 7548 <malloc+0x154a>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37ae:	dee58593          	addi	a1,a1,-530 # 7598 <malloc+0x159a>
    37b2:	00004517          	auipc	a0,0x4
    37b6:	d5e50513          	addi	a0,a0,-674 # 7510 <malloc+0x1512>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    37ca:	d4a50513          	addi	a0,a0,-694 # 7510 <malloc+0x1512>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    37e0:	d3450513          	addi	a0,a0,-716 # 7510 <malloc+0x1512>
  ...
  if(chdir("dd") != 0){
    ...
    37f4:	c8050513          	addi	a0,a0,-896 # 7470 <malloc+0x1472>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3808:	e2c50513          	addi	a0,a0,-468 # 7630 <malloc+0x1632>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    381c:	e4850513          	addi	a0,a0,-440 # 7660 <malloc+0x1662>
  ...
  if(chdir("./..") != 0){
    ...
    3830:	e6450513          	addi	a0,a0,-412 # 7690 <malloc+0x1692>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3846:	d5650513          	addi	a0,a0,-682 # 7598 <malloc+0x159a>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3880:	c9450513          	addi	a0,a0,-876 # 7510 <malloc+0x1512>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3898:	e8c50513          	addi	a0,a0,-372 # 7720 <malloc+0x1722>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38b0:	ea450513          	addi	a0,a0,-348 # 7750 <malloc+0x1752>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    38c8:	bac50513          	addi	a0,a0,-1108 # 7470 <malloc+0x1472>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    38de:	b9650513          	addi	a0,a0,-1130 # 7470 <malloc+0x1472>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    38f4:	b8050513          	addi	a0,a0,-1152 # 7470 <malloc+0x1472>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3908:	edc58593          	addi	a1,a1,-292 # 77e0 <malloc+0x17e2>
    390c:	00004517          	auipc	a0,0x4
    3910:	e1450513          	addi	a0,a0,-492 # 7720 <malloc+0x1722>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3924:	ec058593          	addi	a1,a1,-320 # 77e0 <malloc+0x17e2>
    3928:	00004517          	auipc	a0,0x4
    392c:	e2850513          	addi	a0,a0,-472 # 7750 <malloc+0x1752>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    3940:	c5c58593          	addi	a1,a1,-932 # 7598 <malloc+0x159a>
    3944:	00004517          	auipc	a0,0x4
    3948:	b4c50513          	addi	a0,a0,-1204 # 7490 <malloc+0x1492>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    395c:	dc850513          	addi	a0,a0,-568 # 7720 <malloc+0x1722>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    3970:	de450513          	addi	a0,a0,-540 # 7750 <malloc+0x1752>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3984:	c1850513          	addi	a0,a0,-1000 # 7598 <malloc+0x159a>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3998:	dbc50513          	addi	a0,a0,-580 # 7750 <malloc+0x1752>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39ac:	d7850513          	addi	a0,a0,-648 # 7720 <malloc+0x1722>
  ...
  if(chdir("dd/ff") == 0){
    ...
    39c0:	ad450513          	addi	a0,a0,-1324 # 7490 <malloc+0x1492>
  ...
  if(chdir("dd/xx") == 0){
    ...
    39d4:	f6050513          	addi	a0,a0,-160 # 7930 <malloc+0x1932>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    39e8:	bb450513          	addi	a0,a0,-1100 # 7598 <malloc+0x159a>
  ...
  if(unlink("dd/ff") != 0){
    ...
    39fc:	a9850513          	addi	a0,a0,-1384 # 7490 <malloc+0x1492>
  ...
  if(unlink("dd") == 0){
    ...
    3a10:	a6450513          	addi	a0,a0,-1436 # 7470 <malloc+0x1472>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a24:	f8050513          	addi	a0,a0,-128 # 79a0 <malloc+0x19a2>
  ...
  if(unlink("dd") < 0){
    ...
    3a38:	a3c50513          	addi	a0,a0,-1476 # 7470 <malloc+0x1472>
    ...
    3a5a:	a2250513          	addi	a0,a0,-1502 # 7478 <malloc+0x147a>
    3a5e:	00002097          	auipc	ra,0x2
    3a62:	4e8080e7          	jalr	1256(ra) # 5f46 <printf>
    exit(1);
    3a66:	4505                	li	a0,1
    ...
    3a76:	a2650513          	addi	a0,a0,-1498 # 7498 <malloc+0x149a>
    3a7a:	00002097          	auipc	ra,0x2
    3a7e:	4cc080e7          	jalr	1228(ra) # 5f46 <printf>
    exit(1);
    3a82:	4505                	li	a0,1
    ...
    3a92:	a2a50513          	addi	a0,a0,-1494 # 74b8 <malloc+0x14ba>
    3a96:	00002097          	auipc	ra,0x2
    3a9a:	4b0080e7          	jalr	1200(ra) # 5f46 <printf>
    exit(1);
    3a9e:	4505                	li	a0,1
    ...
    3aae:	a4650513          	addi	a0,a0,-1466 # 74f0 <malloc+0x14f2>
    3ab2:	00002097          	auipc	ra,0x2
    3ab6:	494080e7          	jalr	1172(ra) # 5f46 <printf>
    exit(1);
    3aba:	4505                	li	a0,1
    ...
    3aca:	a5a50513          	addi	a0,a0,-1446 # 7520 <malloc+0x1522>
    3ace:	00002097          	auipc	ra,0x2
    3ad2:	478080e7          	jalr	1144(ra) # 5f46 <printf>
    exit(1);
    3ad6:	4505                	li	a0,1
    ...
    3ae6:	a7650513          	addi	a0,a0,-1418 # 7558 <malloc+0x155a>
    3aea:	00002097          	auipc	ra,0x2
    3aee:	45c080e7          	jalr	1116(ra) # 5f46 <printf>
    exit(1);
    3af2:	4505                	li	a0,1
    ...
    3b02:	a7a50513          	addi	a0,a0,-1414 # 7578 <malloc+0x157a>
    3b06:	00002097          	auipc	ra,0x2
    3b0a:	440080e7          	jalr	1088(ra) # 5f46 <printf>
    exit(1);
    3b0e:	4505                	li	a0,1
    ...
    3b1e:	a8e50513          	addi	a0,a0,-1394 # 75a8 <malloc+0x15aa>
    3b22:	00002097          	auipc	ra,0x2
    3b26:	424080e7          	jalr	1060(ra) # 5f46 <printf>
    exit(1);
    3b2a:	4505                	li	a0,1
    ...
    3b3a:	a9a50513          	addi	a0,a0,-1382 # 75d0 <malloc+0x15d2>
    3b3e:	00002097          	auipc	ra,0x2
    3b42:	408080e7          	jalr	1032(ra) # 5f46 <printf>
    exit(1);
    3b46:	4505                	li	a0,1
    ...
    3b56:	a9e50513          	addi	a0,a0,-1378 # 75f0 <malloc+0x15f2>
    3b5a:	00002097          	auipc	ra,0x2
    3b5e:	3ec080e7          	jalr	1004(ra) # 5f46 <printf>
    exit(1);
    3b62:	4505                	li	a0,1
    ...
    3b72:	aaa50513          	addi	a0,a0,-1366 # 7618 <malloc+0x161a>
    3b76:	00002097          	auipc	ra,0x2
    3b7a:	3d0080e7          	jalr	976(ra) # 5f46 <printf>
    exit(1);
    3b7e:	4505                	li	a0,1
    ...
    3b8e:	ab650513          	addi	a0,a0,-1354 # 7640 <malloc+0x1642>
    3b92:	00002097          	auipc	ra,0x2
    3b96:	3b4080e7          	jalr	948(ra) # 5f46 <printf>
    exit(1);
    3b9a:	4505                	li	a0,1
    ...
    3baa:	aca50513          	addi	a0,a0,-1334 # 7670 <malloc+0x1672>
    3bae:	00002097          	auipc	ra,0x2
    3bb2:	398080e7          	jalr	920(ra) # 5f46 <printf>
    exit(1);
    3bb6:	4505                	li	a0,1
    ...
    3bc6:	ad650513          	addi	a0,a0,-1322 # 7698 <malloc+0x169a>
    3bca:	00002097          	auipc	ra,0x2
    3bce:	37c080e7          	jalr	892(ra) # 5f46 <printf>
    exit(1);
    3bd2:	4505                	li	a0,1
    ...
    3be2:	ad250513          	addi	a0,a0,-1326 # 76b0 <malloc+0x16b2>
    3be6:	00002097          	auipc	ra,0x2
    3bea:	360080e7          	jalr	864(ra) # 5f46 <printf>
    exit(1);
    3bee:	4505                	li	a0,1
    ...
    3bfe:	ad650513          	addi	a0,a0,-1322 # 76d0 <malloc+0x16d2>
    3c02:	00002097          	auipc	ra,0x2
    3c06:	344080e7          	jalr	836(ra) # 5f46 <printf>
    exit(1);
    3c0a:	4505                	li	a0,1
    ...
    3c1a:	ada50513          	addi	a0,a0,-1318 # 76f0 <malloc+0x16f2>
    3c1e:	00002097          	auipc	ra,0x2
    3c22:	328080e7          	jalr	808(ra) # 5f46 <printf>
    exit(1);
    3c26:	4505                	li	a0,1
    ...
    3c36:	afe50513          	addi	a0,a0,-1282 # 7730 <malloc+0x1732>
    3c3a:	00002097          	auipc	ra,0x2
    3c3e:	30c080e7          	jalr	780(ra) # 5f46 <printf>
    exit(1);
    3c42:	4505                	li	a0,1
    ...
    3c52:	b1250513          	addi	a0,a0,-1262 # 7760 <malloc+0x1762>
    3c56:	00002097          	auipc	ra,0x2
    3c5a:	2f0080e7          	jalr	752(ra) # 5f46 <printf>
    exit(1);
    3c5e:	4505                	li	a0,1
    ...
    3c6e:	b1650513          	addi	a0,a0,-1258 # 7780 <malloc+0x1782>
    3c72:	00002097          	auipc	ra,0x2
    3c76:	2d4080e7          	jalr	724(ra) # 5f46 <printf>
    exit(1);
    3c7a:	4505                	li	a0,1
    ...
    3c8a:	b1a50513          	addi	a0,a0,-1254 # 77a0 <malloc+0x17a2>
    3c8e:	00002097          	auipc	ra,0x2
    3c92:	2b8080e7          	jalr	696(ra) # 5f46 <printf>
    exit(1);
    3c96:	4505                	li	a0,1
    ...
    3ca6:	b1e50513          	addi	a0,a0,-1250 # 77c0 <malloc+0x17c2>
    3caa:	00002097          	auipc	ra,0x2
    3cae:	29c080e7          	jalr	668(ra) # 5f46 <printf>
    exit(1);
    3cb2:	4505                	li	a0,1
    ...
    3cc2:	b3250513          	addi	a0,a0,-1230 # 77f0 <malloc+0x17f2>
    3cc6:	00002097          	auipc	ra,0x2
    3cca:	280080e7          	jalr	640(ra) # 5f46 <printf>
    exit(1);
    3cce:	4505                	li	a0,1
    ...
    3cde:	b3e50513          	addi	a0,a0,-1218 # 7818 <malloc+0x181a>
    3ce2:	00002097          	auipc	ra,0x2
    3ce6:	264080e7          	jalr	612(ra) # 5f46 <printf>
    exit(1);
    3cea:	4505                	li	a0,1
    ...
    3cfa:	b4a50513          	addi	a0,a0,-1206 # 7840 <malloc+0x1842>
    3cfe:	00002097          	auipc	ra,0x2
    3d02:	248080e7          	jalr	584(ra) # 5f46 <printf>
    exit(1);
    3d06:	4505                	li	a0,1
    ...
    3d16:	b5650513          	addi	a0,a0,-1194 # 7868 <malloc+0x186a>
    3d1a:	00002097          	auipc	ra,0x2
    3d1e:	22c080e7          	jalr	556(ra) # 5f46 <printf>
    exit(1);
    3d22:	4505                	li	a0,1
    ...
    3d32:	b5a50513          	addi	a0,a0,-1190 # 7888 <malloc+0x188a>
    3d36:	00002097          	auipc	ra,0x2
    3d3a:	210080e7          	jalr	528(ra) # 5f46 <printf>
    exit(1);
    3d3e:	4505                	li	a0,1
    ...
    3d4e:	b5e50513          	addi	a0,a0,-1186 # 78a8 <malloc+0x18aa>
    3d52:	00002097          	auipc	ra,0x2
    3d56:	1f4080e7          	jalr	500(ra) # 5f46 <printf>
    exit(1);
    3d5a:	4505                	li	a0,1
    ...
    3d6a:	b6a50513          	addi	a0,a0,-1174 # 78d0 <malloc+0x18d2>
    3d6e:	00002097          	auipc	ra,0x2
    3d72:	1d8080e7          	jalr	472(ra) # 5f46 <printf>
    exit(1);
    3d76:	4505                	li	a0,1
    ...
    3d86:	b6e50513          	addi	a0,a0,-1170 # 78f0 <malloc+0x18f2>
    3d8a:	00002097          	auipc	ra,0x2
    3d8e:	1bc080e7          	jalr	444(ra) # 5f46 <printf>
    exit(1);
    3d92:	4505                	li	a0,1
    ...
    3da2:	b7250513          	addi	a0,a0,-1166 # 7910 <malloc+0x1912>
    3da6:	00002097          	auipc	ra,0x2
    3daa:	1a0080e7          	jalr	416(ra) # 5f46 <printf>
    exit(1);
    3dae:	4505                	li	a0,1
    ...
    3dbe:	b7e50513          	addi	a0,a0,-1154 # 7938 <malloc+0x193a>
    3dc2:	00002097          	auipc	ra,0x2
    3dc6:	184080e7          	jalr	388(ra) # 5f46 <printf>
    exit(1);
    3dca:	4505                	li	a0,1
    ...
    3dda:	7fa50513          	addi	a0,a0,2042 # 75d0 <malloc+0x15d2>
    3dde:	00002097          	auipc	ra,0x2
    3de2:	168080e7          	jalr	360(ra) # 5f46 <printf>
    exit(1);
    3de6:	4505                	li	a0,1
    ...
    3df6:	b6650513          	addi	a0,a0,-1178 # 7958 <malloc+0x195a>
    3dfa:	00002097          	auipc	ra,0x2
    3dfe:	14c080e7          	jalr	332(ra) # 5f46 <printf>
    exit(1);
    3e02:	4505                	li	a0,1
    ...
    3e12:	b6a50513          	addi	a0,a0,-1174 # 7978 <malloc+0x197a>
    3e16:	00002097          	auipc	ra,0x2
    3e1a:	130080e7          	jalr	304(ra) # 5f46 <printf>
    exit(1);
    3e1e:	4505                	li	a0,1
    ...
    3e2e:	b7e50513          	addi	a0,a0,-1154 # 79a8 <malloc+0x19aa>
    3e32:	00002097          	auipc	ra,0x2
    3e36:	114080e7          	jalr	276(ra) # 5f46 <printf>
    exit(1);
    3e3a:	4505                	li	a0,1
    ...
    3e4a:	b8250513          	addi	a0,a0,-1150 # 79c8 <malloc+0x19ca>
    3e4e:	00002097          	auipc	ra,0x2
    3e52:	0f8080e7          	jalr	248(ra) # 5f46 <printf>
    exit(1);
    3e56:	4505                	li	a0,1
...
0000000000003e60 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3e70:	b7450513          	addi	a0,a0,-1164 # 79e0 <malloc+0x19e2>
  ...
  if(chdir("dots") != 0){
    ...
    3e82:	b6250513          	addi	a0,a0,-1182 # 79e0 <malloc+0x19e2>
  ...
  if(unlink(".") == 0){
    ...
    3e94:	98050513          	addi	a0,a0,-1664 # 6810 <malloc+0x812>
  ...
  if(unlink("..") == 0){
    ...
    3ea6:	59650513          	addi	a0,a0,1430 # 7438 <malloc+0x143a>
  ...
  if(chdir("/") != 0){
    ...
    3eb8:	52c50513          	addi	a0,a0,1324 # 73e0 <malloc+0x13e2>
  ...
  if(unlink("dots/.") == 0){
    ...
    3eca:	b8250513          	addi	a0,a0,-1150 # 7a48 <malloc+0x1a4a>
  ...
  if(unlink("dots/..") == 0){
    ...
    3edc:	b9850513          	addi	a0,a0,-1128 # 7a70 <malloc+0x1a72>
  ...
  if(unlink("dots") != 0){
    ...
    3eee:	af650513          	addi	a0,a0,-1290 # 79e0 <malloc+0x19e2>
    ...
    3f0c:	ae050513          	addi	a0,a0,-1312 # 79e8 <malloc+0x19ea>
    3f10:	00002097          	auipc	ra,0x2
    3f14:	036080e7          	jalr	54(ra) # 5f46 <printf>
    exit(1);
    3f18:	4505                	li	a0,1
    ...
    3f28:	adc50513          	addi	a0,a0,-1316 # 7a00 <malloc+0x1a02>
    3f2c:	00002097          	auipc	ra,0x2
    3f30:	01a080e7          	jalr	26(ra) # 5f46 <printf>
    exit(1);
    3f34:	4505                	li	a0,1
    ...
    3f44:	ad850513          	addi	a0,a0,-1320 # 7a18 <malloc+0x1a1a>
    3f48:	00002097          	auipc	ra,0x2
    3f4c:	ffe080e7          	jalr	-2(ra) # 5f46 <printf>
    exit(1);
    3f50:	4505                	li	a0,1
    ...
    3f60:	ad450513          	addi	a0,a0,-1324 # 7a30 <malloc+0x1a32>
    3f64:	00002097          	auipc	ra,0x2
    3f68:	fe2080e7          	jalr	-30(ra) # 5f46 <printf>
    exit(1);
    3f6c:	4505                	li	a0,1
    ...
    3f7c:	47050513          	addi	a0,a0,1136 # 73e8 <malloc+0x13ea>
    3f80:	00002097          	auipc	ra,0x2
    3f84:	fc6080e7          	jalr	-58(ra) # 5f46 <printf>
    exit(1);
    3f88:	4505                	li	a0,1
    ...
    3f98:	abc50513          	addi	a0,a0,-1348 # 7a50 <malloc+0x1a52>
    3f9c:	00002097          	auipc	ra,0x2
    3fa0:	faa080e7          	jalr	-86(ra) # 5f46 <printf>
    exit(1);
    3fa4:	4505                	li	a0,1
    ...
    3fb4:	ac850513          	addi	a0,a0,-1336 # 7a78 <malloc+0x1a7a>
    3fb8:	00002097          	auipc	ra,0x2
    3fbc:	f8e080e7          	jalr	-114(ra) # 5f46 <printf>
    exit(1);
    3fc0:	4505                	li	a0,1
    ...
    3fd0:	acc50513          	addi	a0,a0,-1332 # 7a98 <malloc+0x1a9a>
    3fd4:	00002097          	auipc	ra,0x2
    3fd8:	f72080e7          	jalr	-142(ra) # 5f46 <printf>
    exit(1);
    3fdc:	4505                	li	a0,1
...
0000000000003fe6 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3ffc:	ac050513          	addi	a0,a0,-1344 # 7ab8 <malloc+0x1aba>
  ...
  if(chdir("dirfile") == 0){
    ...
    4018:	aa450513          	addi	a0,a0,-1372 # 7ab8 <malloc+0x1aba>
  ...
  fd = open("dirfile/xx", 0);
    ...
    402c:	ad850513          	addi	a0,a0,-1320 # 7b00 <malloc+0x1b02>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4044:	ac050513          	addi	a0,a0,-1344 # 7b00 <malloc+0x1b02>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    4058:	aac50513          	addi	a0,a0,-1364 # 7b00 <malloc+0x1b02>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    406c:	a9850513          	addi	a0,a0,-1384 # 7b00 <malloc+0x1b02>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    4080:	a8458593          	addi	a1,a1,-1404 # 7b00 <malloc+0x1b02>
    4084:	00002517          	auipc	a0,0x2
    4088:	27c50513          	addi	a0,a0,636 # 6300 <malloc+0x302>
  ...
  if(unlink("dirfile") != 0){
    ...
    409c:	a2050513          	addi	a0,a0,-1504 # 7ab8 <malloc+0x1aba>
  ...
  fd = open(".", O_RDWR);
    ...
    40b2:	76250513          	addi	a0,a0,1890 # 6810 <malloc+0x812>
  ...
  fd = open(".", 0);
    ...
    40c8:	74c50513          	addi	a0,a0,1868 # 6810 <malloc+0x812>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    40dc:	0c058593          	addi	a1,a1,192 # 6198 <malloc+0x19a>
  ...
  close(fd);
    ...
    4108:	9bc50513          	addi	a0,a0,-1604 # 7ac0 <malloc+0x1ac2>
    410c:	00002097          	auipc	ra,0x2
    4110:	e3a080e7          	jalr	-454(ra) # 5f46 <printf>
    exit(1);
    4114:	4505                	li	a0,1
    ...
    4124:	9c050513          	addi	a0,a0,-1600 # 7ae0 <malloc+0x1ae2>
    4128:	00002097          	auipc	ra,0x2
    412c:	e1e080e7          	jalr	-482(ra) # 5f46 <printf>
    exit(1);
    4130:	4505                	li	a0,1
    ...
    4140:	9d450513          	addi	a0,a0,-1580 # 7b10 <malloc+0x1b12>
    4144:	00002097          	auipc	ra,0x2
    4148:	e02080e7          	jalr	-510(ra) # 5f46 <printf>
    exit(1);
    414c:	4505                	li	a0,1
    ...
    415c:	9b850513          	addi	a0,a0,-1608 # 7b10 <malloc+0x1b12>
    4160:	00002097          	auipc	ra,0x2
    4164:	de6080e7          	jalr	-538(ra) # 5f46 <printf>
    exit(1);
    4168:	4505                	li	a0,1
    ...
    4178:	9c450513          	addi	a0,a0,-1596 # 7b38 <malloc+0x1b3a>
    417c:	00002097          	auipc	ra,0x2
    4180:	dca080e7          	jalr	-566(ra) # 5f46 <printf>
    exit(1);
    4184:	4505                	li	a0,1
    ...
    4194:	9d050513          	addi	a0,a0,-1584 # 7b60 <malloc+0x1b62>
    4198:	00002097          	auipc	ra,0x2
    419c:	dae080e7          	jalr	-594(ra) # 5f46 <printf>
    exit(1);
    41a0:	4505                	li	a0,1
    ...
    41b0:	9dc50513          	addi	a0,a0,-1572 # 7b88 <malloc+0x1b8a>
    41b4:	00002097          	auipc	ra,0x2
    41b8:	d92080e7          	jalr	-622(ra) # 5f46 <printf>
    exit(1);
    41bc:	4505                	li	a0,1
    ...
    41cc:	9e850513          	addi	a0,a0,-1560 # 7bb0 <malloc+0x1bb2>
    41d0:	00002097          	auipc	ra,0x2
    41d4:	d76080e7          	jalr	-650(ra) # 5f46 <printf>
    exit(1);
    41d8:	4505                	li	a0,1
    ...
    41e8:	9ec50513          	addi	a0,a0,-1556 # 7bd0 <malloc+0x1bd2>
    41ec:	00002097          	auipc	ra,0x2
    41f0:	d5a080e7          	jalr	-678(ra) # 5f46 <printf>
    exit(1);
    41f4:	4505                	li	a0,1
    ...
    4204:	9f850513          	addi	a0,a0,-1544 # 7bf8 <malloc+0x1bfa>
    4208:	00002097          	auipc	ra,0x2
    420c:	d3e080e7          	jalr	-706(ra) # 5f46 <printf>
    exit(1);
    4210:	4505                	li	a0,1
...
000000000000421a <iref>:
{
    ...
    4238:	9dca0a13          	addi	s4,s4,-1572 # 7c10 <malloc+0x1c12>
    mkdir("");
    423c:	00003497          	auipc	s1,0x3
    4240:	4dc48493          	addi	s1,s1,1244 # 7718 <malloc+0x171a>
    link("README", "");
    4244:	00002a97          	auipc	s5,0x2
    4248:	0bca8a93          	addi	s5,s5,188 # 6300 <malloc+0x302>
    fd = open("xx", O_CREATE);
    424c:	00004997          	auipc	s3,0x4
    4250:	8bc98993          	addi	s3,s3,-1860 # 7b08 <malloc+0x1b0a>
    4254:	a891                	j	42a8 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    4256:	85da                	mv	a1,s6
    4258:	00004517          	auipc	a0,0x4
    425c:	9c050513          	addi	a0,a0,-1600 # 7c18 <malloc+0x1c1a>
    4260:	00002097          	auipc	ra,0x2
    4264:	ce6080e7          	jalr	-794(ra) # 5f46 <printf>
      exit(1);
    4268:	4505                	li	a0,1
    ...
    4278:	9bc50513          	addi	a0,a0,-1604 # 7c30 <malloc+0x1c32>
    427c:	00002097          	auipc	ra,0x2
    4280:	cca080e7          	jalr	-822(ra) # 5f46 <printf>
      exit(1);
    4284:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    430c:	13098993          	addi	s3,s3,304 # 7438 <malloc+0x143a>
    unlink("irefd");
    4310:	00004917          	auipc	s2,0x4
    4314:	90090913          	addi	s2,s2,-1792 # 7c10 <malloc+0x1c12>
    chdir("..");
    4318:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4334:	0b050513          	addi	a0,a0,176 # 73e0 <malloc+0x13e2>
...
0000000000004354 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    4364:	8e850513          	addi	a0,a0,-1816 # 7c48 <malloc+0x1c4a>
  ...
  if(pid == 0){
    ...
    4388:	8c450513          	addi	a0,a0,-1852 # 7c48 <malloc+0x1c4a>
    ...
    439e:	8ce50513          	addi	a0,a0,-1842 # 7c68 <malloc+0x1c6a>
    43a2:	00002097          	auipc	ra,0x2
    43a6:	ba4080e7          	jalr	-1116(ra) # 5f46 <printf>
      exit(1);
    43aa:	4505                	li	a0,1
    ...
    43ba:	89a50513          	addi	a0,a0,-1894 # 7c50 <malloc+0x1c52>
    43be:	00002097          	auipc	ra,0x2
    43c2:	b88080e7          	jalr	-1144(ra) # 5f46 <printf>
    exit(1);
    43c6:	4505                	li	a0,1
    ...
    43d6:	5de50513          	addi	a0,a0,1502 # 69b0 <malloc+0x9b2>
    43da:	00002097          	auipc	ra,0x2
    43de:	b6c080e7          	jalr	-1172(ra) # 5f46 <printf>
    exit(1);
    43e2:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    4404:	84850513          	addi	a0,a0,-1976 # 7c48 <malloc+0x1c4a>
    ...
    4418:	78c50513          	addi	a0,a0,1932 # 6ba0 <malloc+0xba2>
    441c:	00002097          	auipc	ra,0x2
    4420:	b2a080e7          	jalr	-1238(ra) # 5f46 <printf>
    exit(1);
    4424:	4505                	li	a0,1
...
0000000000004446 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4456:	83e50513          	addi	a0,a0,-1986 # 7c90 <malloc+0x1c92>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    4482:	81250513          	addi	a0,a0,-2030 # 7c90 <malloc+0x1c92>
  ...
  sleep(10); // one second
    ...
    44ba:	6ba50513          	addi	a0,a0,1722 # 6b70 <malloc+0xb72>
    44be:	00002097          	auipc	ra,0x2
    44c2:	a88080e7          	jalr	-1400(ra) # 5f46 <printf>
    exit(1);
    44c6:	4505                	li	a0,1
    ...
    44d4:	7c048493          	addi	s1,s1,1984 # 7c90 <malloc+0x1c92>
    44d8:	4581                	li	a1,0
    44da:	8526                	mv	a0,s1
...
0000000000004516 <killstatus>:
{
  ...
  exit(0);
    ...
    457c:	43850513          	addi	a0,a0,1080 # 69b0 <malloc+0x9b2>
    4580:	00002097          	auipc	ra,0x2
    4584:	9c6080e7          	jalr	-1594(ra) # 5f46 <printf>
      exit(1);
    4588:	4505                	li	a0,1
    ...
    45a2:	70250513          	addi	a0,a0,1794 # 7ca0 <malloc+0x1ca2>
    45a6:	00002097          	auipc	ra,0x2
    45aa:	9a0080e7          	jalr	-1632(ra) # 5f46 <printf>
       exit(1);
    45ae:	4505                	li	a0,1
...
00000000000045b8 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    45e2:	59250513          	addi	a0,a0,1426 # 6b70 <malloc+0xb72>
    45e6:	00002097          	auipc	ra,0x2
    45ea:	960080e7          	jalr	-1696(ra) # 5f46 <printf>
    exit(1);
    45ee:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    4610:	3a450513          	addi	a0,a0,932 # 69b0 <malloc+0x9b2>
    4614:	00002097          	auipc	ra,0x2
    4618:	932080e7          	jalr	-1742(ra) # 5f46 <printf>
    exit(1);
    461c:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    4654:	b4858593          	addi	a1,a1,-1208 # 6198 <malloc+0x19a>
    ...
    467e:	33650513          	addi	a0,a0,822 # 69b0 <malloc+0x9b2>
    4682:	00002097          	auipc	ra,0x2
    4686:	8c4080e7          	jalr	-1852(ra) # 5f46 <printf>
     exit(1);
    468a:	4505                	li	a0,1
    ...
    469a:	62a50513          	addi	a0,a0,1578 # 7cc0 <malloc+0x1cc2>
    469e:	00002097          	auipc	ra,0x2
    46a2:	8a8080e7          	jalr	-1880(ra) # 5f46 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    46d6:	60650513          	addi	a0,a0,1542 # 7cd8 <malloc+0x1cda>
    46da:	00002097          	auipc	ra,0x2
    46de:	86c080e7          	jalr	-1940(ra) # 5f46 <printf>
}
  ...
  printf("kill... ");
    ...
    4702:	5f250513          	addi	a0,a0,1522 # 7cf0 <malloc+0x1cf2>
    4706:	00002097          	auipc	ra,0x2
    470a:	840080e7          	jalr	-1984(ra) # 5f46 <printf>
  kill(pid1);
    470e:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    4730:	5d450513          	addi	a0,a0,1492 # 7d00 <malloc+0x1d02>
    4734:	00002097          	auipc	ra,0x2
    4738:	812080e7          	jalr	-2030(ra) # 5f46 <printf>
  wait(0);
    473c:	4501                	li	a0,0
...
000000000000475c <reparent>:
{
  ...
  exit(0);
    ...
    47b0:	20450513          	addi	a0,a0,516 # 69b0 <malloc+0x9b2>
    47b4:	00001097          	auipc	ra,0x1
    47b8:	792080e7          	jalr	1938(ra) # 5f46 <printf>
      exit(1);
    47bc:	4505                	li	a0,1
    ...
    47cc:	37050513          	addi	a0,a0,880 # 6b38 <malloc+0xb3a>
    47d0:	00001097          	auipc	ra,0x1
    47d4:	776080e7          	jalr	1910(ra) # 5f46 <printf>
        exit(1);
    47d8:	4505                	li	a0,1
...
000000000000480c <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4842:	27a50513          	addi	a0,a0,634 # 6ab8 <malloc+0xaba>
    4846:	00001097          	auipc	ra,0x1
    484a:	700080e7          	jalr	1792(ra) # 5f46 <printf>
    exit(1);
    484e:	4505                	li	a0,1
    ...
    4876:	92658593          	addi	a1,a1,-1754 # 6198 <malloc+0x19a>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    493a:	3da50513          	addi	a0,a0,986 # 7d10 <malloc+0x1d12>
    493e:	00001097          	auipc	ra,0x1
    4942:	608080e7          	jalr	1544(ra) # 5f46 <printf>
    exit(1);
    4946:	4505                	li	a0,1
    ...
    4956:	05e50513          	addi	a0,a0,94 # 69b0 <malloc+0x9b2>
    495a:	00001097          	auipc	ra,0x1
    495e:	5ec080e7          	jalr	1516(ra) # 5f46 <printf>
    exit(1);
    4962:	4505                	li	a0,1
    ...
    49a2:	39250513          	addi	a0,a0,914 # 7d30 <malloc+0x1d32>
    49a6:	00001097          	auipc	ra,0x1
    49aa:	5a0080e7          	jalr	1440(ra) # 5f46 <printf>
    exit(1);
    49ae:	4505                	li	a0,1
...
00000000000049c2 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a0c:	5f6080e7          	jalr	1526(ra) # 5ffe <malloc>
    ...
    4a46:	31e50513          	addi	a0,a0,798 # 7d60 <malloc+0x1d62>
    4a4a:	00001097          	auipc	ra,0x1
    4a4e:	4fc080e7          	jalr	1276(ra) # 5f46 <printf>
      exit(1);
    4a52:	4505                	li	a0,1
...
0000000000004a66 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4afc:	29850513          	addi	a0,a0,664 # 7d90 <malloc+0x1d92>
    4b00:	00001097          	auipc	ra,0x1
    4b04:	446080e7          	jalr	1094(ra) # 5f46 <printf>
    exit(1);
    4b08:	4505                	li	a0,1
    ...
    4b18:	2a450513          	addi	a0,a0,676 # 7db8 <malloc+0x1dba>
    4b1c:	00001097          	auipc	ra,0x1
    4b20:	42a080e7          	jalr	1066(ra) # 5f46 <printf>
      exit(1);
    4b24:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    4b5c:	22850513          	addi	a0,a0,552 # 7d80 <malloc+0x1d82>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4b9c:	24050513          	addi	a0,a0,576 # 7dd8 <malloc+0x1dda>
    4ba0:	00001097          	auipc	ra,0x1
    4ba4:	3a6080e7          	jalr	934(ra) # 5f46 <printf>
    exit(1);
    4ba8:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    4bd8:	1ac50513          	addi	a0,a0,428 # 7d80 <malloc+0x1d82>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4bfe:	20650513          	addi	a0,a0,518 # 7e00 <malloc+0x1e02>
    4c02:	00001097          	auipc	ra,0x1
    4c06:	344080e7          	jalr	836(ra) # 5f46 <printf>
    exit(1);
    4c0a:	4505                	li	a0,1
...
0000000000004c1e <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4c44:	1d878793          	addi	a5,a5,472 # 7e18 <malloc+0x1e1a>
    4c48:	f6f43823          	sd	a5,-144(s0)
    4c4c:	00003797          	auipc	a5,0x3
    4c50:	1d478793          	addi	a5,a5,468 # 7e20 <malloc+0x1e22>
    4c54:	f6f43c23          	sd	a5,-136(s0)
    4c58:	00003797          	auipc	a5,0x3
    4c5c:	1d078793          	addi	a5,a5,464 # 7e28 <malloc+0x1e2a>
    4c60:	f8f43023          	sd	a5,-128(s0)
    4c64:	00003797          	auipc	a5,0x3
    4c68:	1cc78793          	addi	a5,a5,460 # 7e30 <malloc+0x1e32>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4ce0:	0dc50513          	addi	a0,a0,220 # 6db8 <malloc+0xdba>
    4ce4:	00001097          	auipc	ra,0x1
    4ce8:	262080e7          	jalr	610(ra) # 5f46 <printf>
      exit(1);
    4cec:	4505                	li	a0,1
    ...
    4d5c:	0e050513          	addi	a0,a0,224 # 7e38 <malloc+0x1e3a>
    4d60:	00001097          	auipc	ra,0x1
    4d64:	1e6080e7          	jalr	486(ra) # 5f46 <printf>
        exit(1);
    4d68:	4505                	li	a0,1
    ...
    4d76:	0d650513          	addi	a0,a0,214 # 7e48 <malloc+0x1e4a>
    4d7a:	00001097          	auipc	ra,0x1
    4d7e:	1cc080e7          	jalr	460(ra) # 5f46 <printf>
          exit(1);
    4d82:	4505                	li	a0,1
    ...
    4d9e:	0c650513          	addi	a0,a0,198 # 7e60 <malloc+0x1e62>
    4da2:	00001097          	auipc	ra,0x1
    4da6:	1a4080e7          	jalr	420(ra) # 5f46 <printf>
          exit(1);
    4daa:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e2c:	04850513          	addi	a0,a0,72 # 7e70 <malloc+0x1e72>
    4e30:	00001097          	auipc	ra,0x1
    4e34:	116080e7          	jalr	278(ra) # 5f46 <printf>
      exit(1);
    4e38:	4505                	li	a0,1
...
0000000000004e60 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4e8e:	ffeb8b93          	addi	s7,s7,-2 # 7e88 <malloc+0x1e8a>
  for(i = 0; i < N; i++){
    ...
    4ed0:	fc450513          	addi	a0,a0,-60 # 7e90 <malloc+0x1e92>
    4ed4:	00001097          	auipc	ra,0x1
    4ed8:	072080e7          	jalr	114(ra) # 5f46 <printf>
        exit(1);
    4edc:	4505                	li	a0,1
    ...
    4eee:	f9e50513          	addi	a0,a0,-98 # 7e88 <malloc+0x1e8a>
  ...
  fd = open(".", 0);
    ...
    4f26:	8ee50513          	addi	a0,a0,-1810 # 6810 <malloc+0x812>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4f9e:	f1650513          	addi	a0,a0,-234 # 7eb0 <malloc+0x1eb2>
    ...
    4fbe:	f1650513          	addi	a0,a0,-234 # 7ed0 <malloc+0x1ed2>
  ...
  for(i = 0; i < N; i++){
    ...
    4ff6:	f0650513          	addi	a0,a0,-250 # 7ef8 <malloc+0x1efa>
    ...
    5012:	9a250513          	addi	a0,a0,-1630 # 69b0 <malloc+0x9b2>
...
00000000000051bc <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    5244:	cf050513          	addi	a0,a0,-784 # 7f30 <malloc+0x1f32>
  ...
  for(i = 0; ; i++){
    ...
    52a8:	c9c50513          	addi	a0,a0,-868 # 7f40 <malloc+0x1f42>
    ...
    52c4:	ca050513          	addi	a0,a0,-864 # 7f60 <malloc+0x1f62>
    ...
    52e0:	ca450513          	addi	a0,a0,-860 # 7f80 <malloc+0x1f82>
    ...
    52fc:	ca850513          	addi	a0,a0,-856 # 7fa0 <malloc+0x1fa2>
    ...
    5318:	cac50513          	addi	a0,a0,-852 # 7fc0 <malloc+0x1fc2>
    ...
    5334:	ca850513          	addi	a0,a0,-856 # 7fd8 <malloc+0x1fda>
  ...
  unlink("bigfile.dat");
    ...
    5362:	bd250513          	addi	a0,a0,-1070 # 7f30 <malloc+0x1f32>
    ...
    5386:	c7650513          	addi	a0,a0,-906 # 7ff8 <malloc+0x1ffa>
...
000000000000539c <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    53be:	c5e50513          	addi	a0,a0,-930 # 8018 <malloc+0x201a>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    53de:	c4ec8c93          	addi	s9,s9,-946 # 8028 <malloc+0x202a>
    int total = 0;
    53e2:	4d81                	li	s11,0
    ...
    5458:	be450513          	addi	a0,a0,-1052 # 8038 <malloc+0x203a>
  ...
  printf("fsfull test finished\n");
    ...
    54ce:	b8e50513          	addi	a0,a0,-1138 # 8058 <malloc+0x205a>
    ...
    551e:	b2e50513          	addi	a0,a0,-1234 # 8048 <malloc+0x204a>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5550:	b2450513          	addi	a0,a0,-1244 # 8070 <malloc+0x2072>
  ...
  if(pid == 0) {
    ...
    5580:	b1c50513          	addi	a0,a0,-1252 # 8098 <malloc+0x209a>
    ...
    55a4:	ae050513          	addi	a0,a0,-1312 # 8080 <malloc+0x2082>
    ...
    55cc:	ad850513          	addi	a0,a0,-1320 # 80a0 <malloc+0x20a2>
...
runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    561c:	a9050513          	addi	a0,a0,-1392 # 80a8 <malloc+0x20aa>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    5676:	b2698993          	addi	s3,s3,-1242 # 6198 <malloc+0x19a>
      uint64 a = (uint64) sbrk(4096);
    ...
    56a8:	a5c50513          	addi	a0,a0,-1444 # 8100 <malloc+0x2102>
    ...
    56c2:	a0250513          	addi	a0,a0,-1534 # 80c0 <malloc+0x20c2>
    ...
    56dc:	a0850513          	addi	a0,a0,-1528 # 80e0 <malloc+0x20e2>
  ...
  while(1){
    ...
    572a:	9fa50513          	addi	a0,a0,-1542 # 8120 <malloc+0x2122>
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    578c:	9b8b8b93          	addi	s7,s7,-1608 # 8140 <malloc+0x2142>
    int free0 = countfree();
    int free1 = 0;
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    58a2:	90a58593          	addi	a1,a1,-1782 # 81a8 <malloc+0x21aa>
    ...
    58ba:	94a58593          	addi	a1,a1,-1718 # 8200 <malloc+0x2202>
    ...
    58d0:	92c58593          	addi	a1,a1,-1748 # 81f8 <malloc+0x21fa>
  ...
  int continuous = 0;
    ...
    58fc:	8b850513          	addi	a0,a0,-1864 # 81b0 <malloc+0x21b2>
  ...
  printf("ALL TESTS PASSED\n");
    ...
    5928:	8bc50513          	addi	a0,a0,-1860 # 81e0 <malloc+0x21e2>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    5cb4:	91850513          	addi	a0,a0,-1768 # 85c8 <digits>
    5cb8:	883a                	mv	a6,a4
    5cba:	2705                	addiw	a4,a4,1
    5cbc:	02c5f7bb          	remuw	a5,a1,a2
    5cc0:	1782                	slli	a5,a5,0x20
    5cc2:	9381                	srli	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    5d6e:	4c55                	li	s8,21
    5d70:	00003c97          	auipc	s9,0x3
    5d74:	800c8c93          	addi	s9,s9,-2048 # 8570 <malloc+0x2572>
        ...
        if(s == 0)
          s = "(null)";
        while(*s != 0){
    5d78:	02800d93          	li	s11,40
  putc(fd, 'x');
    5d7c:	4d41                	li	s10,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5d7e:	00003b97          	auipc	s7,0x3
    5d82:	84ab8b93          	addi	s7,s7,-1974 # 85c8 <digits>
    5d86:	a839                	j	5da4 <vprintf+0x6a>
        putc(fd, c);
    5d88:	85ca                	mv	a1,s2
    5d8a:	8556                	mv	a0,s5
    5d8c:	00000097          	auipc	ra,0x0
    5d90:	ee0080e7          	jalr	-288(ra) # 5c6c <putc>
    5d94:	a019                	j	5d9a <vprintf+0x60>
    } else if(state == '%'){
    5d96:	01498d63          	beq	s3,s4,5db0 <vprintf+0x76>
  for(i = 0; fmt[i]; i++){
    5d9a:	0485                	addi	s1,s1,1
    5d9c:	fff4c903          	lbu	s2,-1(s1)
    5da0:	14090d63          	beqz	s2,5efa <vprintf+0x1c0>
    if(state == 0){
    5da4:	fe0999e3          	bnez	s3,5d96 <vprintf+0x5c>
      if(c == '%'){
    5da8:	ff4910e3          	bne	s2,s4,5d88 <vprintf+0x4e>
        state = '%';
    5dac:	89d2                	mv	s3,s4
    5dae:	b7f5                	j	5d9a <vprintf+0x60>
      if(c == 'd'){
    5db0:	11490c63          	beq	s2,s4,5ec8 <vprintf+0x18e>
    5db4:	f9d9079b          	addiw	a5,s2,-99
    5db8:	0ff7f793          	zext.b	a5,a5
    5dbc:	10fc6e63          	bltu	s8,a5,5ed8 <vprintf+0x19e>
    5dc0:	f9d9079b          	addiw	a5,s2,-99
    5dc4:	0ff7f713          	zext.b	a4,a5
    5dc8:	10ec6863          	bltu	s8,a4,5ed8 <vprintf+0x19e>
    5dcc:	00271793          	slli	a5,a4,0x2
    5dd0:	97e6                	add	a5,a5,s9
    5dd2:	439c                	lw	a5,0(a5)
    5dd4:	97e6                	add	a5,a5,s9
    5dd6:	8782                	jr	a5
        printint(fd, va_arg(ap, int), 10, 1);
    5dd8:	008b0913          	addi	s2,s6,8
    5ddc:	4685                	li	a3,1
    5dde:	4629                	li	a2,10
    5de0:	000b2583          	lw	a1,0(s6)
    5de4:	8556                	mv	a0,s5
    5de6:	00000097          	auipc	ra,0x0
    5dea:	ea8080e7          	jalr	-344(ra) # 5c8e <printint>
    5dee:	8b4a                	mv	s6,s2
      } else {
    ...
    5e06:	e8c080e7          	jalr	-372(ra) # 5c8e <printint>
    5e0a:	8b4a                	mv	s6,s2
      state = 0;
    5e0c:	4981                	li	s3,0
    ...
    5e22:	e70080e7          	jalr	-400(ra) # 5c8e <printint>
    5e26:	8b4a                	mv	s6,s2
      state = 0;
    5e28:	4981                	li	s3,0
    5e2a:	bf85                	j	5d9a <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    5e2c:	008b0793          	addi	a5,s6,8
    5e30:	f8f43423          	sd	a5,-120(s0)
    5e34:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    5e38:	03000593          	li	a1,48
    5e3c:	8556                	mv	a0,s5
    5e3e:	00000097          	auipc	ra,0x0
    5e42:	e2e080e7          	jalr	-466(ra) # 5c6c <putc>
  putc(fd, 'x');
    5e46:	07800593          	li	a1,120
    5e4a:	8556                	mv	a0,s5
    5e4c:	00000097          	auipc	ra,0x0
    5e50:	e20080e7          	jalr	-480(ra) # 5c6c <putc>
    5e54:	896a                	mv	s2,s10
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5e56:	03c9d793          	srli	a5,s3,0x3c
    5e5a:	97de                	add	a5,a5,s7
    5e5c:	0007c583          	lbu	a1,0(a5)
    5e60:	8556                	mv	a0,s5
    5e62:	00000097          	auipc	ra,0x0
    5e66:	e0a080e7          	jalr	-502(ra) # 5c6c <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5e6a:	0992                	slli	s3,s3,0x4
    5e6c:	397d                	addiw	s2,s2,-1
    5e6e:	fe0914e3          	bnez	s2,5e56 <vprintf+0x11c>
        printptr(fd, va_arg(ap, uint64));
    5e72:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    5e76:	4981                	li	s3,0
    5e78:	b70d                	j	5d9a <vprintf+0x60>
        s = va_arg(ap, char*);
    5e7a:	008b0913          	addi	s2,s6,8
    5e7e:	000b3983          	ld	s3,0(s6)
        if(s == 0)
    5e82:	02098163          	beqz	s3,5ea4 <vprintf+0x16a>
        while(*s != 0){
    5e86:	0009c583          	lbu	a1,0(s3)
    5e8a:	c5ad                	beqz	a1,5ef4 <vprintf+0x1ba>
          putc(fd, *s);
    5e8c:	8556                	mv	a0,s5
    5e8e:	00000097          	auipc	ra,0x0
    5e92:	dde080e7          	jalr	-546(ra) # 5c6c <putc>
          s++;
    5e96:	0985                	addi	s3,s3,1
        while(*s != 0){
    5e98:	0009c583          	lbu	a1,0(s3)
    5e9c:	f9e5                	bnez	a1,5e8c <vprintf+0x152>
        s = va_arg(ap, char*);
    5e9e:	8b4a                	mv	s6,s2
      state = 0;
    5ea0:	4981                	li	s3,0
    5ea2:	bde5                	j	5d9a <vprintf+0x60>
          s = "(null)";
    5ea4:	00002997          	auipc	s3,0x2
    5ea8:	6c498993          	addi	s3,s3,1732 # 8568 <malloc+0x256a>
        while(*s != 0){
    5eac:	85ee                	mv	a1,s11
    5eae:	bff9                	j	5e8c <vprintf+0x152>
        putc(fd, va_arg(ap, uint));
    5eb0:	008b0913          	addi	s2,s6,8
    5eb4:	000b4583          	lbu	a1,0(s6)
    5eb8:	8556                	mv	a0,s5
    5eba:	00000097          	auipc	ra,0x0
    5ebe:	db2080e7          	jalr	-590(ra) # 5c6c <putc>
    5ec2:	8b4a                	mv	s6,s2
      state = 0;
    5ec4:	4981                	li	s3,0
    5ec6:	bdd1                	j	5d9a <vprintf+0x60>
        putc(fd, c);
    5ec8:	85d2                	mv	a1,s4
    5eca:	8556                	mv	a0,s5
    5ecc:	00000097          	auipc	ra,0x0
    5ed0:	da0080e7          	jalr	-608(ra) # 5c6c <putc>
      state = 0;
    5ed4:	4981                	li	s3,0
    5ed6:	b5d1                	j	5d9a <vprintf+0x60>
        putc(fd, '%');
    5ed8:	85d2                	mv	a1,s4
    5eda:	8556                	mv	a0,s5
    ...
    5eec:	d84080e7          	jalr	-636(ra) # 5c6c <putc>
      state = 0;
    5ef0:	4981                	li	s3,0
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    5f8e:	a02d                	j	5fb8 <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5f90:	4618                	lw	a4,8(a2)
    5f92:	9f2d                	addw	a4,a4,a1
    5f94:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5f98:	6398                	ld	a4,0(a5)
    5f9a:	6310                	ld	a2,0(a4)
    5f9c:	a83d                	j	5fda <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5f9e:	ff852703          	lw	a4,-8(a0)
    5fa2:	9f31                	addw	a4,a4,a2
    5fa4:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    5fa6:	ff053683          	ld	a3,-16(a0)
    5faa:	a091                	j	5fee <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5fac:	6398                	ld	a4,0(a5)
    5fae:	00e7e463          	bltu	a5,a4,5fb6 <free+0x3a>
    5fb2:	00e6ea63          	bltu	a3,a4,5fc6 <free+0x4a>
{
    5fb6:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5fb8:	fed7fae3          	bgeu	a5,a3,5fac <free+0x30>
    5fbc:	6398                	ld	a4,0(a5)
    5fbe:	00e6e463          	bltu	a3,a4,5fc6 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5fc2:	fee7eae3          	bltu	a5,a4,5fb6 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    5fc6:	ff852583          	lw	a1,-8(a0)
    5fca:	6390                	ld	a2,0(a5)
    5fcc:	02059813          	slli	a6,a1,0x20
    5fd0:	01c85713          	srli	a4,a6,0x1c
    5fd4:	9736                	add	a4,a4,a3
    5fd6:	fae60de3          	beq	a2,a4,5f90 <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    5fda:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5fde:	4790                	lw	a2,8(a5)
    5fe0:	02061593          	slli	a1,a2,0x20
    5fe4:	01c5d713          	srli	a4,a1,0x1c
    5fe8:	973e                	add	a4,a4,a5
    5fea:	fae68ae3          	beq	a3,a4,5f9e <free+0x22>
    p->s.ptr = bp->s.ptr;
    5fee:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    5ff0:	00003717          	auipc	a4,0x3
    5ff4:	46f73023          	sd	a5,1120(a4) # 9450 <freep>
}
    5ff8:	6422                	ld	s0,8(sp)
    5ffa:	0141                	addi	sp,sp,16
    5ffc:	8082                	ret

0000000000005ffe <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    5ffe:	7139                	addi	sp,sp,-64
    6000:	fc06                	sd	ra,56(sp)
    6002:	f822                	sd	s0,48(sp)
    6004:	f426                	sd	s1,40(sp)
    6006:	f04a                	sd	s2,32(sp)
    6008:	ec4e                	sd	s3,24(sp)
    600a:	e852                	sd	s4,16(sp)
    600c:	e456                	sd	s5,8(sp)
    600e:	e05a                	sd	s6,0(sp)
    6010:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    6012:	02051493          	slli	s1,a0,0x20
    6016:	9081                	srli	s1,s1,0x20
    6018:	04bd                	addi	s1,s1,15
    601a:	8091                	srli	s1,s1,0x4
    601c:	0014899b          	addiw	s3,s1,1
    6020:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    6022:	00003517          	auipc	a0,0x3
    6026:	42e53503          	ld	a0,1070(a0) # 9450 <freep>
    602a:	c515                	beqz	a0,6056 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    602c:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    602e:	4798                	lw	a4,8(a5)
    6030:	02977f63          	bgeu	a4,s1,606e <malloc+0x70>
    6034:	8a4e                	mv	s4,s3
    6036:	0009871b          	sext.w	a4,s3
    603a:	6685                	lui	a3,0x1
    603c:	00d77363          	bgeu	a4,a3,6042 <malloc+0x44>
    6040:	6a05                	lui	s4,0x1
    6042:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    6046:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    604a:	00003917          	auipc	s2,0x3
    604e:	40690913          	addi	s2,s2,1030 # 9450 <freep>
  if(p == (char*)-1)
    6052:	5afd                	li	s5,-1
    6054:	a895                	j	60c8 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    6056:	0000a797          	auipc	a5,0xa
    605a:	c2278793          	addi	a5,a5,-990 # fc78 <base>
    605e:	00003717          	auipc	a4,0x3
    6062:	3ef73923          	sd	a5,1010(a4) # 9450 <freep>
    6066:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    6068:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    606c:	b7e1                	j	6034 <malloc+0x36>
      if(p->s.size == nunits)
    606e:	02e48c63          	beq	s1,a4,60a6 <malloc+0xa8>
        p->s.size -= nunits;
    6072:	4137073b          	subw	a4,a4,s3
    6076:	c798                	sw	a4,8(a5)
        p += p->s.size;
    6078:	02071693          	slli	a3,a4,0x20
    607c:	01c6d713          	srli	a4,a3,0x1c
    6080:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    6082:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    6086:	00003717          	auipc	a4,0x3
    608a:	3ca73523          	sd	a0,970(a4) # 9450 <freep>
      return (void*)(p + 1);
    608e:	01078513          	addi	a0,a5,16
      if((p = morecore(nunits)) == 0)
        return 0;
  }
}
    6092:	70e2                	ld	ra,56(sp)
    6094:	7442                	ld	s0,48(sp)
    6096:	74a2                	ld	s1,40(sp)
    6098:	7902                	ld	s2,32(sp)
    609a:	69e2                	ld	s3,24(sp)
    609c:	6a42                	ld	s4,16(sp)
    609e:	6aa2                	ld	s5,8(sp)
    60a0:	6b02                	ld	s6,0(sp)
    60a2:	6121                	addi	sp,sp,64
    60a4:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    60a6:	6398                	ld	a4,0(a5)
    60a8:	e118                	sd	a4,0(a0)
    60aa:	bff1                	j	6086 <malloc+0x88>
  hp->s.size = nu;
    60ac:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    60b0:	0541                	addi	a0,a0,16
    60b2:	00000097          	auipc	ra,0x0
    60b6:	eca080e7          	jalr	-310(ra) # 5f7c <free>
  return freep;
    60ba:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    60be:	d971                	beqz	a0,6092 <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    60c0:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    60c2:	4798                	lw	a4,8(a5)
    60c4:	fa9775e3          	bgeu	a4,s1,606e <malloc+0x70>
    if(p == freep)
    60c8:	00093703          	ld	a4,0(s2)
    60cc:	853e                	mv	a0,a5
    60ce:	fef719e3          	bne	a4,a5,60c0 <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
    60d2:	8552                	mv	a0,s4
    60d4:	00000097          	auipc	ra,0x0
    60d8:	b78080e7          	jalr	-1160(ra) # 5c4c <sbrk>
  if(p == (char*)-1)
    60dc:	fd5518e3          	bne	a0,s5,60ac <malloc+0xae>
        return 0;
    60e0:	4501                	li	a0,0
    60e2:	bf45                	j	6092 <malloc+0x94>
