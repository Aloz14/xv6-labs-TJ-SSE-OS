...
int main(int argc, char *argv[])
{
  ...
  12:	7e258593          	addi	a1,a1,2018 # 7f0 <malloc+0xf2>
  16:	4509                	li	a0,2
  ...
  42:	28e080e7          	jalr	654(ra) # 2cc <exit>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 474:	3c0c8c93          	addi	s9,s9,960 # 830 <malloc+0x132>
 ...
 482:	40ab8b93          	addi	s7,s7,1034 # 888 <digits>
 ...
 5a8:	28498993          	addi	s3,s3,644 # 828 <malloc+0x12a>
        while(*s != 0){
 5ac:	85ee                	mv	a1,s11
