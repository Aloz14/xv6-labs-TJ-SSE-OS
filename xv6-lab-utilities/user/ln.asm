...
main(int argc, char *argv[])
{
  ...
  14:	7f058593          	addi	a1,a1,2032 # 800 <malloc+0xe8>
  18:	4509                	li	a0,2
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 48e:	3aec8c93          	addi	s9,s9,942 # 838 <malloc+0x120>
 ...
 49c:	3f8b8b93          	addi	s7,s7,1016 # 890 <digits>
 ...
 5c2:	27298993          	addi	s3,s3,626 # 830 <malloc+0x118>
        while(*s != 0){
 5c6:	85ee                	mv	a1,s11
