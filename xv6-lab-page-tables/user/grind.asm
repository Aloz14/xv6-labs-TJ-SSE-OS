...
go(int which_child)
{
  ...
  int fd = -1;
    ...
    if(what == 1){
     ...
     724:	e4050513          	addi	a0,a0,-448 # 1560 <malloc+0x2da>
     728:	00001097          	auipc	ra,0x1
     72c:	aa6080e7          	jalr	-1370(ra) # 11ce <printf>
        exit(1);
     730:	4505                	li	a0,1
     ...
     73e:	e4e50513          	addi	a0,a0,-434 # 1588 <malloc+0x302>
     742:	00001097          	auipc	ra,0x1
     746:	a8c080e7          	jalr	-1396(ra) # 11ce <printf>
        exit(1);
     74a:	4505                	li	a0,1
     ...
     826:	e0658593          	addi	a1,a1,-506 # 1628 <malloc+0x3a2>
     ...
     84a:	dea50513          	addi	a0,a0,-534 # 1630 <malloc+0x3aa>
     84e:	00001097          	auipc	ra,0x1
     852:	980080e7          	jalr	-1664(ra) # 11ce <printf>
        exit(1);
     856:	4505                	li	a0,1
     ...
     864:	c5058593          	addi	a1,a1,-944 # 14b0 <malloc+0x22a>
     868:	4509                	li	a0,2
     86a:	00001097          	auipc	ra,0x1
     86e:	936080e7          	jalr	-1738(ra) # 11a0 <fprintf>
        exit(1);
     872:	4505                	li	a0,1
     ...
     880:	c3458593          	addi	a1,a1,-972 # 14b0 <malloc+0x22a>
     884:	4509                	li	a0,2
     886:	00001097          	auipc	ra,0x1
     88a:	91a080e7          	jalr	-1766(ra) # 11a0 <fprintf>
        exit(1);
     88e:	4505                	li	a0,1
     ...
     8dc:	cd858593          	addi	a1,a1,-808 # 15b0 <malloc+0x32a>
     8e0:	4509                	li	a0,2
     ...
     950:	b2458593          	addi	a1,a1,-1244 # 1470 <malloc+0x1ea>
     954:	4509                	li	a0,2
     956:	00001097          	auipc	ra,0x1
     95a:	84a080e7          	jalr	-1974(ra) # 11a0 <fprintf>
        exit(3);
     95e:	450d                	li	a0,3
     ...
     99c:	c1858593          	addi	a1,a1,-1000 # 15b0 <malloc+0x32a>
     9a0:	4509                	li	a0,2
     9a2:	00000097          	auipc	ra,0x0
     9a6:	7fe080e7          	jalr	2046(ra) # 11a0 <fprintf>
          exit(4);
     9aa:	4511                	li	a0,4
     ...
     9e0:	bd458593          	addi	a1,a1,-1068 # 15b0 <malloc+0x32a>
     9e4:	4509                	li	a0,2
     9e6:	00000097          	auipc	ra,0x0
     9ea:	7ba080e7          	jalr	1978(ra) # 11a0 <fprintf>
          exit(5);
     9ee:	4515                	li	a0,5
     ...
     a08:	bfc78793          	addi	a5,a5,-1028 # 1600 <malloc+0x37a>
     a0c:	faf43423          	sd	a5,-88(s0)
     a10:	fa043823          	sd	zero,-80(s0)
        exec("/cat", args);
     a14:	fa840593          	addi	a1,s0,-88
     a18:	00001517          	auipc	a0,0x1
     a1c:	bf050513          	addi	a0,a0,-1040 # 1608 <malloc+0x382>
     a20:	00000097          	auipc	ra,0x0
     a24:	45c080e7          	jalr	1116(ra) # e7c <exec>
        fprintf(2, "grind: cat: not found\n");
     a28:	00001597          	auipc	a1,0x1
     a2c:	be858593          	addi	a1,a1,-1048 # 1610 <malloc+0x38a>
     a30:	4509                	li	a0,2
     a32:	00000097          	auipc	ra,0x0
     a36:	76e080e7          	jalr	1902(ra) # 11a0 <fprintf>
        exit(6);
     a3a:	4519                	li	a0,6
     ...
     a48:	a2c58593          	addi	a1,a1,-1492 # 1470 <malloc+0x1ea>
     a4c:	4509                	li	a0,2
     a4e:	00000097          	auipc	ra,0x0
     a52:	752080e7          	jalr	1874(ra) # 11a0 <fprintf>
        exit(7);
     a56:	451d                	li	a0,7
...
iter()
{
  ...
  unlink("a");
     ...
     a70:	9e450513          	addi	a0,a0,-1564 # 1450 <malloc+0x1ca>
     a74:	00000097          	auipc	ra,0x0
     a78:	420080e7          	jalr	1056(ra) # e94 <unlink>
  unlink("b");
     a7c:	00001517          	auipc	a0,0x1
     a80:	98450513          	addi	a0,a0,-1660 # 1400 <malloc+0x17a>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     aba:	9ba50513          	addi	a0,a0,-1606 # 1470 <malloc+0x1ea>
     abe:	00000097          	auipc	ra,0x0
     ac2:	710080e7          	jalr	1808(ra) # 11ce <printf>
    exit(1);
     ac6:	4505                	li	a0,1
  ...
  if(pid2 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     b02:	97250513          	addi	a0,a0,-1678 # 1470 <malloc+0x1ea>
     b06:	00000097          	auipc	ra,0x0
     b0a:	6c8080e7          	jalr	1736(ra) # 11ce <printf>
    exit(1);
     b0e:	4505                	li	a0,1
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1360:	b70080e7          	jalr	-1168(ra) # ecc <sbrk>
  if(p == (char*)-1)
